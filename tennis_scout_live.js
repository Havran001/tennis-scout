...
function buildH2HTab(sh){
  ...
  function renderH2H(p1,p2,hist1,hist2){
    ...
    if(h2h.length){
      ...
      html+='<thead><tr>';
      ['Datum','Turnaj','Povrch','Kolo','Skóre','Hráč','DR','A%','vA%','1st%','2nd%','T'].forEach(function(c){html+='<th style="padding:5px 8px;font-size:8px;color:rgba(255,255,255,.25);letter-spacing:1px;text-align:left;border-bottom:1px solid rgba(255,255,255,.06);">'+c+'</th>';});
      html+='</tr></thead><tbody>';
...
(function waitForH2H(){
  ...
  var timer=setInterval(function(){
    ...
    function renderH2H(p1,p2,h1,h2){
      ...
      if(h2hM.length){html+='<div style="margin-top:14px;"><div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;padding-bottom:8px;border-bottom:1px solid rgba(255,255,255,.04);">Vzájemné zápasy ('+h2hM.length+')</div><table style="width:100%;border-collapse:collapse;"><thead><tr>'+['Datum','Turnaj','Povrch','Kolo','Skóre','Hráč','DR','A%','vA%','1st%','2nd%','T'].map(function(c){return '<th style="padding:4px 8px;font-size:8px;color:rgba(255,255,255,.25);letter-spacing:1px;text-align:left;border-bottom:1px solid rgba(255,255,255,.06);">'+c+'</th>';}).join('')+'</tr></thead><tbody>'+h2hM.map(function(m,i){var bg=i%2===0?'transparent':'rgba(255,255,255,.012)';var winnerName=m.result==='W'?p1n:p2n;var winnerSpan=m.result&&m.score?(' <span data-plink="'+winnerName+'" style="color:#FFD700;font-weight:700;cursor:pointer;font-size:11px;">'+winnerName.split(' ').pop()+'</span>'):'';  var m2=(h2.matches||[]).find(function(x){return x.date===m.date&&(x.opponent||'').toLowerCase().split(' ').some(function(w){return p1n.toLowerCase().split(' ').some(function(v){return v.length>2&&w.includes(v);});});});var row1='<tr style="background:'+bg+';border-bottom:0;">'+'<td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.date?m.date.replace(/-/g,'.').split('.').reverse().join('.'):'')+'</td>'+'<td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);max-width:180px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">'+(m.tournament||'—')+'</td>'+'<td><span style="font-size:9px;font-weight:700;padding:2px 6px;border-radius:3px;background:rgba(255,255,255,.05);color:'+(m.surface&&m.surface.toLowerCase().includes('clay')?'#fb923c':m.surface&&m.surface.toLowerCase().includes('grass')?'#4ade80':'#60a5fa')+';">'+(m.surface&&m.surface.toLowerCase().includes('clay')?'Antuka':m.surface&&m.surface.toLowerCase().includes('grass')?'Tráva':'Tvrdý')+'</span></td>'+'<td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.round||'—')+'</td>'+'<td style="padding:5px 8px;font-size:12px;font-weight:600;font-family:monospace;color:#e6edf3;">"+(m.score||'—')+winnerSpan+'</td>'+'<td></td><td></td><td></td><td></td><td></td><td></td><td></td>''</tr>';var row2='<tr style="background:rgba(255,255,255,.018);">'+'<td></td><td></td><td></td><td></td><td></td>'+'<td style="padding:3px 6px;font-size:10px;color:rgba(255,255,255,.6);font-style:italic;white-space:nowrap;" data-plink="'+p1n+'">'+p1n.split(' ').pop()+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m.dr||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m.a_pct||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m.va_pct||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m.first_pct||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m.second_pct||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m.match_time||'—')+'</td>''</tr>';var row3='<tr style="background:rgba(0,0,0,.08);border-bottom:2px solid rgba(255,255,255,.04);">'+'<td></td><td></td><td></td><td></td><td></td>'+(m2?'<td style="padding:3px 6px;font-size:10px;color:rgba(255,255,255,.6);font-style:italic;white-space:nowrap;" data-plink="'+p2n+'">'+p2n.split(' ').pop()+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m2.dr||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m2.a_pct||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m2.va_pct||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m2.first_pct||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m2.second_pct||'—')+'</td>'+'<td style="padding:3px 6px;font-size:11px;font-family:monospace;text-align:right;color:rgba(255,255,255,.5);white-space:nowrap;">'+(m2.match_time||'—')+'</td>':'<td colspan="7"></td>')'</tr>';return row1+row2+row3;}).join('')).join('')+'</tbody></table></div>';}
