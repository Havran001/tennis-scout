    ...
    if(!shown.length){h+='<div style="padding:60px;text-align:center;color:rgba(255,255,255,.2);">Žádné zápasy</div>';}
      ...
      if(activeSort==='time'){
        ...
        shown.forEach(function(m){
          ...
          h+='<div style="width:33%;max-width:33%;min-width:0;flex-shrink:0;">';
      ...
      tOrd.forEach(function(t){
        ...
        h+='<div style="width:33%;max-width:33%;min-width:0;flex-shrink:0;"><div style="font-size:11px;font-weight:700;color:rgba(255,255,255,.8);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">'+t+'</div>';
...
async function _loadBetanoOdds(){
  ...
  try{
    ...
    var _mwEl=sh.getElementById('mw');if(_mwEl&&_mwEl.render)_mwEl.render();
  }catch(e){}
}
