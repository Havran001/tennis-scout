// ================================================================
// ÃÂ°ÃÂÃÂÃÂ¾ TENNIS SCOUT ÃÂ¢ÃÂÃÂ LIVE CALENDAR v5.0
// ATP/WTA/Challenger: statickÃÂÃÂ¡ data 2026 (z atptour.com PDF + wtatennis.com)
// ITF M15/M25/W15/W35+: live API itftennis.com (naÃÂÃÂÃÂÃÂ­tÃÂÃÂ¡ se pÃÂÃÂi spuÃÂÃÂ¡tÃÂÃÂnÃÂÃÂ­)
//
// Jak pouÃÂÃÂ¾ÃÂÃÂ­t:
//   1. OtevÃÂÃÂi www.itftennis.com/en/tournament-calendar/mens-world-tennis-tour-calendar/
//   2. Cmd + Option + J ÃÂ¢ÃÂÃÂ konzole
//   3. VloÃÂÃÂ¾ skript ÃÂ¢ÃÂÃÂ Enter ÃÂ¢ÃÂÃÂ ÃÂÃÂekej ~20s na ITF data
//
//   ATP/WTA/Challenger se zobrazÃÂÃÂ­ okamÃÂÃÂ¾itÃÂÃÂ z jakÃÂÃÂ©koli strÃÂÃÂ¡nky.
//   ITF data se naÃÂÃÂtou pouze ze strÃÂÃÂ¡nky itftennis.com.
// ===============================================================
...
// ATP Rankings - naÃÂÃÂÃÂÃÂ­tÃÂÃÂ¡no z GitHubu (stejnÃÂÃÂ jako ITF data)
window.ATP_PLAYERS = [];
...
// Kontrola CSP
{
  ...
  if (url.startsWith('chrome://')||url.startsWith('about:')||url.startsWith('edge://')) {
    alert('ÃÂ¢ÃÂÃÂ SpusÃÂÃÂ¥ skript na normÃÂÃÂ¡lnÃÂÃÂ­ strÃÂÃÂ¡nce ÃÂ¢ÃÂÃÂ napÃÂÃÂ. otevÃÂÃÂi wikipedia.org'); return;
  }
  if (window.trustedTypes) {
    try { window.trustedTypes.createPolicy('ts-probe-'+Date.now(),{createHTML:s=>s}); }
    catch(e) { if(e.message.includes('disallowed')) { alert('ÃÂ¢ÃÂÃÂ Tato strÃÂÃÂ¡nka blokuje skript (CSP).\nÃÂ¢ÃÂÃÂ OtevÃÂÃÂi wikipedia.org a spusÃÂÃÂ¥ tam.'); return; } }
  }
}

// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ STATICKÃÂÃÂ DATA 2026 ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
// FormÃÂÃÂ¡t: [name, loc, tier, surf, io, alt_m, start, end, sgl, dbl, prize, {a:winners_ATP, w:winners_WTA}]
// io: "O"=outdoor, "I"=indoor
// alt_m: nadmoÃÂÃÂskÃÂÃÂ¡ vÃÂÃÂ½ÃÂÃÂ¡ka v metrech (0 = u moÃÂÃÂe / neuvedeno)
// prize: prize money pro singla vÃÂÃÂ­tÃÂÃÂze v USD (ATP pokud combined, jinak M/W)
// winners: poslednÃÂÃÂ­ 3 roky [2025, 2024, 2023]

const ATP = [
  // LEDEN
  ["United Cup","Perth/Sydney, AUS","TÃÂÃÂ½m.event","TvrdÃÂÃÂ½","O",15,"2026-01-02","2026-01-11",0,0,"ÃÂ¢ÃÂÃÂ",{w:["Polsko","Polsko","USA"]}],
  ["Brisbane International","Brisbane, AUS","ATP250","TvrdÃÂÃÂ½","O",27,"2026-01-04","2026-01-11",32,24,"$604k",{w:["Rune","Fonseca","Shelton"]}],
  ["Bank of China Hong Kong Open","Hong Kong","ATP250","TvrdÃÂÃÂ½","O",10,"2026-01-05","2026-01-11",28,16,"$604k",{w:["Bublik","Bublik","Bublik"]}],
  ["Adelaide International","Adelaide, AUS","ATP250","TvrdÃÂÃÂ½","O",48,"2026-01-12","2026-01-17",28,24,"$604k",{w:["Machac","Korda","Rublev"]}],
  ["ASB Classic","Auckland, NZL","ATP250","TvrdÃÂÃÂ½","O",25,"2026-01-12","2026-01-17",28,16,"$604k",{w:["Mensik","Paul","Cressy"]}],
  ["Australian Open","Melbourne, AUS","Grand Slam","TvrdÃÂÃÂ½","O",31,"2026-01-18","2026-02-01",128,64,"$2,9M AUD",{w:["Alcaraz","Sinner","Djokovic"]}],
  // ÃÂÃÂNOR
  ["Open Occitanie","Montpellier, FRA","ATP250","TvrdÃÂÃÂ½","I",1,"2026-02-02","2026-02-08",28,16,"$604k",{w:["Humbert","Humbert","Bublik"]}],
  ["Nexo Dallas Open","Dallas, USA","ATP500","TvrdÃÂÃÂ½","I",139,"2026-02-09","2026-02-15",32,16,"$1,96M",{w:["Draper","Fritz","Opelka"]}],
  ["ABN AMRO Open","Rotterdam, NED","ATP500","TvrdÃÂÃÂ½","I",1,"2026-02-09","2026-02-15",32,16,"$1,96M",{w:["Medvedev","Sinner","Rublev"]}],
  ["IEB+ Argentina Open","Buenos Aires, ARG","ATP250","Antuka","O",25,"2026-02-09","2026-02-15",28,16,"$604k",{w:["Cerundolo","Cerundolo","Djokovic"]}],
  ["Qatar ExxonMobil Open","Doha, QAT","ATP500","TvrdÃÂÃÂ½","O",11,"2026-02-16","2026-02-22",32,16,"$1,96M",{w:["Rublev","Medvedev","Djokovic"]}],
  ["Rio Open","Rio de Janeiro, BRA","ATP500","Antuka","O",10,"2026-02-16","2026-02-22",32,16,"$1,96M",{w:["Fonseca","Cerundolo","Tsitsipas"]}],
  ["Delray Beach Open","Delray Beach, USA","ATP250","TvrdÃÂÃÂ½","O",3,"2026-02-16","2026-02-22",28,16,"$604k",{w:["Paul","Korda","Tiafoe"]}],
  ["Mubadala Citi DC Open","Washington DC, USA","ATP500","TvrdÃÂÃÂ½","O",7,"2026-02-23","2026-03-01",48,16,"$1,96M",{w:["Fritz","Fritz","Zverev"]}],
  ["Mexican Open","Acapulco, MEX","ATP500","TvrdÃÂÃÂ½","O",3,"2026-02-23","2026-03-01",32,16,"$1,96M",{w:["Alcaraz","Alcaraz","Alcaraz"]}],
  ["Dubai Duty Free Championships","Dubai, UAE","ATP500","TvrdÃÂÃÂ½","O",5,"2026-02-23","2026-03-01",32,16,"$1,96M",{w:["Medvedev","Djokovic","Rublev"]}],
  ["Movistar Chile Open","Santiago, CHI","ATP250","Antuka","O",520,"2026-02-23","2026-03-01",28,16,"$604k",{w:["Jarry","Tabilo","Jarry"]}],
  // BÃÂÃÂEZEN
  ["BNP Paribas Open","Indian Wells, USA","Masters1000","TvrdÃÂÃÂ½","O",485,"2026-03-04","2026-03-15",96,32,"$1,15M",{w:["Draper","Alcaraz","Alcaraz"]}],
  ["Miami Open","Miami, USA","Masters1000","TvrdÃÂÃÂ½","O",2,"2026-03-18","2026-03-29",96,32,"$1,2M",{w:["Sinner","Sinner","Alcaraz"]}],
  ...
  // ÃÂÃÂERVEN
  ["Libema Open","'s-Hertogenbosch, NED","ATP250","TrÃÂÃÂ¡va","O",5,"2026-06-08","2026-06-14",28,16,"$604k",{w:["Rune","Griekspoor","Bublik"]}],
  ["BOSS Open","Stuttgart, GER","ATP250","TrÃÂÃÂ¡va","O",226,"2026-06-08","2026-06-14",28,16,"$604k",{w:["Ruud","Rune","Auger-Aliassime"]}],
  ["Terra Wortmann Open","Halle, GER","ATP500","TrÃÂÃÂ¡va","O",65,"2026-06-15","2026-06-21",32,16,"$1,96M",{w:["Sinner","Sinner","Rublev"]}],
  ["HSBC Championships","London, GBR","ATP500","TrÃÂÃÂ¡va","O",11,"2026-06-15","2026-06-21",32,16,"$1,96M",{w:["Djokovic","Fritz","Paul"]}],
  ["Mallorca Championships","Mallorca, ESP","ATP250","TrÃÂÃÂ¡va","O",14,"2026-06-21","2026-06-27",28,16,"$604k",{w:["Ruusuvuori","Fognini","Fognini"]}],
  ["Rothesay International","Eastbourne, GBR","ATP250","TrÃÂÃÂ¡va","O",5,"2026-06-22","2026-06-28",28,16,"$604k",{w:["Norrie","Norrie","Norrie"]}],
  ["Wimbledon","London, GBR","Grand Slam","TrÃÂÃÂ¡va","O",43,"2026-06-29","2026-07-12",128,64,"$2,9M GBP",{w:["Alcaraz","Alcaraz","Alcaraz"]}],
  // ÃÂÃÂERVENEC
  ["Nordea Open","BÃÂÃÂ¥stad, SWE","ATP250","Antuka","O",12,"2026-07-13","2026-07-19",28,16,"$604k",{w:["Ruud","Rune","Rune"]}],
  ...
  ["Generali Open","KitzbÃÂÃÂ¼hel, AUT","ATP250","Antuka","O",762,"2026-07-19","2026-07-25",28,16,"$604k",{w:["Altmaier","Struff","Struff"]}],
  ["Millennium Estoril Open","Estoril, POR","ATP250","Antuka","O",149,"2026-07-20","2026-07-26",28,16,"$604k",{w:["Rune","Monfils","Norrie"]}],
  ["Mifel Tennis Open","Los Cabos, MEX","ATP250","TvrdÃÂÃÂ½","O",14,"2026-07-20","2026-07-26",28,16,"$604k",{w:["Rune","Fonseca","Zverev"]}],
  ["Mubadala Citi DC Open","Washington DC, USA","ATP500","TvrdÃÂÃÂ½","O",7,"2026-07-27","2026-08-02",48,16,"$1,96M",{w:["Shelton","Fritz","Shelton"]}],
  // SRPEN
  ["National Bank Open","Montreal/Toronto, CAN","Masters1000","TvrdÃÂÃÂ½","O",30,"2026-08-03","2026-08-16",96,32,"$857k",{w:["Sinner","Sinner","Alcaraz"]}],
  ["Cincinnati Open","Cincinnati, USA","Masters1000","TvrdÃÂÃÂ½","O",226,"2026-08-17","2026-08-23",96,32,"$857k",{w:["Sinner","Djokovic","Alcaraz"]}],
  ["Winston-Salem Open","Winston-Salem, USA","ATP250","TvrdÃÂÃÂ½","O",270,"2026-08-23","2026-08-29",48,16,"$604k",{w:["Paul","Mannarino","Cressy"]}],
  ["US Open","New York, USA","Grand Slam","TvrdÃÂÃÂ½","O",6,"2026-08-31","2026-09-13",128,64,"$3,6M",{w:["Sinner","Sinner","Medvedev"]}],
  // ZÃÂÃÂÃÂÃÂÃÂÃÂ
  ["Chengdu Open","Chengdu, CHN","ATP250","TvrdÃÂÃÂ½","O",500,"2026-09-21","2026-09-27",28,16,"$604k",{w:["Sinner","Medvedev","Wu"]}],
  ["Hangzhou Open","Hangzhou, CHN","ATP250","TvrdÃÂÃÂ½","O",7,"2026-09-21","2026-09-27",28,16,"$604k",{w:["Bublik","Zverev","Davidovich"]}],
  ["Laver Cup","London, GBR","Exhibice","TvrdÃÂÃÂ½","I",43,"2026-09-25","2026-09-27",0,0,"ÃÂ¢ÃÂÃÂ",{w:["Evropa","SvÃÂÃÂt","Evropa"]}],
  ["Kinoshita Japan Open","Tokyo, JPN","ATP500","TvrdÃÂÃÂ½","O",40,"2026-09-28","2026-10-04",32,16,"$1,96M",{w:["Rune","Paul","Tsitsipas"]}],
  ["China Open","Beijing, CHN","ATP500","TvrdÃÂÃÂ½","O",43,"2026-09-28","2026-10-04",32,16,"$1,96M",{w:["Sinner","Sinner","Alcaraz"]}],
  // ÃÂÃÂÃÂÃÂJEN
  ["Rolex Shanghai Masters","Shanghai, CHN","Masters1000","TvrdÃÂÃÂ½","O",4,"2026-10-05","2026-10-18",96,32,"$1,12M",{w:["Sinner","Djokovic","Medvedev"]}],
  ["Almaty Open","Almaty, KAZ","ATP250","TvrdÃÂÃÂ½","I",775,"2026-10-19","2026-10-25",28,16,"$604k",{w:["Rune","Rublev","Bublik"]}],
  ["European Open","Antwerp, BEL","ATP250","TvrdÃÂÃÂ½","I",12,"2026-10-19","2026-10-25",28,16,"$604k",{w:["Paul","Rublev","Sinner"]}],
  ["Grand Prix Auvergne-RhÃÂÃÂ´ne-Alpes","Lyon, FRA","ATP250","TvrdÃÂÃÂ½","I",173,"2026-10-19","2026-10-25",28,16,"$604k",{w:["Tiafoe","Fils","Mannarino"]}],
  ["Swiss Indoors Basel","Basel, SUI","ATP500","TvrdÃÂÃÂ½","I",260,"2026-10-26","2026-11-01",28,16,"$1,96M",{w:["Sinner","Sinner","Djokovic"]}],
  ["Erste Bank Open","Vienna, AUT","ATP500","TvrdÃÂÃÂ½","I",171,"2026-10-26","2026-11-01",32,16,"$1,96M",{w:["Draper","Sinner","Rublev"]}],
  // LISTOPAD
  ["Rolex Paris Masters","Paris, FRA","Masters1000","TvrdÃÂÃÂ½","I",35,"2026-11-02","2026-11-08",48,24,"$857k",{w:["Zverev","Djokovic","Djokovic"]}],
  ["BNP Paribas Nordic Open","Stockholm, SWE","ATP250","TvrdÃÂÃÂ½","I",28,"2026-11-09","2026-11-15",28,16,"$604k",{w:["Rune","Rune","Nishioka"]}],
  ["Nitto ATP Finals","Turin, ITA","Finals","TvrdÃÂÃÂ½","I",239,"2026-11-15","2026-11-22",8,8,"$2,6M",{w:["Sinner","Sinner","Djokovic"]}],
  ["Next Gen ATP Finals","Jeddah, KSA","NextGen","TvrdÃÂÃÂ½","I",612,"2026-12-16","2026-12-20",8,0,"$1,8M",{w:["Fonseca","Mensik","Fils"]}],
];

const WTA = [
  // LEDEN
  ["United Cup","Perth/Sydney, AUS","TÃÂÃÂ½m.event","TvrdÃÂÃÂ½","O",15,"2026-01-02","2026-01-11",0,0,"ÃÂ¢ÃÂÃÂ",{w:["Polsko","Polsko","USA"]}],
  ["Brisbane International","Brisbane, AUS","WTA500","TvrdÃÂÃÂ½","O",27,"2026-01-04","2026-01-11",32,16,"$235k",{w:["Sabalenka","Gauff","Azarenka"]}],
  ["Adelaide International","Adelaide, AUS","WTA500","TvrdÃÂÃÂ½","O",48,"2026-01-05","2026-01-11",32,16,"$235k",{w:["Svitolina","Rybakina","Barty"]}],
  ["ASB Classic","Auckland, NZL","WTA250","TvrdÃÂÃÂ½","O",25,"2026-01-05","2026-01-11",32,16,"$235k",{w:["Svitolina","Osaka","Vandeweghe"]}],
  ["Hobart International","Hobart, AUS","WTA250","TvrdÃÂÃÂ½","O",54,"2026-01-12","2026-01-18",32,16,"$235k",{w:["Cocciaretto","Kvitova","Stosur"]}],
  ["Australian Open","Melbourne, AUS","Grand Slam","TvrdÃÂÃÂ½","O",31,"2026-01-18","2026-02-01",128,64,"$2,9M AUD",{w:["Rybakina","Sabalenka","Sabalenka"]}],
  // ÃÂÃÂNOR
  ["Thames International","London, GBR","WTA500","TvrdÃÂÃÂ½","I",11,"2026-02-02","2026-02-08",28,16,"$235k",{w:["Andreeva","Rybakina","ÃÂ¢ÃÂÃÂ"]}],
  ["Cali Open","Cali, COL","WTA250","Antuka","O",995,"2026-02-02","2026-02-08",32,16,"$115k",{w:["Sorribes Tormo","Sorribes Tormo","Osorio"]}],
  ["Abu Dhabi Open","Abu Dhabi, UAE","WTA500","TvrdÃÂÃÂ½","O",27,"2026-02-02","2026-02-08",28,16,"$235k",{w:["Muchova","Rybakina","ÃÂ¢ÃÂÃÂ"]}],
  ["Qatar TotalEnergies Open","Doha, QAT","WTA1000","TvrdÃÂÃÂ½","O",11,"2026-02-09","2026-02-15",56,28,"$665k",{w:["Muchova","Swiatek","Swiatek"]}],
  ["Dubai Duty Free Championships","Dubai, UAE","WTA1000","TvrdÃÂÃÂ½","O",5,"2026-02-16","2026-02-22",56,28,"$665k",{w:["Pegula","Svitolina","Swiatek"]}],
  ["Rio Open","Rio de Janeiro, BRA","WTA250","Antuka","O",10,"2026-02-16","2026-02-22",32,16,"$115k",{w:["Sorribes Tormo","Sorribes Tormo","Osorio"]}],
  ["Abierto Mexicano Telcel","Acapulco, MEX","WTA250","TvrdÃÂÃÂ½","O",3,"2026-02-23","2026-03-01",32,16,"$115k",{w:["Samsonova","Osaka","Haddad Maia"]}],
  // BÃÂÃÂEZEN
  ["BNP Paribas Open","Indian Wells, USA","WTA1000","TvrdÃÂÃÂ½","O",485,"2026-03-04","2026-03-15",96,32,"$1,15M",{w:["Andreeva","Sabalenka","Swiatek"]}],
  ["Miami Open","Miami, USA","WTA1000","TvrdÃÂÃÂ½","O",2,"2026-03-18","2026-03-29",96,32,"$1,2M",{w:["Gauff","Swiatek","Swiatek"]}],
  ...
  ["Upper Austria Ladies Linz","Linz, AUT","WTA500","TvrdÃÂÃÂ½","I",266,"2026-04-06","2026-04-12",28,16,"$235k",{w:["Rybakina","Rybakina","Bencic"]}],
  ...
  // ÃÂÃÂERVEN
  ["Libema Open","'s-Hertogenbosch, NED","WTA500","TrÃÂÃÂ¡va","O",5,"2026-06-08","2026-06-14",28,16,"$235k",{w:["Rybakina","Vondrousova","Kontaveit"]}],
  ["Rothesay Open Nottingham","Nottingham, GBR","WTA250","TrÃÂÃÂ¡va","O",28,"2026-06-08","2026-06-14",32,16,"$115k",{w:["Paolini","Bouzkova","Brengle"]}],
  ["Bad Homburg Open","Bad Homburg, GER","WTA250","TrÃÂÃÂ¡va","O",149,"2026-06-15","2026-06-21",32,16,"$115k",{w:["Rybakina","Vondrousova","Kerber"]}],
  ["Berlin Ladies Open","Berlin, GER","WTA500","TrÃÂÃÂ¡va","O",34,"2026-06-15","2026-06-21",28,16,"$235k",{w:["Swiatek","Swiatek","Kvitova"]}],
  ["Rothesay International Eastbourne","Eastbourne, GBR","WTA250","TrÃÂÃÂ¡va","O",5,"2026-06-22","2026-06-28",32,16,"$115k",{w:["Rybakina","Gauff","Jabeur"]}],
  ["Wimbledon","London, GBR","Grand Slam","TrÃÂÃÂ¡va","O",43,"2026-06-29","2026-07-12",128,64,"$2,9M GBP",{w:["Rybakina","Vondrousova","Rybakina"]}],
  // ÃÂÃÂERVENEC
  ...
  ["Mubadala Citi DC Open","Washington DC, USA","WTA500","TvrdÃÂÃÂ½","O",7,"2026-07-20","2026-07-26",28,16,"$235k",{w:["Gauff","Gauff","Kontaveit"]}],
  // SRPEN
  ["National Bank Open","Toronto/Montreal, CAN","WTA1000","TvrdÃÂÃÂ½","O",105,"2026-08-03","2026-08-09",96,32,"$857k",{w:["Sabalenka","Swiatek","Swiatek"]}],
  ["Western & Southern Open","Cincinnati, USA","WTA1000","TvrdÃÂÃÂ½","O",226,"2026-08-10","2026-08-17",96,32,"$857k",{w:["Swiatek","Swiatek","Swiatek"]}],
  ["US Open","New York, USA","Grand Slam","TvrdÃÂÃÂ½","O",6,"2026-08-31","2026-09-13",128,64,"$3,6M",{w:["Sabalenka","Sabalenka","Swiatek"]}],
  // ZÃÂÃÂÃÂÃÂÃÂÃÂ
  ["Singapore Open","Singapore, SIN","WTA500","TvrdÃÂÃÂ½","I",15,"2026-09-21","2026-09-27",28,16,"$235k",{w:["ÃÂ¢ÃÂÃÂ","ÃÂ¢ÃÂÃÂ","ÃÂ¢ÃÂÃÂ"]}],
  ["Guangzhou Open","Guangzhou, CHN","WTA250","TvrdÃÂÃÂ½","O",11,"2026-09-21","2026-09-27",32,16,"$115k",{w:["Zhu","Zheng","Zhu"]}],
  ["China Open","Beijing, CHN","WTA1000","TvrdÃÂÃÂ½","O",43,"2026-09-28","2026-10-04",96,32,"$857k",{w:["Sabalenka","Swiatek","Swiatek"]}],
  ["Wuhan Open","Wuhan, CHN","WTA1000","TvrdÃÂÃÂ½","O",23,"2026-09-28","2026-10-11",96,32,"$857k",{w:["Swiatek","Rybakina","Swiatek"]}],
  // ÃÂÃÂÃÂÃÂJEN
  ["Korea Open","Seoul, KOR","WTA250","TvrdÃÂÃÂ½","O",38,"2026-10-19","2026-10-25",32,16,"$115k",{w:["Osaka","Osaka","Azarenka"]}],
  ["Jiangxi Open","Nanchang, CHN","WTA250","TvrdÃÂÃÂ½","O",46,"2026-10-19","2026-10-25",32,16,"$115k",{w:["Zheng","Zheng","Kvitova"]}],
  ["Rolex Paris Masters","Paris, FRA","WTA1000","TvrdÃÂÃÂ½","I",35,"2026-10-26","2026-11-01",56,28,"$857k",{w:["Sabalenka","Swiatek","ÃÂ¢ÃÂÃÂ"]}],
  // LISTOPAD
  ["Merida Open","Merida, MEX","WTA250","TvrdÃÂÃÂ½","O",9,"2026-11-02","2026-11-08",32,16,"$115k",{w:["Osorio","Osorio","ÃÂ¢ÃÂÃÂ"]}],
  ["WTA Finals","Riyadh, KSA","Finals","TvrdÃÂÃÂ½","I",612,"2026-11-06","2026-11-14",8,8,"$2,2M",{w:["Sabalenka","Swiatek","Swiatek"]}],
];

const CHALL = [
  // LEDEN
  ["Bengaluru Open","Bengaluru, IND","CH125","TvrdÃÂÃÂ½","O",920,"2026-01-05","2026-01-10",32,16,"$175k",{w:["Martinez",""]}],
  ["Canberra International","Canberra, AUS","CH125","TvrdÃÂÃÂ½","O",578,"2026-01-05","2026-01-10",32,16,"$175k",{w:["Blockx",""]}],
  ["BNC Tennis Open","Noumea, NCL","CH75","TvrdÃÂÃÂ½","O",2,"2026-01-05","2026-01-10",32,16,"$100k",{w:["Gea",""]}],
  ["Bangkok Open 1","Nonthaburi, THA","CH50","TvrdÃÂÃÂ½","O",3,"2026-01-05","2026-01-10",32,16,"$65k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Lexus Nottingham Challenger","Nottingham, GBR","CH50","TvrdÃÂÃÂ½","I",28,"2026-01-05","2026-01-10",32,16,"$65k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Bangkok Open 2","Nonthaburi, THA","CH75","TvrdÃÂÃÂ½","O",3,"2026-01-12","2026-01-17",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Challenger AAT","ItajaÃÂÃÂ­, BRA","CH50","Antuka","O",3,"2026-01-12","2026-01-17",32,16,"$65k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Glasgow Challenger","Glasgow, GBR","CH50","TvrdÃÂÃÂ½","I",8,"2026-01-12","2026-01-17",32,16,"$65k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Indoor Oeiras Open 1","Oeiras, POR","CH100","TvrdÃÂÃÂ½","I",36,"2026-01-19","2026-01-25",32,16,"$140k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["ItajaÃÂÃÂ­ Open","ItajaÃÂÃÂ­, BRA","CH75","Antuka","O",3,"2026-01-19","2026-01-25",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Indoor Oeiras Open 2","Oeiras, POR","CH100","TvrdÃÂÃÂ½","I",36,"2026-01-26","2026-02-01",32,16,"$140k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Medellin Open","MedellÃÂÃÂ­n, COL","CH75","Antuka","O",1495,"2026-01-26","2026-02-01",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  // ÃÂÃÂNOR
  ["Rosario Challenger","Rosario, ARG","CH125","Antuka","O",25,"2026-02-02","2026-02-08",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Brisbane Challenger","Brisbane, AUS","CH75","TvrdÃÂÃÂ½","O",27,"2026-02-02","2026-02-08",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Cleveland Challenger","Cleveland, USA","CH75","TvrdÃÂÃÂ½","I",183,"2026-02-02","2026-02-08",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Pau Challenger","Pau, FRA","CH125","TvrdÃÂÃÂ½","I",210,"2026-02-09","2026-02-15",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Chennai Open","Chennai, IND","CH50","TvrdÃÂÃÂ½","O",6,"2026-02-09","2026-02-15",32,16,"$65k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Tenerife Challenger","Tenerife, ESP","CH75","TvrdÃÂÃÂ½","O",682,"2026-02-09","2026-02-15",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Szczecin Challenger","Szczecin, POL","CH75","TvrdÃÂÃÂ½","I",1,"2026-02-09","2026-02-15",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Lille Challenger","Lille, FRA","CH125","TvrdÃÂÃÂ½","I",20,"2026-02-16","2026-02-22",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Delhi Open","New Delhi, IND","CH75","TvrdÃÂÃÂ½","O",216,"2026-02-16","2026-02-22",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Liberec Challenger","Liberec, CZE","CH75","TvrdÃÂÃÂ½","I",399,"2026-02-16","2026-02-22",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Heilbronn Challenger","Heilbronn, GER","CH75","TvrdÃÂÃÂ½","I",155,"2026-02-16","2026-02-22",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Maha Open Pune","Pune, IND","CH75","TvrdÃÂÃÂ½","O",554,"2026-02-23","2026-03-01",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Lugano Challenger","Lugano, SUI","CH75","TvrdÃÂÃÂ½","I",274,"2026-02-23","2026-03-01",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  // BÃÂÃÂEZEN
  ["Thionville Challenger","Thionville, FRA","CH100","TvrdÃÂÃÂ½","I",175,"2026-03-02","2026-03-08",32,16,"$140k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Kigali Challenger","Kigali, RWA","CH75","Antuka","O",1567,"2026-03-02","2026-03-08",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Arizona Tennis Classic","Phoenix, USA","CH175","TvrdÃÂÃÂ½","O",331,"2026-03-09","2026-03-15",28,16,"$245k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Copa Cap Cana","Cap Cana, DOM","CH175","TvrdÃÂÃÂ½","O",15,"2026-03-09","2026-03-15",28,16,"$245k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Murcia Challenger","Murcia, ESP","CH75","Antuka","O",43,"2026-03-16","2026-03-22",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Morelia Open","Morelia, MEX","CH125","TvrdÃÂÃÂ½","O",1909,"2026-03-23","2026-03-29",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Naples Challenger","Naples, ITA","CH125","Antuka","O",17,"2026-03-23","2026-03-29",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  // DUBEN
  ["Mexico City Open","Mexico City, MEX","CH125","Antuka","O",2240,"2026-04-06","2026-04-12",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Advantage Cars Prague Open","Prague, CZE","CH75","Antuka","O",190,"2026-04-06","2026-04-12",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["ProstÃÂÃÂjov Challenger","ProstÃÂÃÂjov, CZE","CH125","Antuka","O",225,"2026-04-13","2026-04-19",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Busan Challenger","Busan, KOR","CH125","TvrdÃÂÃÂ½","O",40,"2026-04-13","2026-04-19",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Oeiras Challenger","Oeiras, POR","CH125","Antuka","O",36,"2026-04-13","2026-04-19",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Aix-en-Provence Challenger","Aix-en-Provence, FRA","CH175","Antuka","O",183,"2026-04-27","2026-05-03",28,16,"$245k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Marrakech Challenger","Marrakech, MAR","CH75","Antuka","O",454,"2026-04-27","2026-05-03",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  // KVÃÂÃÂTEN
  ["Wuxi Open","Wuxi, CHN","CH100","TvrdÃÂÃÂ½","O",7,"2026-05-04","2026-05-10",32,16,"$140k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["BNP Paribas Primrose Bordeaux","Bordeaux, FRA","CH175","Antuka","O",6,"2026-05-11","2026-05-17",28,16,"$245k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Valencia Challenger","Valencia, ESP","CH175","Antuka","O",13,"2026-05-11","2026-05-17",28,16,"$245k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Lyon Challenger","Lyon, FRA","CH125","Antuka","O",173,"2026-05-18","2026-05-24",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Geneva Challenger","Geneva, SUI","CH100","Antuka","O",375,"2026-05-18","2026-05-24",32,16,"$140k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Istanbul Challenger","Istanbul, TUR","CH75","Antuka","O",39,"2026-05-18","2026-05-24",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  // ÃÂÃÂERVEN
  ["Birmingham Challenger","Birmingham, GBR","CH125","TrÃÂÃÂ¡va","O",140,"2026-06-01","2026-06-07",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Surbiton Trophy","London, GBR","CH75","TrÃÂÃÂ¡va","O",11,"2026-06-01","2026-06-07",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Ilkley Trophy","Ilkley, GBR","CH125","TrÃÂÃÂ¡va","O",246,"2026-06-08","2026-06-14",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Nottingham Challenger (Grass)","Nottingham, GBR","CH125","TrÃÂÃÂ¡va","O",28,"2026-06-15","2026-06-21",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Mallorca Challenger","Mallorca, ESP","CH75","TrÃÂÃÂ¡va","O",14,"2026-06-22","2026-06-28",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  // ÃÂÃÂERVENEC
  ["Braunschweig Challenger","Braunschweig, GER","CH125","Antuka","O",72,"2026-07-06","2026-07-12",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Newport Challenger","Newport, USA","CH125","TrÃÂÃÂ¡va","O",7,"2026-07-06","2026-07-12",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["BÃÂÃÂ¥stad Challenger","BÃÂÃÂ¥stad, SWE","CH100","Antuka","O",12,"2026-07-06","2026-07-12",32,16,"$140k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Zug Challenger","Zug, SUI","CH125","Antuka","O",425,"2026-07-20","2026-07-26",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Vancouver Challenger","Vancouver, CAN","CH125","TvrdÃÂÃÂ½","O",12,"2026-07-27","2026-08-02",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["San Marino Challenger","San Marino, SMR","CH125","Antuka","O",672,"2026-07-27","2026-08-02",32,16,"$175k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  // SRPEN
  ["Granby Challenger","Granby, CAN","CH100","TvrdÃÂÃÂ½","O",180,"2026-08-03","2026-08-09",32,16,"$140k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Lexington Challenger","Lexington, USA","CH75","TvrdÃÂÃÂ½","O",290,"2026-08-03","2026-08-09",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
  ["Indianapolis Challenger","Indianapolis, USA","CH75","TvrdÃÂÃÂ½","O",220,"2026-08-10","2026-08-16",32,16,"$100k",{w:["ÃÂ¢ÃÂÃÂ",""]}],
];
...
const MCS=['Leden','ÃÂÃÂnor','BÃÂÃÂezen','Duben','KvÃÂÃÂten','ÃÂÃÂerven','ÃÂÃÂervenec','Srpen','ZÃÂÃÂ¡ÃÂÃÂÃÂÃÂ­','ÃÂÃÂÃÂÃÂ­jen','Listopad','Prosinec'];
const MSH=['Led','ÃÂÃÂno','BÃÂÃÂe','Dub','KvÃÂÃÂ','ÃÂÃÂer','ÃÂÃÂvc','Srp','ZÃÂÃÂ¡ÃÂÃÂ','ÃÂÃÂÃÂÃÂ­j','Lis','Pro'];

function surfCS(s){const l=(s||'').toLowerCase();if(l.includes('indoor')||l.includes('carpet'))return'KrytÃÂÃÂ½';if(l.includes('clay'))return'Antuka';if(l.includes('grass'))return'TrÃÂÃÂ¡va';return'TvrdÃÂÃÂ½';}
function fmtRange(s,e){if(!s)return'ÃÂ¢ÃÂÃÂ';const a=new Date(s+'T00:00:00'),b=e?new Date(e+'T00:00:00'):a;const sd=a.getDate(),sm=a.getMonth(),ed=b.getDate(),em=b.getMonth();return sm===em?`${sd}ÃÂ¢ÃÂÃÂ${ed}. ${MSH[sm]}`:`${sd}. ${MSH[sm]} ÃÂ¢ÃÂÃÂ ${ed}. ${MSH[em]}`;}
...
// PÃÂÃÂevod arrays na objekty
function mkAtp(arr){return arr.map(([n,loc,tier,surf,io,alt,s,e,sgl,dbl,prize,wins])=>({name:n,loc,cat:'ATP',tier,surf,io:io||'O',alt:alt||0,start:s,end:e,sgl,dbl,prize:prize||'ÃÂ¢ÃÂÃÂ',winners:wins?.w||[],src:'atptour.com'}));}
function mkWta(arr){return arr.map(([n,loc,tier,surf,io,alt,s,e,sgl,dbl,prize,wins])=>({name:n,loc,cat:'WTA',tier,surf,io:io||'O',alt:alt||0,start:s,end:e,sgl,dbl,prize:prize||'ÃÂ¢ÃÂÃÂ',winners:wins?.w||[],src:'wtatennis.com'}));}
function mkChall(arr){return arr.map(([n,loc,tier,surf,io,alt,s,e,sgl,dbl,prize,wins])=>({name:n,loc,cat:'CHALL',tier,surf,io:io||'O',alt:alt||0,start:s,end:e,sgl,dbl,prize:prize||'ÃÂ¢ÃÂÃÂ',winners:wins?.w||[],src:'atptour.com'}));}

// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ITF API ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ

async function fetchPlayers(onProgress){
  try{
    onProgress&&onProgress('NaÃÂÃÂÃÂÃÂ­tÃÂÃÂ¡m hrÃÂÃÂ¡ÃÂÃÂe ATP...');
    // NaÃÂÃÂti hrÃÂÃÂ¡ÃÂÃÂe s cache-bust
    ...
    // NaÃÂÃÂti Sackmann CSV pro age/hand/height
    onProgress&&onProgress('NaÃÂÃÂÃÂÃÂ­tÃÂÃÂ¡m statistiky...');
    ...
    onProgress&&onProgress('HrÃÂÃÂ¡ÃÂÃÂi ATP naÃÂÃÂteni: '+window.ATP_PLAYERS.length);
    // NaÃÂÃÂti WTA hrÃÂÃÂ¡ÃÂÃÂky
    try{
      ...
      onProgress&&onProgress('WTA hrÃÂÃÂ¡ÃÂÃÂky naÃÂÃÂteny: '+window.WTA_PLAYERS.length);
...
async function fetchITF(onProg){
  // Data jsou kaÃÂÃÂ¾dÃÂÃÂ½ den automaticky aktualizovÃÂÃÂ¡na GitHub Actions
  // z itftennis.com a uloÃÂÃÂ¾ena do raw.githubusercontent.com (prochÃÂÃÂ¡zÃÂÃÂ­ sÃÂÃÂ­tÃÂÃÂ­)
  const GH_URL = 'https://raw.githubusercontent.com/Hacran001/tennis-scout/main/itf_data.json';
  onProg('NaÃÂÃÂÃÂÃÂ­tÃÂÃÂ¡m ITF z GitHub cache...');
  ...
  onProg(`ITF: ${items.length} turnajÃÂÃÂ¯ (aktualizovÃÂÃÂ¡no ${data.updated?.slice(0,10)||'?'})`);
  return items;
}

// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ CSS ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
const CSS=`
:host{all:initial;}
...
#w{
  ...
  background:#0d1117;
  font-family:'SÃÂÃÂ¶hne','Helvetica Neue','Arial',sans-serif;
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ HOME VIEW ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ TABLES ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
.mg{margin-top:24px;}
.mh{
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ PLAYERS VIEW ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
#pw{
  display:none;
  color:#e6edf3;
}

/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ERR / ITF STATUS / LOAD ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ SCROLLBARS ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
::-webkit-scrollbar{width:3px;height:3px;}
::-webkit-scrollbar-track{background:transparent;}
::-webkit-scrollbar-thumb{background:rgba(255,255,255,0.07);border-radius:3px;}
`;function surfSp(s){return s==='Antuka'?'sA':s==='TrÃÂÃÂ¡va'?'sT':s==='KrytÃÂÃÂ½'?'sK':'sH';}
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ HRÃÂÃÂÃÂÃÂI ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
function buildPlayersTab(sh){
  ...
  function countryFlag(cc){
    ...
    // IOC 3-letter ÃÂ¢ÃÂÃÂ ISO 2-letter mapa (hlavnÃÂÃÂ­ zemÃÂÃÂ)
  ...
  function rP(){
    ...
    if(!ATP.length){wrap.innerHTML='<div style="padding:60px;text-align:center;color:rgba(255,255,255,0.2);font-size:13px;">ÃÂ¢ÃÂÃÂ³ NaÃÂÃÂÃÂÃÂ­tÃÂÃÂ¡m hrÃÂÃÂ¡ÃÂÃÂe...</div>';return;}
    ...
    h+='<input id="ps-i" type="text" autocomplete="off" placeholder="Hledej jmÃÂÃÂ©no, zemi nebo rank..." value="'+sv+'"';
    ...
    if(pS)h+='<button id="ps-x" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;color:rgba(255,255,255,0.3);font-size:18px;cursor:pointer;line-height:1;">ÃÂÃÂ</button>';
    h+='</div>';
    if(q&&total>0)h+='<div style="margin-top:5px;font-size:11px;color:#00C853;">ÃÂ¢ÃÂÃÂ Nalezeno '+total+' hrÃÂÃÂ¡ÃÂÃÂÃÂÃÂ¯</div>';
    if(q&&total===0)h+='<div style="margin-top:5px;font-size:11px;color:rgba(255,100,100,0.7);">ÃÂ¢ÃÂÃÂ Nic pro "'+pS+'"</div>';
    h+='</div>';
    ...
    h+='<button data-cf="ALL" style="padding:4px 12px;border-radius:14px;border:1px solid '+(pC==="ALL"?"#00C853":"rgba(255,255,255,0.12)")+';background:'+(pC==="ALL"?"#00C853":"transparent")+';color:'+(pC==="ALL"?"#000":"rgba(255,255,255,0.5)")+';font-size:10px;cursor:pointer;font-weight:700;">VÃÂÃÂ¡e</button>';
    ...
    [["rank","Ranking"],["pts","Body"],["age","VÃÂÃÂk"],["height","VÃÂÃÂ½ÃÂÃÂ¡ka"],["name","JmÃÂÃÂ©no"]].forEach(function(x){h+='<option value="'+x[0]+'"'+(pO===x[0]?" selected":"")+'>'+x[1]+'</option>';});
    h+='</select><span style="font-size:9px;color:rgba(255,255,255,0.2);">'+(q?total+"/":"")+ATP.length+' hrÃÂÃÂ¡ÃÂÃÂÃÂÃÂ¯</span></div></div>';
    // Tabulka ÃÂ¢ÃÂÃÂ novÃÂÃÂ© sloupce
    ...
    h+='<th style="padding:7px 8px;font-size:8px;color:rgba(255,255,255,0.2);text-align:left;letter-spacing:1px;border-bottom:1px solid rgba(255,255,255,0.06);">HRÃÂÃÂÃÂÃÂ</th>';
    h+='<th style="padding:7px 8px;font-size:8px;color:rgba(255,255,255,0.2);text-align:center;letter-spacing:1px;border-bottom:1px solid rgba(255,255,255,0.06);width:50px;">ZEMÃÂÃÂ</th>';
    h+='<th style="padding:7px 8px;font-size:8px;color:rgba(255,255,255,0.2);text-align:center;letter-spacing:1px;border-bottom:1px solid rgba(255,255,255,0.06);width:40px;">VÃÂÃÂK</th>';
    ...
    h+='<th style="padding:7px 8px;font-size:8px;color:rgba(255,255,255,0.2);text-align:center;letter-spacing:1px;border-bottom:1px solid rgba(255,255,255,0.06);width:60px;">VÃÂÃÂÃÂÃÂ KA</th>';
    ...
    pg.forEach(function(p,idx){
      ...
      var handIcon=p.hand==="L"?'ÃÂ°ÃÂÃÂ¤ÃÂ L':'R';
      ...
      h+='<td style="padding:7px 8px;text-align:center;font-size:10px;color:rgba(0,200,83,0.4);">ÃÂ¢ÃÂÃÂ</td>';
      h+='</tr>';
    });
    h+='</tbody></table>';
    if(pages>1){
      h+='<div style="display:flex;gap:4px;padding:14px 0;align-items:center;justify-content:center;flex-wrap:wrap;">';
      h+='<button data-pp="prev" style="padding:5px 14px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);background:transparent;color:'+(pP===0?"rgba(255,255,255,0.15)":"rgba(255,255,255,0.5)")+';font-size:13px;cursor:pointer;">ÃÂ¢ÃÂÃÂ</button>';
      ...
      h+='<button data-pp="next" style="padding:5px 14px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);background:transparent;color:'+(pP>=pages-1?"rgba(255,255,255,0.15)":"rgba(255,255,255,0.5)")+';font-size:13px;cursor:pointer;">ÃÂ¢ÃÂÃÂ</button>';
...
function buildMatchesTab(sh){
  ...
  var FLAGS={'USA':'ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¸','ESP':'ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¸','FRA':'ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ·','GER':'ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂª','ITA':'ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ¹','GBR':'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ§','AUS':'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂº','ARG':'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ·','JPN':'ÃÂ°ÃÂÃÂÃÂ¯ÃÂ°ÃÂÃÂÃÂµ','CAN':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¦','BRA':'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ·','NED':'ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ±','SUI':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ­','ROU':'ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂ´','POL':'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ±','CZE':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¿','AUT':'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ¹','GRE':'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ·','BEL':'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂª','SWE':'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂª','NOR':'ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ´','DEN':'ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ°','SRB':'ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂ¸','KAZ':'ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ¿','RUS':'ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂº','UKR':'ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¦','POR':'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¹','CHI':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ±','MEX':'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ½','RSA':'ÃÂ°ÃÂÃÂÃÂ¿ÃÂ°ÃÂÃÂÃÂ¦','IND':'ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ³','KOR':'ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ·','MAR':'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¦','COL':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ´','CRO':'ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂ·','GEO':'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂª','QAT':'ÃÂ°ÃÂÃÂÃÂ¶ÃÂ°ÃÂÃÂÃÂ¦','UAE':'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂª','CHN':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ³','SVK':'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ°','UZB':'ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¿','MON':'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¨','TUR':'ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ·','BUL':'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¬','HUN':'ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂº','FIN':'ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ®','SLO':'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ®','SVK':'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ°','EST':'ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂª','LAT':'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ»','LTU':'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ¹','NZL':'ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ¿','AZE':'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ¿','ARM':'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ²','GBR':'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ§','MDA':'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ©','BLR':'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¾'};

  function tInfo(t){
    var u=t.toUpperCase();
    if(u.includes('ITF')) return{i:'ÃÂ°ÃÂÃÂÃÂµ',l:'ITF',c:'rgba(255,255,255,.4)',bg:'rgba(255,255,255,.03)',b:'rgba(255,255,255,.1)'};
    if(u.includes('CHALLENGER')) return{i:'ÃÂ¢ÃÂÃÂ¡',l:'Challenger',c:'#60a5fa',bg:'rgba(96,165,250,.1)',b:'rgba(96,165,250,.2)'};
    if(u.match(/AUSTRALIAN OPEN|ROLAND GARROS|WIMBLEDON|US OPEN/)) return{i:'ÃÂ°ÃÂÃÂÃÂ',l:'Grand Slam',c:'#FFD700',bg:'rgba(255,215,0,.12)',b:'rgba(255,215,0,.3)'};
    if(u.match(/ATP.*1000|MASTERS 1000|MIAMI|INDIAN WELLS|MADRID OPEN|ROME|MONTREAL|CINCINNATI|SHANGHAI|PARIS MASTERS|CANADIAN|MONTE.CARLO/)) return{i:'ÃÂ°ÃÂÃÂ¥ÃÂ',l:'ATP 1000',c:'#C0C0C0',bg:'rgba(192,192,192,.1)',b:'rgba(192,192,192,.2)'};
    if(u.match(/ATP.*500|ROTTERDAM|DUBAI|ACAPULCO|BARCELONA|HAMBURG|WASHINGTON|TOKYO|BEIJING|VIENNA|BASEL/)) return{i:'ÃÂ°ÃÂÃÂ¥ÃÂ',l:'ATP 500',c:'#CD7F32',bg:'rgba(205,127,50,.1)',b:'rgba(205,127,50,.2)'};
    if(u.match(/WTA.*1000/)) return{i:'ÃÂ°ÃÂÃÂÃÂ´',l:'WTA 1000',c:'#e879f9',bg:'rgba(232,121,249,.1)',b:'rgba(232,121,249,.2)'};
    if(u.match(/WTA.*500/)) return{i:'ÃÂ°ÃÂÃÂÃÂ£',l:'WTA 500',c:'#d946ef',bg:'rgba(217,70,239,.1)',b:'rgba(217,70,239,.2)'};
    if(u.match(/WTA.*SINGLES|WTA - /)) return{i:'ÃÂ°ÃÂÃÂÃÂ£',l:'WTA 250',c:'#c084fc',bg:'rgba(192,132,252,.08)',b:'rgba(192,132,252,.15)'};
    return{i:'ÃÂ°ÃÂÃÂÃÂ¾',l:'ATP 250',c:'rgba(255,255,255,.55)',bg:'rgba(255,255,255,.05)',b:'rgba(255,255,255,.12)'};
  }
  ...
  function pb(b){var o={};b.split('ÃÂÃÂ¬').forEach(function(f){var i=f.indexOf('ÃÂÃÂ·');if(i>0)o[f.slice(0,i)]=f.slice(i+1);});return o;}

  function parseFeed(feedTxt){
    // KLÃÂÃÂÃÂÃÂOVÃÂÃÂ OPRAVA: game score (WA/WB/WC) je pÃÂÃÂÃÂÃÂ­mo v f_2_0_1 bloku kaÃÂÃÂ¾dÃÂÃÂ©ho zÃÂÃÂ¡pasu
    // NEPÃÂÃÂEPISUJEME r_2_1 ÃÂ¢ÃÂÃÂ f_2_0_1 je aktuÃÂÃÂ¡lnÃÂÃÂjÃÂÃÂ¡ÃÂÃÂ­ a kompletnÃÂÃÂ­
    ...
    blocks.forEach(function(b){
      ...
      if(isLive){
        // WA/WB/WC jsou game score pÃÂÃÂÃÂÃÂ­mo v f_2_0_1 ÃÂ¢ÃÂÃÂ aktuÃÂÃÂ¡lnÃÂÃÂ­ a pÃÂÃÂesnÃÂÃÂ©
        game1=b.WA||'0';
        game2=b.WB||'0';
  ...
  function getMatches(data){
    // Worker a flashscore vracÃÂÃÂ­ data pro konkrÃÂÃÂ©tnÃÂÃÂ­ den pÃÂÃÂÃÂÃÂ­mo
    return data.matches||[];
  }
...
function renderMatches(data){
    ...
    [{d:-1,l:'VÃÂÃÂera'},{d:0,l:'Dnes'},{d:1,l:'ZÃÂÃÂ­tra'}].forEach(function(x){
    ...
    if(data.src==='github'){var age=Math.round((Date.now()-new Date(data.updated).getTime())/1000);h+='<span style="font-size:9px;color:rgba(255,140,0,.7);">ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ '+age+'s starÃÂÃÂ¡ data ÃÂ¢ÃÂÃÂ live na flashscore.com</span>';}
    if(_lastUpdated)h+='<span style="font-size:9px;color:rgba(255,255,255,.2);">ÃÂ¢ÃÂÃÂ¥ '+_lastUpdated.slice(11,16)+'</span>';
    ...
    [['all','VÃÂÃÂ¡e',all.length],['live','LIVE ÃÂ°ÃÂÃÂÃÂ´',live.length],['finished','Konec',fin.length],['scheduled','NÃÂÃÂ¡plÃÂÃÂ¡n.',sch.length]].forEach(function(f){
    ...
    [['all','VÃÂÃÂ¡e'],['GS','Grand Slam'],['M1000','ATP 1000'],['ATP500','ATP 500'],['ATP250','ATP 250'],['WTA','WTA'],['CH','Challenger'],['ITF','ITF']].forEach(function(t){var on=activeTier===t[0];h+='<button data-tier="'+t[0]+'" style="padding:2px 9px;border-radius:7px;border:1px solid '+(on?'#60a5fa':'rgba(255,255,255,.08)')+';background:'+(on?'rgba(96,165,250,.15)':'transparent')+';color:'+(on?'#60a5fa':'rgba(255,255,255,.3)')+';font-size:9px;font-weight:'+(on?700:400)+';cursor:pointer;">'+t[1]+'</button>';});
    h+='<div style="width:1px;height:14px;background:rgba(255,255,255,.1);margin:0 3px;flex-shrink:0;align-self:center;"></div>';
    [['all','VÃÂÃÂ¡e'],['singles','Dvouhra'],['doubles','ÃÂÃÂtyÃÂÃÂhra']].forEach(function(f){var on=activeFormat===f[0];h+='<button data-fmt="'+f[0]+'" style="padding:2px 9px;border-radius:7px;border:1px solid '+(on?'#f472b6':'rgba(255,255,255,.08)')+';background:'+(on?'rgba(244,114,182,.15)':'transparent')+';color:'+(on?'#f472b6':'rgba(255,255,255,.3)')+';font-size:9px;font-weight:'+(on?700:400)+';cursor:pointer;">'+f[1]+'</button>';});
    h+='</div>';
    h+='<div style="margin-left:auto;"><button data-sort="1" style="padding:3px 10px;border-radius:10px;border:1px solid '+(activeSort==='time'?'#00C853':'rgba(255,255,255,.15)')+';background:'+(activeSort==='time'?'rgba(0,200,83,.15)':'transparent')+';color:'+(activeSort==='time'?'#00C853':'rgba(255,255,255,.4)')+';font-size:9px;cursor:pointer;">ÃÂ¢ÃÂÃÂ± ÃÂÃÂas</button> <button data-sort="0" style="padding:3px 10px;border-radius:10px;border:1px solid '+(activeSort==='tournament'?'#00C853':'rgba(255,255,255,.15)')+';background:'+(activeSort==='tournament'?'rgba(0,200,83,.15)':'transparent')+';color:'+(activeSort==='tournament'?'#00C853':'rgba(255,255,255,.4)')+';font-size:9px;cursor:pointer;">ÃÂ°ÃÂÃÂÃÂ Turnaj</button></div>';
    h+='</div>';
    if(!shown.length){h+='<div style="padding:60px;text-align:center;color:rgba(255,255,255,.2);">ÃÂÃÂ½ÃÂÃÂ¡dnÃÂÃÂ© zÃÂÃÂ¡pasy</div>';}
    else{
      if(activeSort==='time'){
        ...
        shown.forEach(function(m){
          ...
          h+=_starBtn(m.id);h+='<button onclick="var f=JSON.parse(localStorage.getItem(\x27ts_favs\x27)||\x27[]\x27);var id=\x27'+m.id+'\x27;var i=f.indexOf(id);if(i>-1)f.splice(i,1);else f.push(id);localStorage.setItem(\x27ts_favs\x27,JSON.stringify(f));var on=f.indexOf(id)>-1;this.innerHTML=on?\x27&#9733;\x27:\x27&#9734;\x27;this.style.color=on?\x27#FFD700\x27:\x27rgba(255,255,255,0.28)\x27;event.stopPropagation()" style="background:none;border:none;font-size:20px;line-height:1;cursor:pointer;padding:0 3px 0 0;flex-shrink:0;color:rgba(255,255,255,0.28)">&#9734;</button>';h+='<a href="'+m.url+'" target="_blank" onclick="event.stopPropagation()" style="margin-left:6px;flex-shrink:0;display:block;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="28" height="28" style="display:block;border-radius:7px"><rect width="100" height="100" fill="#28a428"/><circle cx="50" cy="58" r="27" fill="none" stroke="white" stroke-width="10" stroke-dasharray="15 12" stroke-linecap="round" stroke-dashoffset="8"/><polygon points="67,13 83,40 51,40" fill="#e8192c"/></svg></a>';
          h+='</div></div>';
        });
      } else {
      var byT={},tOrd=[];
      ...
      tOrd.forEach(function(t){
        var sample=byT[t][0];
        var ti=tInfo(t);
        var flag=FLAGS[sample.tournament_country||'']||'';if(!flag){var _m=t.match(/\(([^)]+)\)/);if(_m){var _cn={'Spain':'ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¸','USA':'ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¸','Japan':'ÃÂ°ÃÂÃÂÃÂ¯ÃÂ°ÃÂÃÂÃÂµ','France':'ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ·','Italy':'ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ¹','Germany':'ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂª','Australia':'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂº','Argentina':'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ·','Canada':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¦','Brazil':'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ·','Netherlands':'ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ±','Switzerland':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ­','Romania':'ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂ´','Poland':'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ±','Czech Republic':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¿','Austria':'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ¹','Greece':'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ·','Belgium':'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂª','Sweden':'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂª','Norway':'ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ´','Denmark':'ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ°','Serbia':'ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂ¸','Croatia':'ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂ·','Hungary':'ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂº','Portugal':'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¹','Colombia':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ´','Chile':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ±','Mexico':'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ½','Morocco':'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¦','Turkey':'ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ·','China':'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ³','India':'ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ³','South Korea':'ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ·','Ecuador':'ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¨','Peru':'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂª','Uruguay':'ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¾','Paraguay':'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¾','Bolivia':'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ´','Guatemala':'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ¹','Kazakhstan':'ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ¿','Tunisia':'ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ³','Egypt':'ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¬','South Africa':'ÃÂ°ÃÂÃÂÃÂ¿ÃÂ°ÃÂÃÂÃÂ¦','Kenya':'ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂª','Great Britain':'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ§','United Kingdom':'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ§','Ireland':'ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂª','Slovakia':'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ°','Bulgaria':'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¬','Finland':'ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ®','Estonia':'ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂª','Lithuania':'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ¹','Latvia':'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ»','Slovenia':'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ®'};var _k=_m[1].trim();flag=_cn[_k]||FLAGS[_k]||''}};
        ...
        byT[t].forEach(function(m){
          ...
          for(var si=0;si<maxSi;si++){
            ...
            // Dokonceny set ÃÂ¢ÃÂÃÂ maly, sedy, bez pozadi
          ...
          h+='</div>';
          h+=_starBtn(m.id);h+='<button onclick="var f=JSON.parse(localStorage.getItem(\x27ts_favs\x27)||\x27[]\x27);var id=\x27'+m.id+'\x27;var i=f.indexOf(id);if(i>-1)f.splice(i,1);else f.push(id);localStorage.setItem(\x27ts_favs\x27,JSON.stringify(f));var on=f.indexOf(id)>-1;this.innerHTML=on?\x27&#9733;\x27:\x27&#9734;\x27;this.style.color=on?\x27#FFD700\x27:\x27rgba(255,255,255,0.28)\x27;event.stopPropagation()" style="background:none;border:none;font-size:20px;line-height:1;cursor:pointer;padding:0 3px 0 0;flex-shrink:0;color:rgba(255,255,255,0.28)">&#9734;</button>';h+='<a href="'+m.url+'" target="_blank" onclick="event.stopPropagation()" title="Flashscore" style="flex-shrink:0;margin:0 8px;width:28px;height:28px;border-radius:7px;overflow:hidden;display:block;text-decoration:none;">';
  ...
  async function tick(){
    try{
      ...
      if(!_lastUpdated)wrap.innerHTML='<div style="padding:60px;text-align:center;color:rgba(255,255,255,.2);">ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ '+e.message+'</div>';
    }
  }
  function render(){wrap.innerHTML='<div style="padding:60px;text-align:center;color:rgba(255,255,255,.2);">ÃÂ¢ÃÂÃÂ³ NaÃÂÃÂÃÂÃÂ­tÃÂÃÂ¡m...</div>';tick();}
...
function buildUI(){
  ...
  sidebar.innerHTML=`
    <div id="sb-logo">
      <div id="sb-logo-icon">ÃÂ°ÃÂÃÂÃÂ¾</div>
      <div id="sb-logo-text">Tennis<span>Scout</span></div>
      <div id="sb-badge">v${VERSION}</div>
    </div>
    <nav id="sb-nav">
      <div class="nav-section">PÃÂÃÂehled</div>
      <div class="nav-item active" data-view="home" id="nav-home">
        <span class="nav-icon">ÃÂ¢ÃÂÃÂ</span> RozcestnÃÂÃÂ­k
      </div>
      <div class="nav-section">Moduly</div>
      <div class="nav-item" data-view="tournaments" id="nav-tournaments">
        <span class="nav-icon">ÃÂ°ÃÂÃÂÃÂ</span> Turnaje
        <span class="nav-badge" id="nav-count">795</span>
      </div>
      <div class="nav-item" data-view="matches" id="nav-matches"><span class="nav-icon">ÃÂ°ÃÂÃÂÃÂ¾</span> ZÃÂÃÂ¡pasy
        <span class="nav-badge" id="nav-matches-count"></span>
      </div><div class="nav-item" data-view="players" id="nav-players">
        <span class="nav-icon">ÃÂ°ÃÂÃÂÃÂ¤</span> HrÃÂÃÂ¡ÃÂÃÂi ATP
        <span class="nav-badge" id="nav-players-count">1454</span>
      </div>
      <div class="nav-item disabled">
        <span class="nav-icon">ÃÂ°ÃÂÃÂÃÂ</span> Kurzy
        <span class="nav-soon">brzy</span>
      </div>
      <div class="nav-item disabled">
        <span class="nav-icon">ÃÂ¢ÃÂÃÂ¡</span> Live zÃÂÃÂ¡pasy
        <span class="nav-soon">brzy</span>
      </div>
      <div class="nav-item disabled">
        <span class="nav-icon">ÃÂ°ÃÂÃÂÃÂ</span> Statistiky
        <span class="nav-soon">brzy</span>
      </div>
    </nav>
    <div id="sb-footer">
      <button id="sb-reload">ÃÂ¢ÃÂÃÂ» Reload dat</button>
      <button id="sb-close">ÃÂ¢ÃÂÃÂ ZavÃÂÃÂÃÂÃÂ­t</button>
    </div>
  `;
  ...
  topbar.innerHTML=`
    <div id="topbar-title">RozcestnÃÂÃÂ­k</div>
    <div id="topbar-sub">Tennis Scout</div>
    <div id="topbar-stats">
      <div class="ts-stat">
        <div class="ts-stat-val" id="nt">ÃÂ¢ÃÂÃÂ</div>
        <div class="ts-stat-lbl">TurnajÃÂÃÂ¯</div>
      </div>
      <div class="ts-stat">
        <div class="ts-stat-val green" id="ns">ÃÂ¢ÃÂÃÂ</div>
  ...
  [['ALL','VÃÂÃÂ¡e',true],['ATP','ATP'],['WTA','WTA'],['CHALL','Challenger'],['ITF','ITF']].forEach(([c,t,on])=>{
    const b=el('button',null,'fb'+(on?' on':''));b.dataset.c=c;b.textContent=t;fr1.appendChild(b);
  });
  const srch=el('input','srch');srch.placeholder='ÃÂ°ÃÂÃÂÃÂ  Hledat...';fr1.appendChild(srch);
  filterbar.appendChild(fr1);
  const fr2=el('div',null,'fr');
  fr2.style.paddingBottom='10px';
  fr2.innerHTML=`<span class="fl">Povrch</span>`;
  [['VÃÂÃÂ¡echny',true],['TvrdÃÂÃÂ½'],['Antuka'],['TrÃÂÃÂ¡va'],['KrytÃÂÃÂ½']].forEach(([s,on])=>{
  ...
  const itft=el('div','itft');itft.textContent='NaÃÂÃÂÃÂÃÂ­tÃÂÃÂ¡m ITF data...';itfs.appendChild(itft);
  body.appendChild(itfs);
  // Loader
  const load=el('div','load');
  load.style.display='none';
  load.innerHTML=`<div class="spin"></div><div id="prog">ATP/WTA/Challenger: naÃÂÃÂteno ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂekÃÂÃÂ¡m na ITF API...</div>`;
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ NAVIGACE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  function goView(view){
    ...
    // Topbar title
    const titles={home:'RozcestnÃÂÃÂ­k',tournaments:'Turnaje 2026',players:'HrÃÂÃÂ¡ÃÂÃÂi ATP'};
  ...
  // Players toggle pro zpÃÂÃÂtnou kompatibilitu
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ RENDER ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
function setupRender({sh,body,mnav}){
  let aC='ALL',aS='VÃÂÃÂ¡echny',sq='',exId=null;

  function filtered(){
    return(window._tsData||[]).filter(t=>{
      if(aC!=='ALL'&&t.cat!==aC)return false;
      if(aS!=='VÃÂÃÂ¡echny'&&t.surf!==aS)return false;
  ...
  function render(){
    ...
    if(!ts.length){[...body.children].forEach(el=>{if(el.id!=='pw'&&el.id!=='home-view')el.remove()});const e=document.createElement('div');e.style.cssText='text-align:center;padding:60px;color:#5a6070;';e.textContent='ÃÂÃÂ½ÃÂÃÂ¡dnÃÂÃÂ© turnaje.';body.appendChild(e);return;}

    let html='';
    Object.keys(byM).sort((a,b)=>+a-+b).forEach(m=>{
      const arr=byM[m];
      html+=`<div class="mg" id="m${m}"><div class="mh"><div class="mn">${MCS[m]}</div><div class="mc">${arr.length} turnajÃÂÃÂ¯</div></div><table><thead><tr><th style="width:18px"></th><th>Turnaj</th><th>Datum</th><th>Povrch</th><th>Los</th></tr></thead><tbody>`;
      arr.forEach((t,i)=>{
        const uid=`${m}_${i}`,ex=exId===uid,live=isLive(t.start,t.end);
        html+=`<tr class="r${ex?' ex':''}" data-uid="${uid}"><td><span class="cv">ÃÂ¢ÃÂÃÂº</span></td><td><span class="ct c${t.cat}">${t.cat}</span><span class="tr ${tierCls(t.tier)}">${t.tier||'ÃÂ¢ÃÂÃÂ'}</span><span class="nm">${live?'<span class="live"></span>':''}${t.name}</span><span class="lc">${t.loc}${t.country?' ('+t.country+')':''}</span></td><td class="dt">${fmtRange(t.start,t.end)}</td><td><span class="sp ${surfSp(t.surf)}">${t.surf}</span></td><td style="font-family:monospace;font-size:10px;color:#5a6070">${t.sgl>0?t.sgl:'ÃÂ¢ÃÂÃÂ'}</td></tr>`;
        if(ex){
          const altLabel=t.alt>0?`${t.alt} m n.m.${t.alt>1000?' ÃÂ°ÃÂÃÂÃÂ´':t.alt>500?' ÃÂ°ÃÂÃÂÃÂ¡':''}`:t.cat==='ITF'?'ÃÂ¢ÃÂÃÂ':'0 m';
        const ioLabel=t.io==='I'?'ÃÂ°ÃÂÃÂÃÂ  KrytÃÂÃÂ¡ hala':'ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ VenkovnÃÂÃÂ­';
        const winnersHtml=(t.winners&&t.winners.length>0&&t.winners[0]!=='ÃÂ¢ÃÂÃÂ')?t.winners.slice(0,3).map((w,i)=>`<div style="font-size:9px;color:#5a6070;font-family:monospace">${2025-i}: <span style="color:#e8eaf0;font-weight:600">${w}</span></div>`).join(''):'<span style="color:#5a6070;font-size:10px">ÃÂ¢ÃÂÃÂ</span>';
        html+=`<tr class="xr"><td colspan="5"><div class="xc" style="grid-template-columns:1fr 1fr 1fr 1fr"><div><h4>Info</h4><div class="ig"><div><label>Okruh</label><span>${t.cat}</span></div><div><label>Tier</label><span>${t.tier||'ÃÂ¢ÃÂÃÂ'}</span></div><div><label>Povrch</label><span>${t.surf}</span></div><div><label>Lokace</label><span>${ioLabel}</span></div><div><label>Los SGL</label><span>${t.sgl>0?t.sgl+' hr':'ÃÂ¢ÃÂÃÂ'}</span></div><div><label>Los DBL</label><span>${t.dbl>0?t.dbl+' pÃÂÃÂ¡rÃÂÃÂ¯':'ÃÂ¢ÃÂÃÂ'}</span></div></div></div><div><h4>Lokalita & vÃÂÃÂ½ÃÂÃÂ¡ka</h4><div style="font-size:12px;color:#e8eaf0;font-weight:600;margin-bottom:4px">${t.name}</div><div style="font-size:10px;color:#5a6070">${t.loc}${t.country?' ('+t.country+')':''}</div><div style="font-size:10px;color:#c8f135;margin-top:6px;font-family:monospace;font-weight:600">${altLabel}</div><div style="font-size:9px;color:#5a6070;margin-top:2px;font-family:monospace">${t.start||'?'} ÃÂ¢ÃÂÃÂ ${t.end||'?'}</div></div><div><h4>Prize money</h4><div style="font-size:16px;color:#c8f135;font-weight:700;font-family:monospace">${t.prize||'ÃÂ¢ÃÂÃÂ'}</div><div style="font-size:9px;color:#5a6070;margin-top:2px">VÃÂÃÂ­tÃÂÃÂz singlu</div><div style="margin-top:8px;font-size:9px;color:#5a6070;text-transform:uppercase;letter-spacing:1px">Stav</div><div style="color:${live?'#f13570':'#5a6070'};font-size:${live?12:11}px;font-weight:${live?700:400};margin-top:2px">${live?'ÃÂ°ÃÂÃÂÃÂ´ ProbÃÂÃÂ­hÃÂÃÂ¡':'NadchÃÂÃÂ¡zejÃÂÃÂ­cÃÂÃÂ­'}</div></div><div><h4>VÃÂÃÂ­tÃÂÃÂzovÃÂÃÂ© (2025ÃÂ¢ÃÂÃÂ2023)</h4>${winnersHtml}</div></div></td></tr>`;
        }
      });
...
// PÃÂÃÂidej homeView do body
...
// 2. ITF + Players paralelnÃÂÃÂ na pozadÃÂÃÂ­
fetchPlayers(txt=>console.log('Players:',txt)).then(count=>{
  console.log('ÃÂ¢ÃÂÃÂ ATP hrÃÂÃÂ¡ÃÂÃÂi naÃÂÃÂteni:',count);
}).catch(e=>console.warn('ATP players:',e.message));

fetchITF(txt=>{setP(txt);}).then(itfItems=>{
  window._tsData.push(...itfItems);
  // PYidej ZÃÂ¯ÃÂ¿ÃÂ½pasy panel  po settlenutÃÂ¯ÃÂ¿ÃÂ½ DOM
  setTimeout(function(){
  ...
  if(hcT)hcT.textContent=window._tsData.length+' turnÃÂÃÂ¡jÃÂÃÂ¯';
  ...
  console.log('ÃÂ°ÃÂÃÂÃÂ¾ Tennis Scout v'+VERSION+' ÃÂ¢ÃÂÃÂ '+window._tsData.length+' turnÃÂÃÂ¡jÃÂÃÂ¯');
