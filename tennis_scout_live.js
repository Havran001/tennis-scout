// v1775838683
// ===+'<td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;white-space:nowrap;">'+(m.dr||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.a_pct||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.va_pct||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.first_in||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.first_pct||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.second_pct||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.bp_saved||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);">'+(m.match_time||'—')+'</td>'=======================================================
...
function buildH2HTab(sh){
  ...
  function renderH2H(p1,p2,hist1,hist2){
    ...
    if(h2h.length){
      ...
      html+='<thead><tr>';
      ['Datum','Turnaj','Povrch','Kolo','Rk','vRk','Skóre','DR','A%','vA%','1stIn','1st%','2nd%','BPsv','T',''].forEach(function(c){html+='<th style="padding:5px 8px;font-size:8px;color:rgba(255,255,255,.25);letter-spacing:1px;text-align:left;border-bottom:1px solid rgba(255,255,255,.06);">'+c+'</th>';});
      html+='</tr></thead><tbody>';
...
(function waitForH2H(){
  ...
  var timer=setInterval(function(){
    ...
    function renderH2H(p1,p2,h1,h2){
      ...
      if(h2hM.length){html+='<div style="margin-top:14px;"><div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;padding-bottom:8px;border-bottom:1px solid rgba(255,255,255,.04);">Vzájemné zápasy ('+h2hM.length+')</div><table style="width:100%;border-collapse:collapse;"><thead><tr>'+[['Datum','Turnaj','Povrch','Kolo','Rk','vRk','Skóre','DR','A%','vA%','1stIn','1st%','2nd%','BPsv','T',''].map(function(c){return '<th style="padding:4px 8px;font-size:8px;color:rgba(255,255,255,.25);letter-spacing:1px;text-align:left;border-bottom:1px solid rgba(255,255,255,.06);">'+c+'</th>';}).join('')+'</tr></thead><tbody>'+h2hM.map(function(m,i){var bg=i%2===0?'transparent':'rgba(255,255,255,.012)';return '<tr style="background:'+bg+';border-bottom:1px solid rgba(255,255,255,.03);"><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+fDate(m.date)+'</td><td style="padding:5px 8px;font-size:11px;color:#e6edf3;max-width:180px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">'+(m.tournament||'—')+'</td><td style="padding:5px 8px;"><span style="font-size:9px;font-weight:700;color:'+sColor(m.surface)+';background:rgba(255,255,255,.05);padding:2px 6px;border-radius:3px;">'+sLabel(m.surface||'')+'</span></td><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.round||'—')+'</td><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.rank||'—')+'</td><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.opp_rank||'—')+'</td><td style="padding:5px 8px;font-size:12px;font-weight:600;font-family:monospace;color:#e6edf3;">'+(m.score||'—')+'</td><td style="padding:5px 8px;font-size:13px;font-weight:800;color:'+rColor(m.result)+';"> '+(m.result||'?')+'</td+'<td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;white-space:nowrap;">'+(m.dr||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.a_pct||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.va_pct||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.first_in||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.first_pct||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.second_pct||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);font-family:monospace;">'+(m.bp_saved||'—')+'</td><td style="padding:4px 6px;font-size:10px;color:rgba(255,255,255,.45);">'+(m.match_time||'—')+'</td>'></tr>';}).join('')+'</tbody></table></div>';}
