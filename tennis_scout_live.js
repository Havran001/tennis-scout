    ...
    if(!shown.length){h+='<div style="padding:60px;text-align:center;color:rgba(255,255,255,.2);">Žádné zápasy</div>';}
      ...
      tOrd.forEach(function(t){
        ...
        byT[t].forEach(function(m){
          ...
          h+='</div>';
          if(ns>0&&m.isFin){var _sc1=0,_sc2=0;var scoreH='<div style="display:flex;flex-direction:column;gap:1px;margin-left:4px;">';for(var si=0;si<ns;si++){var sv1=parseInt(m.sets1[si]||0),sv2=parseInt(m.sets2[si]||0);if(sv1>sv2)_sc1++;else if(sv2>sv1)_sc2++;scoreH+='<div style="display:flex;gap:3px;"><span style="font-size:15px;line-height:1.3;font-weight:500;color:rgba(255,255,255,.55);">'+sv1+'</span><span style="font-size:15px;line-height:1.3;font-weight:500;color:rgba(255,255,255,.55);">'+sv2+'</span></div>';}scoreH+='</div>';if(_sc1>0||_sc2>0){h+='<div style="display:flex;flex-direction:column;gap:1px;margin-left:4px;"><span style="font-size:15px;font-weight:700;color:#fff;line-height:1.3;">'+_sc1+'</span><span style="font-size:15px;font-weight:700;color:#fff;line-height:1.3;">'+_sc2+'</span></div>';}h+=scoreH;}
