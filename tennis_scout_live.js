...
function _renderMatches(){
            ...
            var mhCss=[
              ...
              '.lvl-atp{color:#60a5fa;font-weight:800;font-size:11px;background:rgba(96,165,250,0.15);padding:1px 5px;border-radius:3px;}',
              '.lvl-ch{color:#fcd34d;font-weight:800;font-size:11px;background:rgba(252,211,77,0.15);padding:1px 5px;border-radius:3px;}',
              '.lvl-itf{color:#a78bfa;font-weight:800;font-size:11px;background:rgba(167,139,250,0.15);padding:1px 5px;border-radius:3px;}',
