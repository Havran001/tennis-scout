      ...
      function _loadMatchHistory(pid,pname,sh){
        ...
        .then(function(hist){
          ...
          function _renderMatches(){
              ...
              hm+='<div data-surface="'+_sc+'" style="display:flex;align-items:center;gap:10px;padding:7px 10px 7px 14px;border-bottom:1px solid rgba(255,255,255,.04);border-left:3px solid '+(_isW?'rgba(0,200,83,0.5)':'rgba(239,68,68,0.4)')+';margin-bottom:1px;border-radius:0 4px 4px 0;">'
                ...
                +'<div style="flex:1;min-width:0;">'
                  ...
                  +'<div style="display:flex;align-items:center;gap:5px;flex-wrap:wrap;">'
                    ...
                    +'<span style="font-size:9px;color:rgba(255,255,255,.2);">Â·</span>'
            ...
            if(lastYear)hm+='</div>';
            if(!filtered.length)hm='<div style="padding:40px;text-align:center;color:rgba(255,255,255,.2);font-size:13px;">Å½Ã¡dnÃ© zÃ¡pasy pro tento filtr</div>';
          ...
          h+='<div style="display:flex;gap:8px;align-items:center;padding:12px 0 14px;border-bottom:1px solid rgba(255,255,255,.06);flex-wrap:wrap;">'
            ...
            +'<select id="mh-f-surface" style="'+selStyle+'">'
              +'<option value="">VÅ¡echny povrchy</option>'
            ...
            +'</select>'
            // Reset
            +'<button id="mh-f-reset" style="background:transparent;border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.4);font-size:11px;padding:6px 12px;border-radius:8px;cursor:pointer;">â Reset</button>'
