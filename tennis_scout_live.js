...
(function waitForH2H(){
  ...
  var timer=setInterval(function(){
    ...
    function renderH2H(p1,p2,h1,h2){
      ...
      if(h2hM.length){html+='<div style="margin-top:14px;"><div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;padding-bottom:8px;border-bottom:1px solid rgba(255,255,255,.04);">Vzájemné zápasy ('+h2hM.length+')</div><table style="width:100%;border-collapse:collapse;"><thead><tr>'+['Datum','Turnaj','Povrch','Kolo','Skóre','','Hráč','DR','A%','vA%','1st%','2nd%','T'].map(function(c){return '<th style="padding:4px 8px;font-size:8px;color:rgba(255,255,255,.25);letter-spacing:1px;text-align:left;border-bottom:1px solid rgba(255,255,255,.06);">'+c+'</th>';}).join('')+'</tr></thead><tbody>'+h2hM.map(function(m,i){var bg=i%2===0?'transparent':'rgba(255,255,255,.012)';return '<tr style="background:'+bg+';border-bottom:1px solid rgba(255,255,255,.03);"><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+fDate(m.date)+'</td><td style="padding:5px 8px;font-size:11px;color:#e6edf3;max-width:180px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">'+(m.tournament||'—')+'</td><td style="padding:5px 8px;"><span style="font-size:9px;font-weight:700;color:'+sColor(m.surface)+';background:rgba(255,255,255,.05);padding:2px 6px;border-radius:3px;">'+sLabel(m.surface||'')+'</span></td><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.round||'—')+'</td><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.rank||'—')+'</td><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.opp_rank||'—')+'</td><td style="padding:5px 8px;font-size:12px;font-weight:600;font-family:monospace;color:#e6edf3;">'+(m.score||'—')+'</td><td style="padding:5px 8px;font-size:13px;font-weight:800;color:'+rColor(m.result)+';"> '+(m.result||'?')+'</td>'+'<td colspan="7" style="padding:0;"></td>'+'</tr>'+'<tr style="background:rgba(255,255,255,.02);">'+'<td colspan="5" style="padding:0;"></td>'+'<td style="padding:3px 8px;font-size:10px;color:rgba(255,255,255,.55);font-style:italic;">'+p1n.split(' ').pop()+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m.dr||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m.a_pct||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m.va_pct||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m.first_pct||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m.second_pct||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m.match_time||'—')+'</td>'+'</tr>'+'<tr style="background:rgba(255,255,255,.01);border-bottom:2px solid rgba(255,255,255,.06);">'+'<td colspan="5" style="padding:0;"></td>'+(function(){var m2=(h2.matches||[]).find(function(x){return x.date===m.date&&(x.opponent||'').toLowerCase().split(' ').some(function(w){return p1n.toLowerCase().split(' ').some(function(v){return v.length>2&&w.includes(v);});});});if(!m2)return '<td colspan="7"></td>';return '<td style="padding:3px 8px;font-size:10px;color:rgba(255,255,255,.55);font-style:italic;">'+p2n.split(' ').pop()+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m2.dr||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m2.a_pct||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m2.va_pct||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m2.first_pct||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);font-family:monospace;text-align:right;">'+(m2.second_pct||'—')+'</td>'+'<td style="padding:3px 8px;font-size:11px;color:rgba(255,255,255,.5);">'+(m2.match_time||'—')+'</td>';})()+'</tr>';}).join('')+'</tbody></table></div>';}
