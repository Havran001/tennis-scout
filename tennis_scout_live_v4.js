...
function buildMatchesTab(sh){
  ...
  var activeDay=[-1,0,1,2,3],activeFilter='all',activeFilters=new Set(['all']),_cachedWithOdds=null,_activeFilterKey='all',activeSort='tournament',activeTier='all',activeFormat='all',_interval=null,_lastData=null,_lastUpdated='';
