...
(function waitForH2H(){
  ...
  var timer=setInterval(function(){
    ...
    function renderH2H(p1,p2,h1,h2){
      ...
      html+='<div style="flex:1;"><div style="font-size:10px;color:rgba(255,255,255,.3);margin-bottom:4px;">'+getFlag(p1.country)+' '+p1.country+'</div><div style="font-size:22px;font-weight:800;color:#fff;cursor:pointer;text-decoration:underline;text-decoration-color:rgba(255,255,255,.15);text-decoration-thickness:1px;text-underline-offset:4px;" data-h2h-pid="'+(p1.id||'')+'" title="Otevřít kartu hráče">'+p1n+'</div><div style="font-size:11px;color:rgba(255,255,255,.3);margin-top:3px;">#'+p1.rank+'</div></div>';
      ...
      html+='<div style="flex:1;text-align:right;"><div style="font-size:10px;color:rgba(255,255,255,.3);margin-bottom:4px;">'+p2.country+' '+getFlag(p2.country)+'</div><div style="font-size:22px;font-weight:800;color:#fff;cursor:pointer;text-decoration:underline;text-decoration-color:rgba(255,255,255,.15);text-decoration-thickness:1px;text-underline-offset:4px;" data-h2h-pid="'+(p2.id||'')+'" title="Otevřít kartu hráče">'+p2n+'</div><div style="font-size:11px;color:rgba(255,255,255,.3);margin-top:3px;">#'+p2.rank+'</div></div>';
      html+='</div>';
