...
// === taToBeSur PATCH - pÅidÃ¡vÃ¡ chybÄjÃ­cÃ­ zÃ¡znamy ===
(function(){
  var _w=setInterval(function(){
    ...
    var p=s.replace(
      'taToBeSur[sur]||sur',
      '({"aliassime":"auger","connell":"o","oconnell":"o","zandschulp":"van","jong":"de","agut":"bautista","fokina":"davidovich","minaur":"de","schwaerzler":"schwarzler","moller":"moeller"})[sur]||sur'
    );
