// v1776422048
// ==========================================================
// Ã°ÂÂÂ¾ TENNIS SCOUT Ã¢ÂÂ LIVE CALENDAR v5.0
// ATP/WTA/Challenger: statickÃÂ¡ data 2026 (z atptour.com PDF + wtatennis.com)
// ITF M15/M25/W15/W35+: live API itftennis.com (naÃÂÃÂ­tÃÂ¡ se pÃÂi spuÃÂ¡tÃÂnÃÂ­)
//
// Jak pouÃÂ¾ÃÂ­t:
//   1. OtevÃÂi www.itftennis.com/en/tournament-calendar/mens-world-tennis-tour-calendar/
//   2. Cmd + Option + J Ã¢ÂÂ konzole
//   3. VloÃÂ¾ skript Ã¢ÂÂ Enter Ã¢ÂÂ ÃÂekej ~20s na ITF data
//
//   ATP/WTA/Challenger se zobrazÃÂ­ okamÃÂ¾itÃÂ z jakÃÂ©koli strÃÂ¡nky.
//   ITF data se naÃÂtou pouze ze strÃÂ¡nky itftennis.com.
// ===============================================================
...
// ATP Rankings - naÃÂÃÂ­tÃÂ¡no z GitHubu (stejnÃÂ jako ITF data)
window.ATP_PLAYERS = [];
...
// Kontrola CSP
{
  ...
  if (url.startsWith('chrome://')||url.startsWith('about:')||url.startsWith('edge://')) {
    alert('Ã¢ÂÂ SpusÃÂ¥ skript na normÃÂ¡lnÃÂ­ strÃÂ¡nce Ã¢ÂÂ napÃÂ. otevÃÂi wikipedia.org'); return;
  }
  if (window.trustedTypes) {
    try { window.trustedTypes.createPolicy('ts-probe-'+Date.now(),{createHTML:s=>s}); }
    catch(e) { if(e.message.includes('disallowed')) { alert('Ã¢ÂÂ Tato strÃÂ¡nka blokuje skript (CSP).\nÃ¢ÂÂ OtevÃÂi wikipedia.org a spusÃÂ¥ tam.'); return; } }
  }
}

// Ã¢ÂÂÃ¢ÂÂ STATICKÃÂ DATA 2026 Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
// FormÃÂ¡t: [name, loc, tier, surf, io, alt_m, start, end, sgl, dbl, prize, {a:winners_ATP, w:winners_WTA}]
// io: "O"=outdoor, "I"=indoor
// alt_m: nadmoÃÂskÃÂ¡ vÃÂ½ÃÂ¡ka v metrech (0 = u moÃÂe / neuvedeno)
// prize: prize money pro singla vÃÂ­tÃÂze v USD (ATP pokud combined, jinak M/W)
// winners: poslednÃÂ­ 3 roky [2025, 2024, 2023]

const ATP = [
  // LEDEN
  ["United Cup","Perth/Sydney, AUS","TÃÂ½m.event","TvrdÃÂ½","O",15,"2026-01-02","2026-01-11",0,0,"Ã¢ÂÂ",{w:["Polsko","Polsko","USA"]}],
  ["Brisbane International","Brisbane, AUS","ATP250","TvrdÃÂ½","O",27,"2026-01-04","2026-01-11",32,24,"$604k",{w:["Rune","Fonseca","Shelton"]}],
  ["Bank of China Hong Kong Open","Hong Kong","ATP250","TvrdÃÂ½","O",10,"2026-01-05","2026-01-11",28,16,"$604k",{w:["Bublik","Bublik","Bublik"]}],
  ["Adelaide International","Adelaide, AUS","ATP250","TvrdÃÂ½","O",48,"2026-01-12","2026-01-17",28,24,"$604k",{w:["Machac","Korda","Rublev"]}],
  ["ASB Classic","Auckland, NZL","ATP250","TvrdÃÂ½","O",25,"2026-01-12","2026-01-17",28,16,"$604k",{w:["Mensik","Paul","Cressy"]}],
  ["Australian Open","Melbourne, AUS","Grand Slam","TvrdÃÂ½","O",31,"2026-01-18","2026-02-01",128,64,"$2,9M AUD",{w:["Alcaraz","Sinner","Djokovic"]}],
  // ÃÂNOR
  ["Open Occitanie","Montpellier, FRA","ATP250","TvrdÃÂ½","I",1,"2026-02-02","2026-02-08",28,16,"$604k",{w:["Humbert","Humbert","Bublik"]}],
  ["Nexo Dallas Open","Dallas, USA","ATP500","TvrdÃÂ½","I",139,"2026-02-09","2026-02-15",32,16,"$1,96M",{w:["Draper","Fritz","Opelka"]}],
  ["ABN AMRO Open","Rotterdam, NED","ATP500","TvrdÃÂ½","I",1,"2026-02-09","2026-02-15",32,16,"$1,96M",{w:["Medvedev","Sinner","Rublev"]}],
  ["IEB+ Argentina Open","Buenos Aires, ARG","ATP250","Antuka","O",25,"2026-02-09","2026-02-15",28,16,"$604k",{w:["Cerundolo","Cerundolo","Djokovic"]}],
  ["Qatar ExxonMobil Open","Doha, QAT","ATP500","TvrdÃÂ½","O",11,"2026-02-16","2026-02-22",32,16,"$1,96M",{w:["Rublev","Medvedev","Djokovic"]}],
  ["Rio Open","Rio de Janeiro, BRA","ATP500","Antuka","O",10,"2026-02-16","2026-02-22",32,16,"$1,96M",{w:["Fonseca","Cerundolo","Tsitsipas"]}],
  ["Delray Beach Open","Delray Beach, USA","ATP250","TvrdÃÂ½","O",3,"2026-02-16","2026-02-22",28,16,"$604k",{w:["Paul","Korda","Tiafoe"]}],
  ["Mubadala Citi DC Open","Washington DC, USA","ATP500","TvrdÃÂ½","O",7,"2026-02-23","2026-03-01",48,16,"$1,96M",{w:["Fritz","Fritz","Zverev"]}],
  ["Mexican Open","Acapulco, MEX","ATP500","TvrdÃÂ½","O",3,"2026-02-23","2026-03-01",32,16,"$1,96M",{w:["Alcaraz","Alcaraz","Alcaraz"]}],
  ["Dubai Duty Free Championships","Dubai, UAE","ATP500","TvrdÃÂ½","O",5,"2026-02-23","2026-03-01",32,16,"$1,96M",{w:["Medvedev","Djokovic","Rublev"]}],
  ["Movistar Chile Open","Santiago, CHI","ATP250","Antuka","O",520,"2026-02-23","2026-03-01",28,16,"$604k",{w:["Jarry","Tabilo","Jarry"]}],
  // BÃÂEZEN
  ["BNP Paribas Open","Indian Wells, USA","Masters1000","TvrdÃÂ½","O",485,"2026-03-04","2026-03-15",96,32,"$1,15M",{w:["Draper","Alcaraz","Alcaraz"]}],
  ["Miami Open","Miami, USA","Masters1000","TvrdÃÂ½","O",2,"2026-03-18","2026-03-29",96,32,"$1,2M",{w:["Sinner","Sinner","Alcaraz"]}],
  ...
  // ÃÂERVEN
  ["Libema Open","'s-Hertogenbosch, NED","ATP250","TrÃÂ¡va","O",5,"2026-06-08","2026-06-14",28,16,"$604k",{w:["Rune","Griekspoor","Bublik"]}],
  ["BOSS Open","Stuttgart, GER","ATP250","TrÃÂ¡va","O",226,"2026-06-08","2026-06-14",28,16,"$604k",{w:["Ruud","Rune","Auger-Aliassime"]}],
  ["Terra Wortmann Open","Halle, GER","ATP500","TrÃÂ¡va","O",65,"2026-06-15","2026-06-21",32,16,"$1,96M",{w:["Sinner","Sinner","Rublev"]}],
  ["HSBC Championships","London, GBR","ATP500","TrÃÂ¡va","O",11,"2026-06-15","2026-06-21",32,16,"$1,96M",{w:["Djokovic","Fritz","Paul"]}],
  ["Mallorca Championships","Mallorca, ESP","ATP250","TrÃÂ¡va","O",14,"2026-06-21","2026-06-27",28,16,"$604k",{w:["Ruusuvuori","Fognini","Fognini"]}],
  ["Rothesay International","Eastbourne, GBR","ATP250","TrÃÂ¡va","O",5,"2026-06-22","2026-06-28",28,16,"$604k",{w:["Norrie","Norrie","Norrie"]}],
  ["Wimbledon","London, GBR","Grand Slam","TrÃÂ¡va","O",43,"2026-06-29","2026-07-12",128,64,"$2,9M GBP",{w:["Alcaraz","Alcaraz","Alcaraz"]}],
  // ÃÂERVENEC
  ["Nordea Open","BÃÂ¥stad, SWE","ATP250","Antuka","O",12,"2026-07-13","2026-07-19",28,16,"$604k",{w:["Ruud","Rune","Rune"]}],
  ...
  ["Generali Open","KitzbÃÂ¼hel, AUT","ATP250","Antuka","O",762,"2026-07-19","2026-07-25",28,16,"$604k",{w:["Altmaier","Struff","Struff"]}],
  ["Millennium Estoril Open","Estoril, POR","ATP250","Antuka","O",149,"2026-07-20","2026-07-26",28,16,"$604k",{w:["Rune","Monfils","Norrie"]}],
  ["Mifel Tennis Open","Los Cabos, MEX","ATP250","TvrdÃÂ½","O",14,"2026-07-20","2026-07-26",28,16,"$604k",{w:["Rune","Fonseca","Zverev"]}],
  ["Mubadala Citi DC Open","Washington DC, USA","ATP500","TvrdÃÂ½","O",7,"2026-07-27","2026-08-02",48,16,"$1,96M",{w:["Shelton","Fritz","Shelton"]}],
  // SRPEN
  ["National Bank Open","Montreal/Toronto, CAN","Masters1000","TvrdÃÂ½","O",30,"2026-08-03","2026-08-16",96,32,"$857k",{w:["Sinner","Sinner","Alcaraz"]}],
  ["Cincinnati Open","Cincinnati, USA","Masters1000","TvrdÃÂ½","O",226,"2026-08-17","2026-08-23",96,32,"$857k",{w:["Sinner","Djokovic","Alcaraz"]}],
  ["Winston-Salem Open","Winston-Salem, USA","ATP250","TvrdÃÂ½","O",270,"2026-08-23","2026-08-29",48,16,"$604k",{w:["Paul","Mannarino","Cressy"]}],
  ["US Open","New York, USA","Grand Slam","TvrdÃÂ½","O",6,"2026-08-31","2026-09-13",128,64,"$3,6M",{w:["Sinner","Sinner","Medvedev"]}],
  // ZÃÂÃÂÃÂ
  ["Chengdu Open","Chengdu, CHN","ATP250","TvrdÃÂ½","O",500,"2026-09-21","2026-09-27",28,16,"$604k",{w:["Sinner","Medvedev","Wu"]}],
  ["Hangzhou Open","Hangzhou, CHN","ATP250","TvrdÃÂ½","O",7,"2026-09-21","2026-09-27",28,16,"$604k",{w:["Bublik","Zverev","Davidovich"]}],
  ["Laver Cup","London, GBR","Exhibice","TvrdÃÂ½","I",43,"2026-09-25","2026-09-27",0,0,"Ã¢ÂÂ",{w:["Evropa","SvÃÂt","Evropa"]}],
  ["Kinoshita Japan Open","Tokyo, JPN","ATP500","TvrdÃÂ½","O",40,"2026-09-28","2026-10-04",32,16,"$1,96M",{w:["Rune","Paul","Tsitsipas"]}],
  ["China Open","Beijing, CHN","ATP500","TvrdÃÂ½","O",43,"2026-09-28","2026-10-04",32,16,"$1,96M",{w:["Sinner","Sinner","Alcaraz"]}],
  // ÃÂÃÂJEN
  ["Rolex Shanghai Masters","Shanghai, CHN","Masters1000","TvrdÃÂ½","O",4,"2026-10-05","2026-10-18",96,32,"$1,12M",{w:["Sinner","Djokovic","Medvedev"]}],
  ["Almaty Open","Almaty, KAZ","ATP250","TvrdÃÂ½","I",775,"2026-10-19","2026-10-25",28,16,"$604k",{w:["Rune","Rublev","Bublik"]}],
  ["European Open","Antwerp, BEL","ATP250","TvrdÃÂ½","I",12,"2026-10-19","2026-10-25",28,16,"$604k",{w:["Paul","Rublev","Sinner"]}],
  ["Grand Prix Auvergne-RhÃÂ´ne-Alpes","Lyon, FRA","ATP250","TvrdÃÂ½","I",173,"2026-10-19","2026-10-25",28,16,"$604k",{w:["Tiafoe","Fils","Mannarino"]}],
  ["Swiss Indoors Basel","Basel, SUI","ATP500","TvrdÃÂ½","I",260,"2026-10-26","2026-11-01",28,16,"$1,96M",{w:["Sinner","Sinner","Djokovic"]}],
  ["Erste Bank Open","Vienna, AUT","ATP500","TvrdÃÂ½","I",171,"2026-10-26","2026-11-01",32,16,"$1,96M",{w:["Draper","Sinner","Rublev"]}],
  // LISTOPAD
  ["Rolex Paris Masters","Paris, FRA","Masters1000","TvrdÃÂ½","I",35,"2026-11-02","2026-11-08",48,24,"$857k",{w:["Zverev","Djokovic","Djokovic"]}],
  ["BNP Paribas Nordic Open","Stockholm, SWE","ATP250","TvrdÃÂ½","I",28,"2026-11-09","2026-11-15",28,16,"$604k",{w:["Rune","Rune","Nishioka"]}],
  ["Nitto ATP Finals","Turin, ITA","Finals","TvrdÃÂ½","I",239,"2026-11-15","2026-11-22",8,8,"$2,6M",{w:["Sinner","Sinner","Djokovic"]}],
  ["Next Gen ATP Finals","Jeddah, KSA","NextGen","TvrdÃÂ½","I",612,"2026-12-16","2026-12-20",8,0,"$1,8M",{w:["Fonseca","Mensik","Fils"]}],
];

const WTA = [
  // LEDEN
  ["United Cup","Perth/Sydney, AUS","TÃÂ½m.event","TvrdÃÂ½","O",15,"2026-01-02","2026-01-11",0,0,"Ã¢ÂÂ",{w:["Polsko","Polsko","USA"]}],
  ["Brisbane International","Brisbane, AUS","WTA500","TvrdÃÂ½","O",27,"2026-01-04","2026-01-11",32,16,"$235k",{w:["Sabalenka","Gauff","Azarenka"]}],
  ["Adelaide International","Adelaide, AUS","WTA500","TvrdÃÂ½","O",48,"2026-01-05","2026-01-11",32,16,"$235k",{w:["Svitolina","Rybakina","Barty"]}],
  ["ASB Classic","Auckland, NZL","WTA250","TvrdÃÂ½","O",25,"2026-01-05","2026-01-11",32,16,"$235k",{w:["Svitolina","Osaka","Vandeweghe"]}],
  ["Hobart International","Hobart, AUS","WTA250","TvrdÃÂ½","O",54,"2026-01-12","2026-01-18",32,16,"$235k",{w:["Cocciaretto","Kvitova","Stosur"]}],
  ["Australian Open","Melbourne, AUS","Grand Slam","TvrdÃÂ½","O",31,"2026-01-18","2026-02-01",128,64,"$2,9M AUD",{w:["Rybakina","Sabalenka","Sabalenka"]}],
  // ÃÂNOR
  ["Thames International","London, GBR","WTA500","TvrdÃÂ½","I",11,"2026-02-02","2026-02-08",28,16,"$235k",{w:["Andreeva","Rybakina","Ã¢ÂÂ"]}],
  ["Cali Open","Cali, COL","WTA250","Antuka","O",995,"2026-02-02","2026-02-08",32,16,"$115k",{w:["Sorribes Tormo","Sorribes Tormo","Osorio"]}],
  ["Abu Dhabi Open","Abu Dhabi, UAE","WTA500","TvrdÃÂ½","O",27,"2026-02-02","2026-02-08",28,16,"$235k",{w:["Muchova","Rybakina","Ã¢ÂÂ"]}],
  ["Qatar TotalEnergies Open","Doha, QAT","WTA1000","TvrdÃÂ½","O",11,"2026-02-09","2026-02-15",56,28,"$665k",{w:["Muchova","Swiatek","Swiatek"]}],
  ["Dubai Duty Free Championships","Dubai, UAE","WTA1000","TvrdÃÂ½","O",5,"2026-02-16","2026-02-22",56,28,"$665k",{w:["Pegula","Svitolina","Swiatek"]}],
  ["Rio Open","Rio de Janeiro, BRA","WTA250","Antuka","O",10,"2026-02-16","2026-02-22",32,16,"$115k",{w:["Sorribes Tormo","Sorribes Tormo","Osorio"]}],
  ["Abierto Mexicano Telcel","Acapulco, MEX","WTA250","TvrdÃÂ½","O",3,"2026-02-23","2026-03-01",32,16,"$115k",{w:["Samsonova","Osaka","Haddad Maia"]}],
  // BÃÂEZEN
  ["BNP Paribas Open","Indian Wells, USA","WTA1000","TvrdÃÂ½","O",485,"2026-03-04","2026-03-15",96,32,"$1,15M",{w:["Andreeva","Sabalenka","Swiatek"]}],
  ["Miami Open","Miami, USA","WTA1000","TvrdÃÂ½","O",2,"2026-03-18","2026-03-29",96,32,"$1,2M",{w:["Gauff","Swiatek","Swiatek"]}],
  ...
  ["Upper Austria Ladies Linz","Linz, AUT","WTA500","TvrdÃÂ½","I",266,"2026-04-06","2026-04-12",28,16,"$235k",{w:["Rybakina","Rybakina","Bencic"]}],
  ...
  // ÃÂERVEN
  ["Libema Open","'s-Hertogenbosch, NED","WTA500","TrÃÂ¡va","O",5,"2026-06-08","2026-06-14",28,16,"$235k",{w:["Rybakina","Vondrousova","Kontaveit"]}],
  ["Rothesay Open Nottingham","Nottingham, GBR","WTA250","TrÃÂ¡va","O",28,"2026-06-08","2026-06-14",32,16,"$115k",{w:["Paolini","Bouzkova","Brengle"]}],
  ["Bad Homburg Open","Bad Homburg, GER","WTA250","TrÃÂ¡va","O",149,"2026-06-15","2026-06-21",32,16,"$115k",{w:["Rybakina","Vondrousova","Kerber"]}],
  ["Berlin Ladies Open","Berlin, GER","WTA500","TrÃÂ¡va","O",34,"2026-06-15","2026-06-21",28,16,"$235k",{w:["Swiatek","Swiatek","Kvitova"]}],
  ["Rothesay International Eastbourne","Eastbourne, GBR","WTA250","TrÃÂ¡va","O",5,"2026-06-22","2026-06-28",32,16,"$115k",{w:["Rybakina","Gauff","Jabeur"]}],
  ["Wimbledon","London, GBR","Grand Slam","TrÃÂ¡va","O",43,"2026-06-29","2026-07-12",128,64,"$2,9M GBP",{w:["Rybakina","Vondrousova","Rybakina"]}],
  // ÃÂERVENEC
  ...
  ["Mubadala Citi DC Open","Washington DC, USA","WTA500","TvrdÃÂ½","O",7,"2026-07-20","2026-07-26",28,16,"$235k",{w:["Gauff","Gauff","Kontaveit"]}],
  // SRPEN
  ["National Bank Open","Toronto/Montreal, CAN","WTA1000","TvrdÃÂ½","O",105,"2026-08-03","2026-08-09",96,32,"$857k",{w:["Sabalenka","Swiatek","Swiatek"]}],
  ["Western & Southern Open","Cincinnati, USA","WTA1000","TvrdÃÂ½","O",226,"2026-08-10","2026-08-17",96,32,"$857k",{w:["Swiatek","Swiatek","Swiatek"]}],
  ["US Open","New York, USA","Grand Slam","TvrdÃÂ½","O",6,"2026-08-31","2026-09-13",128,64,"$3,6M",{w:["Sabalenka","Sabalenka","Swiatek"]}],
  // ZÃÂÃÂÃÂ
  ["Singapore Open","Singapore, SIN","WTA500","TvrdÃÂ½","I",15,"2026-09-21","2026-09-27",28,16,"$235k",{w:["Ã¢ÂÂ","Ã¢ÂÂ","Ã¢ÂÂ"]}],
  ["Guangzhou Open","Guangzhou, CHN","WTA250","TvrdÃÂ½","O",11,"2026-09-21","2026-09-27",32,16,"$115k",{w:["Zhu","Zheng","Zhu"]}],
  ["China Open","Beijing, CHN","WTA1000","TvrdÃÂ½","O",43,"2026-09-28","2026-10-04",96,32,"$857k",{w:["Sabalenka","Swiatek","Swiatek"]}],
  ["Wuhan Open","Wuhan, CHN","WTA1000","TvrdÃÂ½","O",23,"2026-09-28","2026-10-11",96,32,"$857k",{w:["Swiatek","Rybakina","Swiatek"]}],
  // ÃÂÃÂJEN
  ["Korea Open","Seoul, KOR","WTA250","TvrdÃÂ½","O",38,"2026-10-19","2026-10-25",32,16,"$115k",{w:["Osaka","Osaka","Azarenka"]}],
  ["Jiangxi Open","Nanchang, CHN","WTA250","TvrdÃÂ½","O",46,"2026-10-19","2026-10-25",32,16,"$115k",{w:["Zheng","Zheng","Kvitova"]}],
  ["Rolex Paris Masters","Paris, FRA","WTA1000","TvrdÃÂ½","I",35,"2026-10-26","2026-11-01",56,28,"$857k",{w:["Sabalenka","Swiatek","Ã¢ÂÂ"]}],
  // LISTOPAD
  ["Merida Open","Merida, MEX","WTA250","TvrdÃÂ½","O",9,"2026-11-02","2026-11-08",32,16,"$115k",{w:["Osorio","Osorio","Ã¢ÂÂ"]}],
  ["WTA Finals","Riyadh, KSA","Finals","TvrdÃÂ½","I",612,"2026-11-06","2026-11-14",8,8,"$2,2M",{w:["Sabalenka","Swiatek","Swiatek"]}],
];

const CHALL = [
  // LEDEN
  ["Bengaluru Open","Bengaluru, IND","CH125","TvrdÃÂ½","O",920,"2026-01-05","2026-01-10",32,16,"$175k",{w:["Martinez",""]}],
  ["Canberra International","Canberra, AUS","CH125","TvrdÃÂ½","O",578,"2026-01-05","2026-01-10",32,16,"$175k",{w:["Blockx",""]}],
  ["BNC Tennis Open","Noumea, NCL","CH75","TvrdÃÂ½","O",2,"2026-01-05","2026-01-10",32,16,"$100k",{w:["Gea",""]}],
  ["Bangkok Open 1","Nonthaburi, THA","CH50","TvrdÃÂ½","O",3,"2026-01-05","2026-01-10",32,16,"$65k",{w:["Ã¢ÂÂ",""]}],
  ["Lexus Nottingham Challenger","Nottingham, GBR","CH50","TvrdÃÂ½","I",28,"2026-01-05","2026-01-10",32,16,"$65k",{w:["Ã¢ÂÂ",""]}],
  ["Bangkok Open 2","Nonthaburi, THA","CH75","TvrdÃÂ½","O",3,"2026-01-12","2026-01-17",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Challenger AAT","ItajaÃÂ­, BRA","CH50","Antuka","O",3,"2026-01-12","2026-01-17",32,16,"$65k",{w:["Ã¢ÂÂ",""]}],
  ["Glasgow Challenger","Glasgow, GBR","CH50","TvrdÃÂ½","I",8,"2026-01-12","2026-01-17",32,16,"$65k",{w:["Ã¢ÂÂ",""]}],
  ["Indoor Oeiras Open 1","Oeiras, POR","CH100","TvrdÃÂ½","I",36,"2026-01-19","2026-01-25",32,16,"$140k",{w:["Ã¢ÂÂ",""]}],
  ["ItajaÃÂ­ Open","ItajaÃÂ­, BRA","CH75","Antuka","O",3,"2026-01-19","2026-01-25",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Indoor Oeiras Open 2","Oeiras, POR","CH100","TvrdÃÂ½","I",36,"2026-01-26","2026-02-01",32,16,"$140k",{w:["Ã¢ÂÂ",""]}],
  ["Medellin Open","MedellÃÂ­n, COL","CH75","Antuka","O",1495,"2026-01-26","2026-02-01",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  // ÃÂNOR
  ["Rosario Challenger","Rosario, ARG","CH125","Antuka","O",25,"2026-02-02","2026-02-08",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Brisbane Challenger","Brisbane, AUS","CH75","TvrdÃÂ½","O",27,"2026-02-02","2026-02-08",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Cleveland Challenger","Cleveland, USA","CH75","TvrdÃÂ½","I",183,"2026-02-02","2026-02-08",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Pau Challenger","Pau, FRA","CH125","TvrdÃÂ½","I",210,"2026-02-09","2026-02-15",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Chennai Open","Chennai, IND","CH50","TvrdÃÂ½","O",6,"2026-02-09","2026-02-15",32,16,"$65k",{w:["Ã¢ÂÂ",""]}],
  ["Tenerife Challenger","Tenerife, ESP","CH75","TvrdÃÂ½","O",682,"2026-02-09","2026-02-15",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Szczecin Challenger","Szczecin, POL","CH75","TvrdÃÂ½","I",1,"2026-02-09","2026-02-15",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Lille Challenger","Lille, FRA","CH125","TvrdÃÂ½","I",20,"2026-02-16","2026-02-22",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Delhi Open","New Delhi, IND","CH75","TvrdÃÂ½","O",216,"2026-02-16","2026-02-22",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Liberec Challenger","Liberec, CZE","CH75","TvrdÃÂ½","I",399,"2026-02-16","2026-02-22",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Heilbronn Challenger","Heilbronn, GER","CH75","TvrdÃÂ½","I",155,"2026-02-16","2026-02-22",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Maha Open Pune","Pune, IND","CH75","TvrdÃÂ½","O",554,"2026-02-23","2026-03-01",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Lugano Challenger","Lugano, SUI","CH75","TvrdÃÂ½","I",274,"2026-02-23","2026-03-01",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  // BÃÂEZEN
  ["Thionville Challenger","Thionville, FRA","CH100","TvrdÃÂ½","I",175,"2026-03-02","2026-03-08",32,16,"$140k",{w:["Ã¢ÂÂ",""]}],
  ["Kigali Challenger","Kigali, RWA","CH75","Antuka","O",1567,"2026-03-02","2026-03-08",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Arizona Tennis Classic","Phoenix, USA","CH175","TvrdÃÂ½","O",331,"2026-03-09","2026-03-15",28,16,"$245k",{w:["Ã¢ÂÂ",""]}],
  ["Copa Cap Cana","Cap Cana, DOM","CH175","TvrdÃÂ½","O",15,"2026-03-09","2026-03-15",28,16,"$245k",{w:["Ã¢ÂÂ",""]}],
  ["Murcia Challenger","Murcia, ESP","CH75","Antuka","O",43,"2026-03-16","2026-03-22",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Morelia Open","Morelia, MEX","CH125","TvrdÃÂ½","O",1909,"2026-03-23","2026-03-29",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Naples Challenger","Naples, ITA","CH125","Antuka","O",17,"2026-03-23","2026-03-29",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  // DUBEN
  ["Mexico City Open","Mexico City, MEX","CH125","Antuka","O",2240,"2026-04-06","2026-04-12",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Advantage Cars Prague Open","Prague, CZE","CH75","Antuka","O",190,"2026-04-06","2026-04-12",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["ProstÃÂjov Challenger","ProstÃÂjov, CZE","CH125","Antuka","O",225,"2026-04-13","2026-04-19",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Busan Challenger","Busan, KOR","CH125","TvrdÃÂ½","O",40,"2026-04-13","2026-04-19",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Oeiras Challenger","Oeiras, POR","CH125","Antuka","O",36,"2026-04-13","2026-04-19",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Aix-en-Provence Challenger","Aix-en-Provence, FRA","CH175","Antuka","O",183,"2026-04-27","2026-05-03",28,16,"$245k",{w:["Ã¢ÂÂ",""]}],
  ["Marrakech Challenger","Marrakech, MAR","CH75","Antuka","O",454,"2026-04-27","2026-05-03",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  // KVÃÂTEN
  ["Wuxi Open","Wuxi, CHN","CH100","TvrdÃÂ½","O",7,"2026-05-04","2026-05-10",32,16,"$140k",{w:["Ã¢ÂÂ",""]}],
  ["BNP Paribas Primrose Bordeaux","Bordeaux, FRA","CH175","Antuka","O",6,"2026-05-11","2026-05-17",28,16,"$245k",{w:["Ã¢ÂÂ",""]}],
  ["Valencia Challenger","Valencia, ESP","CH175","Antuka","O",13,"2026-05-11","2026-05-17",28,16,"$245k",{w:["Ã¢ÂÂ",""]}],
  ["Lyon Challenger","Lyon, FRA","CH125","Antuka","O",173,"2026-05-18","2026-05-24",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Geneva Challenger","Geneva, SUI","CH100","Antuka","O",375,"2026-05-18","2026-05-24",32,16,"$140k",{w:["Ã¢ÂÂ",""]}],
  ["Istanbul Challenger","Istanbul, TUR","CH75","Antuka","O",39,"2026-05-18","2026-05-24",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  // ÃÂERVEN
  ["Birmingham Challenger","Birmingham, GBR","CH125","TrÃÂ¡va","O",140,"2026-06-01","2026-06-07",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Surbiton Trophy","London, GBR","CH75","TrÃÂ¡va","O",11,"2026-06-01","2026-06-07",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Ilkley Trophy","Ilkley, GBR","CH125","TrÃÂ¡va","O",246,"2026-06-08","2026-06-14",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Nottingham Challenger (Grass)","Nottingham, GBR","CH125","TrÃÂ¡va","O",28,"2026-06-15","2026-06-21",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Mallorca Challenger","Mallorca, ESP","CH75","TrÃÂ¡va","O",14,"2026-06-22","2026-06-28",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  // ÃÂERVENEC
  ["Braunschweig Challenger","Braunschweig, GER","CH125","Antuka","O",72,"2026-07-06","2026-07-12",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Newport Challenger","Newport, USA","CH125","TrÃÂ¡va","O",7,"2026-07-06","2026-07-12",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["BÃÂ¥stad Challenger","BÃÂ¥stad, SWE","CH100","Antuka","O",12,"2026-07-06","2026-07-12",32,16,"$140k",{w:["Ã¢ÂÂ",""]}],
  ["Zug Challenger","Zug, SUI","CH125","Antuka","O",425,"2026-07-20","2026-07-26",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["Vancouver Challenger","Vancouver, CAN","CH125","TvrdÃÂ½","O",12,"2026-07-27","2026-08-02",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  ["San Marino Challenger","San Marino, SMR","CH125","Antuka","O",672,"2026-07-27","2026-08-02",32,16,"$175k",{w:["Ã¢ÂÂ",""]}],
  // SRPEN
  ["Granby Challenger","Granby, CAN","CH100","TvrdÃÂ½","O",180,"2026-08-03","2026-08-09",32,16,"$140k",{w:["Ã¢ÂÂ",""]}],
  ["Lexington Challenger","Lexington, USA","CH75","TvrdÃÂ½","O",290,"2026-08-03","2026-08-09",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
  ["Indianapolis Challenger","Indianapolis, USA","CH75","TvrdÃÂ½","O",220,"2026-08-10","2026-08-16",32,16,"$100k",{w:["Ã¢ÂÂ",""]}],
];
...
const MCS=['Leden','ÃÂnor','BÃÂezen','Duben','KvÃÂten','ÃÂerven','ÃÂervenec','Srpen','ZÃÂ¡ÃÂÃÂ­','ÃÂÃÂ­jen','Listopad','Prosinec'];
const MSH=['Led','ÃÂno','BÃÂe','Dub','KvÃÂ','ÃÂer','ÃÂvc','Srp','ZÃÂ¡ÃÂ','ÃÂÃÂ­j','Lis','Pro'];

function surfCS(s){const l=(s||'').toLowerCase();if(l.includes('indoor')||l.includes('carpet'))return'KrytÃÂ½';if(l.includes('clay'))return'Antuka';if(l.includes('grass'))return'TrÃÂ¡va';return'TvrdÃÂ½';}
function fmtRange(s,e){if(!s)return'Ã¢ÂÂ';const a=new Date(s+'T00:00:00'),b=e?new Date(e+'T00:00:00'):a;const sd=a.getDate(),sm=a.getMonth(),ed=b.getDate(),em=b.getMonth();return sm===em?`${sd}Ã¢ÂÂ${ed}. ${MSH[sm]}`:`${sd}. ${MSH[sm]} Ã¢ÂÂ ${ed}. ${MSH[em]}`;}
...
// PÃÂevod arrays na objekty
function mkAtp(arr){return arr.map(([n,loc,tier,surf,io,alt,s,e,sgl,dbl,prize,wins])=>({name:n,loc,cat:'ATP',tier,surf,io:io||'O',alt:alt||0,start:s,end:e,sgl,dbl,prize:prize||'Ã¢ÂÂ',winners:wins?.w||[],src:'atptour.com'}));}
function mkWta(arr){return arr.map(([n,loc,tier,surf,io,alt,s,e,sgl,dbl,prize,wins])=>({name:n,loc,cat:'WTA',tier,surf,io:io||'O',alt:alt||0,start:s,end:e,sgl,dbl,prize:prize||'Ã¢ÂÂ',winners:wins?.w||[],src:'wtatennis.com'}));}
function mkChall(arr){return arr.map(([n,loc,tier,surf,io,alt,s,e,sgl,dbl,prize,wins])=>({name:n,loc,cat:'CHALL',tier,surf,io:io||'O',alt:alt||0,start:s,end:e,sgl,dbl,prize:prize||'Ã¢ÂÂ',winners:wins?.w||[],src:'atptour.com'}));}

// Ã¢ÂÂÃ¢ÂÂ ITF API Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ

async function fetchPlayers(onProgress){
  try{
    onProgress&&onProgress('NaÃÂÃÂ­tÃÂ¡m hrÃÂ¡ÃÂe ATP...');
    // NaÃÂti hrÃÂ¡ÃÂe s cache-bust
    ...
    // NaÃÂti Sackmann CSV pro age/hand/height
    onProgress&&onProgress('NaÃÂÃÂ­tÃÂ¡m statistiky...');
...
move:(p.move!==undefined&&p.move!==null)?p.move:null
    ...
    onProgress&&onProgress('HrÃÂ¡ÃÂi ATP naÃÂteni: '+window.ATP_PLAYERS.length);
    // NaÃÂti WTA hrÃÂ¡ÃÂky
    try{
      ...
      onProgress&&onProgress('WTA hrÃÂ¡ÃÂky naÃÂteny: '+window.WTA_PLAYERS.length);
...
async function fetchITF(onProg){
  // Data jsou kaÃÂ¾dÃÂ½ den automaticky aktualizovÃÂ¡na GitHub Actions
  // z itftennis.com a uloÃÂ¾ena do raw.githubusercontent.com (prochÃÂ¡zÃÂ­ sÃÂ­tÃÂ­)
  const GH_URL = 'https://raw.githubusercontent.com/Hacran001/tennis-scout/main/itf_data.json';
  onProg('NaÃÂÃÂ­tÃÂ¡m ITF z GitHub cache...');
  ...
  onProg(`ITF: ${items.length} turnajÃÂ¯ (aktualizovÃÂ¡no ${data.updated?.slice(0,10)||'?'})`);
  return items;
}
...
#w{
  ...
  background:#0d1117;
  font-family:'SÃÂ¶hne','Helvetica Neue','Arial',sans-serif;
...
/* Ã¢ÂÂÃ¢ÂÂ HOME VIEW Ã¢ÂÂÃ¢ÂÂ */
...
/* Ã¢ÂÂÃ¢ÂÂ PLAYERS VIEW Ã¢ÂÂÃ¢ÂÂ */
#pw{
  display:none;
  color:#e6edf3;
}

/* Ã¢ÂÂÃ¢ÂÂ ERR / ITF STATUS / LOAD Ã¢ÂÂÃ¢ÂÂ */
...
/* Ã¢ÂÂÃ¢ÂÂ SCROLLBARS Ã¢ÂÂÃ¢ÂÂ */
::-webkit-scrollbar{width:3px;height:3px;}
::-webkit-scrollbar-track{background:transparent;}
::-webkit-scrollbar-thumb{background:rgba(255,255,255,0.07);border-radius:3px;}
.mc-plink:hover{text-decoration:underline;text-underline-offset:2px;}
`;function surfSp(s){return s==='Antuka'?'sA':s==='TrÃÂ¡va'?'sT':s==='KrytÃÂ½'?'sK':'sH';}
...
// Ã¢ÂÂÃ¢ÂÂ HRÃÂÃÂI Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function buildPlayersTab(sh){
  ...
  function countryFlag(cc){
    ...
    // IOC 3-letter Ã¢ÂÂ ISO 2-letter mapa (hlavnÃÂ­ zemÃÂ)
    var m={'ESP':'ES','ITA':'IT','SRB':'RS','GER':'DE','AUS':'AU','USA':'US','FRA':'FR',
      ...
      'MRI':'MU','ZIM':'ZW','KEN':'KE','NGR':'NG','GHA':'GH','SEN':'SN','CMR':'CM','ANG':'AO','KOS':'XK','KSA':'SA','NMI':'MP','SVK':'SK'
    };
  ...
  function rP(){
    ...
    if(!ATP.length){wrap.innerHTML='<div style="padding:60px;text-align:center;color:rgba(255,255,255,0.2);font-size:13px;">Ã¢ÂÂ³ NaÃÂÃÂ­tÃÂ¡m hrÃÂ¡ÃÂe...</div>';return;}
    ...
    h+='<input id="ps-i" type="text" autocomplete="off" placeholder="Hledej jmÃÂ©no, zemi nebo rank..." value="'+sv+'"';
    ...
    if(pS)h+='<button id="ps-x" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;color:rgba(255,255,255,0.3);font-size:18px;cursor:pointer;line-height:1;">ÃÂ</button>';
    h+='</div>';
    if(q&&total>0)h+='<div style="margin-top:5px;font-size:11px;color:#00C853;">Ã¢ÂÂ Nalezeno '+total+' hrÃÂ¡ÃÂÃÂ¯</div>';
    if(q&&total===0)h+='<div style="margin-top:5px;font-size:11px;color:rgba(255,100,100,0.7);">Ã¢ÂÂ Nic pro "'+pS+'"</div>';
    h+='</div>';
    ...
    h+='<span style="font-size:9px;color:rgba(255,255,255,0.3);text-transform:uppercase;letter-spacing:1.5px;">PoÃÂadÃÂ­</span>';
    ...
    [["all","VÃÂ¡ichni hrÃÂ¡ÃÂi"],["1-100","1 - 100"],["101-200","101 - 200"],["201-300","201 - 300"],["301-400","301 - 400"],["401-500","401 - 500"],["1-500","Top 500"],["1-1000","Top 1000"],["1-2500","Top 2500"]].forEach(function(x){h+='<option value="'+x[0]+'"'+(pR===x[0]?" selected":"")+'>'+x[1]+'</option>';});
    h+='</select></div>';
    // Country dropdown Ã¢ÂÂ all countries alphabetically
    var allCountries=[...new Set(ATP.map(function(p){return (p.country||"").toUpperCase();}).filter(Boolean))].sort();
    h+='<div style="display:flex;align-items:center;gap:6px;flex-shrink:0;">';
    h+='<span style="font-size:9px;color:rgba(255,255,255,0.3);text-transform:uppercase;letter-spacing:1.5px;">ZemÃÂ</span>';
    ...
    h+='<option value="ALL"'+(pC==="ALL"?" selected":"")+'>VÃÂ¡echny zemÃÂ</option>';
    ...
    [["rank","Ranking"],["pts","Body"],["age","VÃÂk"],["height","VÃÂ½ÃÂ¡ka"],["name","JmÃÂ©no"]].forEach(function(x){h+='<option value="'+x[0]+'"'+(pO===x[0]?" selected":"")+'>'+x[1]+'</option>';});
    h+='</select><span style="font-size:9px;color:rgba(255,255,255,0.2);">'+(q?total+"/":"")+ATP.length+' hrÃÂ¡ÃÂÃÂ¯</span></div></div>';
    // VlajkovÃÂ© filtry Ã¢ÂÂ top 20 zemÃÂ­
    ...
    var top20=['USA','ITA','FRA','ESP','GER','ARG','GBR','JPN','RUS','AUS','BRA','CHN','SUI','IND','CZE','NED','ROU','POL','SRB','KOR','SVK'];
    h+='<button data-cf="ALL" style="padding:3px 10px;border-radius:12px;font-size:10px;font-weight:700;cursor:pointer;transition:all .1s;border:1px solid '+(pC==="ALL"?"#00C853":"rgba(255,255,255,0.1)")+';background:'+(pC==="ALL"?"rgba(0,200,83,0.15)":"transparent")+';color:'+(pC==="ALL"?"#00C853":"rgba(255,255,255,0.4)")+';">VÃÂ¡e</button>';
    ...
    h+='<th style="padding:7px 8px;font-size:8px;color:rgba(255,255,255,0.2);text-align:left;letter-spacing:1px;border-bottom:1px solid rgba(255,255,255,0.06);">HRÃÂÃÂ</th>';
    h+='<th style="padding:7px 8px;font-size:8px;color:rgba(255,255,255,0.2);text-align:center;letter-spacing:1px;border-bottom:1px solid rgba(255,255,255,0.06);width:50px;">ZEMÃÂ</th>';
    h+='<th style="padding:7px 8px;font-size:8px;color:rgba(255,255,255,0.2);text-align:center;letter-spacing:1px;border-bottom:1px solid rgba(255,255,255,0.06);width:40px;">VÃÂK</th>';
    ...
    h+='<th style="padding:7px 8px;font-size:8px;color:rgba(255,255,255,0.2);text-align:center;letter-spacing:1px;border-bottom:1px solid rgba(255,255,255,0.06);width:60px;">VÃÂÃÂ KA</th>';
    ...
    pg.forEach(function(p,idx){
      ...
      var handIcon=p.hand==="L"?'Ã°ÂÂ¤Â L':'R';
      ...
      h+='<td style="padding:7px 8px;font-size:11px;color:rgba(255,255,255,0.25);white-space:nowrap;">'+(function(){var mv=p.move;var r='<span>'+p.rank+'</span>';if(mv!=null&&mv!==0){var up=mv>0;var arrow=up?'&#9650;':'&#9660;';var col=up?'#3fb950':'#f85149';var abs=Math.abs(mv);r+='<div style="font-size:9px;line-height:1;color:'+col+';margin-top:1px;">'+arrow+abs+'</div>';}return r;})()+'</td>';
      ...
      h+='<td style="padding:7px 8px;text-align:center;font-size:11px;">'
        +(p.ch?'<span style="color:#f59e0b;font-weight:700;">'+chVal+'</span><div style="font-size:9px;color:rgba(255,255,255,0.25);margin-top:1px;">'+chDate+'</div>'
          :'<span style="color:rgba(255,255,255,0.2);">Ã¢ÂÂ</span>')
        +'</td>';
    ...
    if(pages>1){
      ...
      h+='<button data-pp="prev" style="padding:5px 14px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);background:transparent;color:'+(pP===0?"rgba(255,255,255,0.15)":"rgba(255,255,255,0.5)")+';font-size:13px;cursor:pointer;">Ã¢ÂÂ</button>';
      ...
      h+='<button data-pp="next" style="padding:5px 14px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);background:transparent;color:'+(pP>=pages-1?"rgba(255,255,255,0.15)":"rgba(255,255,255,0.5)")+';font-size:13px;cursor:pointer;">Ã¢ÂÂ</button>';
      h+='<span style="font-size:9px;color:rgba(255,255,255,0.15);margin-left:6px;">'+(pP*PAGE+1)+"-"+Math.min((pP+1)*PAGE,total)+" / "+total+'</span></div>';
    }
    h+='</div>';
    wrap.innerHTML=h;
  // Player page Ã¢ÂÂ full screen view
  sh._openPlayerFromHistory = function(player){
    // Simuluj klik na hrÃÂ¡ÃÂe ze seznamu
    var tr = wrap.querySelector('tr.pr[data-pid="'+player.id+'"]');
    if(tr){ tr.click(); return; }
    // HrÃÂ¡ÃÂ nenÃÂ­ v aktuÃÂ¡lnÃÂ­m zobrazenÃÂ­ - pÃÂejdi na seznam a klikni
    // Fallback: najdi ho pÃÂes search
  ...
  wrap.querySelectorAll('tr.pr').forEach(function(row){
    row.addEventListener('click',function(){
      ...
      var handTxt=hand==='L'?'LevÃÂ¡k Ã¢ÂÂ':'PravÃÂ¡k';
      ...
      // PÃÂidej notes ze zÃÂ¡pasovÃÂ½ch komentÃÂ¡ÃÂÃÂ¯ kterÃÂ© jeÃÂ¡tÃÂ nejsou v notesList
      (function(){
      ...
      var headerHTML='<div style="background:linear-gradient(180deg,#161b22 0%,#0d1117 100%);border-bottom:1px solid rgba(255,255,255,0.06);padding:20px 32px 0;flex-shrink:0;">'
        // Back button
        +'<button id="pp-back" style="background:none;border:none;color:rgba(255,255,255,0.4);font-size:13px;cursor:pointer;padding:0;margin-bottom:16px;display:flex;align-items:center;gap:6px;">&#8592; ZpÃÂt na hrÃÂ¡ÃÂe</button>'
        +'<div style="display:flex;align-items:flex-end;gap:24px;padding-bottom:0;">'
          ...
          +'<div style="width:110px;height:130px;border-radius:12px 12px 0 0;overflow:hidden;background:rgba(255,255,255,0.05);flex-shrink:0;display:flex;align-items:center;justify-content:center;">'
            ...
            +'<div style="display:none;width:100%;height:100%;align-items:center;justify-content:center;font-size:40px;">'+( flag||'Ã°ÂÂÂ¤')+'</div>'
          +'</div>'
          // Info
          +'<div style="flex:1;padding-bottom:20px;">'
            ...
            +'<div style="display:flex;align-items:center;gap:12px;margin-bottom:14px;">'+'<div id="pp-name" style="font-size:28px;font-weight:800;color:#fff;letter-spacing:-0.5px;">'+pname+'</div>'+'<button id="pp-update-btn" data-pid="'+pid+'" data-fullname="'+pfull+'" style="background:rgba(0,188,212,0.12);border:1px solid rgba(0,188,212,0.3);border-radius:8px;color:#00bcd4;font-size:11px;padding:4px 10px;cursor:pointer;flex-shrink:0;">Ã¢ÂÂ» Aktualizovat</button>'+'<span id="pp-update-status" style="font-size:11px;color:rgba(255,255,255,0.4);"></span>'+'</div>'
            +'<div style="display:flex;gap:10px;flex-wrap:wrap;">'
              ...
              +(age?'<div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:8px 14px;text-align:center;">'
                +'<div style="font-size:9px;color:rgba(255,255,255,0.3);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:2px;">VÃÂk</div>'
              ...
              +(height?'<div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:8px 14px;text-align:center;">'
                +'<div style="font-size:9px;color:rgba(255,255,255,0.3);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:2px;">VÃÂ½ÃÂ¡ka</div>'
        ...
        +'<div style="display:flex;gap:0;margin-top:16px;">'
          +'<div class="pp-tab pp-tab-active" data-tab="notes" style="padding:10px 20px;font-size:12px;font-weight:600;color:#00C853;border-bottom:2px solid #00C853;cursor:pointer;">&#128221; PoznÃÂ¡mky</div>'
          +'<div class="pp-tab" data-tab="matches" style="padding:10px 20px;font-size:12px;font-weight:500;color:rgba(255,255,255,0.4);border-bottom:2px solid transparent;cursor:pointer;">&#127934; Historie zÃÂ¡pasÃÂ¯</div>'
        +'</div>'
      +'</div>';

      // Ã¢ÂÂÃ¢ÂÂ NOTES SECTION Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
      var notesHTML='<div id="pp-notes-section" style="flex:1;padding:28px 32px;overflow-y:auto;">'
        +'<div style="max-width:720px;">'
          // Header + Add button
          +'<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">'
            +'<div style="font-size:11px;color:rgba(255,255,255,0.25);letter-spacing:2px;text-transform:uppercase;">MÃÂ© poznÃÂ¡mky</div>'
            +'<button id="pp-add-note-btn" style="background:rgba(0,200,83,0.12);border:1px solid rgba(0,200,83,0.3);color:#00C853;border-radius:8px;padding:6px 14px;font-size:11px;font-weight:700;cursor:pointer;">+ PÃÂidat poznÃÂ¡mku</button>'
          +'</div>'
          ...
          +'<div id="pp-note-form" style="display:none;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:10px;padding:16px;margin-bottom:16px;">'
            +'<div style="display:flex;gap:8px;margin-bottom:8px;">'
              ...
              +'<div style="flex:2;">'
                ...
                +'<input id="pp-note-source" type="text" placeholder="napÃÂ. flashscore, vlastnÃÂ­ pozorovÃÂ¡nÃÂ­..." style="background:#161b22;border:1px solid rgba(255,255,255,0.1);color:#e6edf3;font-size:12px;padding:6px 10px;border-radius:6px;outline:none;width:100%;box-sizing:border-box;"/>'
              +'</div>'
            +'</div>'
            +'<textarea id="pp-note-text" placeholder="Text poznÃÂ¡mky..." style="width:100%;min-height:90px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:8px;color:#e6edf3;font-size:13px;line-height:1.6;padding:10px 12px;resize:vertical;outline:none;font-family:inherit;box-sizing:border-box;"></textarea>'
            +'<div style="display:flex;gap:8px;margin-top:8px;">'
              +'<button id="pp-note-save-btn" style="background:rgba(0,200,83,0.15);border:1px solid rgba(0,200,83,0.35);color:#00C853;border-radius:8px;padding:7px 18px;font-size:12px;font-weight:700;cursor:pointer;">UloÃÂ¾it</button>'
              +'<button id="pp-note-cancel-btn" style="background:transparent;border:1px solid rgba(255,255,255,0.1);color:rgba(255,255,255,0.4);border-radius:8px;padding:7px 14px;font-size:12px;cursor:pointer;">ZruÃÂ¡it</button>'
              +'<span id="pp-note-edit-id" style="display:none;"></span>'
            +'</div>'
          +'</div>'
          // Notes list
          +'<div id="pp-notes-list">'
            +(notesList.length===0?'<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.2);font-size:13px;">ZatÃÂ­m ÃÂ¾ÃÂ¡dnÃÂ© poznÃÂ¡mky</div>':
              notesList.slice().sort(function(a,b){return (b.id||0)-(a.id||0);}).map(function(n){
                return '<div class="pp-note-item" data-nid="'+n.id+'" style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:10px;padding:14px 16px;margin-bottom:10px;">'
                  +'<div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">'
                    +(n.date?'<span style="font-size:10px;color:rgba(255,255,255,0.3);background:rgba(255,255,255,0.06);padding:2px 8px;border-radius:10px;">Ã°ÂÂÂ '+n.date+'</span>':'')
                    +(n.source?'<span style="font-size:10px;color:rgba(0,200,83,0.6);background:rgba(0,200,83,0.08);padding:2px 8px;border-radius:10px;">Ã°ÂÂÂ '+n.source+'</span>':'')
                    +'<div style="margin-left:auto;display:flex;gap:6px;">'
                      +'<button class="pp-edit-note" data-nid="'+n.id+'" style="background:transparent;border:1px solid rgba(255,255,255,0.1);color:rgba(255,255,255,0.4);border-radius:6px;padding:3px 10px;font-size:10px;cursor:pointer;">Ã¢ÂÂÃ¯Â¸Â Upravit</button>'
                      +'<button class="pp-del-note" data-nid="'+n.id+'" style="background:transparent;border:1px solid rgba(239,68,68,0.2);color:rgba(239,68,68,0.5);border-radius:6px;padding:3px 10px;font-size:10px;cursor:pointer;">Ã°ÂÂÂ Smazat</button>'
                    +'</div>'
                  +'</div>'
      ...
      // Ã¢ÂÂÃ¢ÂÂ MATCHES SECTION Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
      var matchesHTML='<div id="pp-matches-section" style="display:none;flex:1;padding:28px 32px;">'
        +'<div style="text-align:center;padding:60px;color:rgba(255,255,255,0.2);">'
          +'<div style="padding:40px;text-align:center;color:rgba(255,255,255,.2);">&#9203; NaÃÂÃÂ­tÃÂ¡m historii zÃÂ¡pasÃÂ¯...</div>'


      pg.innerHTML=headerHTML+notesHTML+matchesHTML;
      sh.appendChild(pg);
// ZavÃÂi comment modal pÃÂi kliknutÃÂ­ na overlay nebo navigaci
// comment modal closes via overlay mousedown and player navigation

      // Ã¢ÂÂÃ¢ÂÂ FETCH PHOTO Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
      (function(){
        // ATP headshot primÃÂ¡rnÃÂ - funguje pro vÃÂ¡echny rankovanÃÂ© hrÃÂ¡ÃÂe
      ...
      // Ã¢ÂÂÃ¢ÂÂ BACK BUTTON Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
      ...
      // Ã¢ÂÂÃ¢ÂÂ MATCH HISTORY Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
  ...
  var _existingModal=sh.getElementById('mh-cmt-modal');if(_existingModal)_existingModal.style.display='none';
        if(sec.dataset.loaded===pid){
          // Data cached Ã¢ÂÂ znovu inicializuj komentÃÂ¡ÃÂe (mohly pÃÂibÃÂ½t novÃÂ©)
          ...
          if(_listEl){
            _listEl.querySelectorAll(".mh-cmt-expand").forEach(function(ex){
              ...
              // OdstraÃÂ starÃÂ© listenery klonovÃÂ¡nÃÂ­m
        ...
        sec.innerHTML='<div style="padding:40px;text-align:center;color:rgba(255,255,255,.2);">&#9203; NaÃÂÃÂ­tÃÂ¡m...</div>';
...
all=all.filter(function(m){var t=m.tournament||'';var hasFlashFormat=t.match(/^(ATP|WTA|ITF|CHALLENGER)\s+-\s+/i);var hasNoStats=!m.dr&&!m.a_pct&&!m.first_pct;if(hasFlashFormat&&hasNoStats)return false;return true;});
          ...
          if(all.length===0){
            sec.innerHTML='<div style="padding:40px;text-align:center;color:rgba(255,255,255,.2);">ÃÂ½ÃÂ¡dnÃÂ© zÃÂ¡pasy k dispozici</div>';
          ...
          // Photo + Info Ã¢ÂÂ identickÃÂ© s kartou hrÃÂ¡ÃÂe
'<button id="mh-f-back" style="background:transparent;border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.4);font-size:11px;padding:5px 12px;border-radius:8px;cursor:pointer;margin-bottom:14px;display:block;">Ã¢ÂÂ ZpÃÂt</button>'+
          '<div style="display:flex;align-items:flex-end;gap:24px;padding-bottom:0;">'+
            // Photo
            '<div style="width:110px;height:130px;border-radius:12px 12px 0 0;overflow:hidden;background:rgba(255,255,255,0.05);flex-shrink:0;display:flex;align-items:center;justify-content:center;">'+
            ...
            '<div style="flex:1;padding-bottom:20px;">'+
              ...
              '<div style="display:flex;gap:10px;flex-wrap:wrap;">'+
                ...
                '<div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:8px 16px;text-align:center;">'+
                  ...
                  '<div style="font-size:22px;font-weight:700;color:#e6edf3;">'+Number(pts).toLocaleString()+'</div>'+
                '</div>'+
                (age?'<div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:8px 14px;text-align:center;"><div style="font-size:9px;color:rgba(255,255,255,0.3);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:2px;">VÃÂk</div><div style="font-size:20px;font-weight:700;color:#e6edf3;">'+age+'</div></div>':'')+
                (height?'<div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:8px 14px;text-align:center;"><div style="font-size:9px;color:rgba(255,255,255,0.3);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:2px;">VÃÂ½ÃÂ¡ka</div><div style="font-size:20px;font-weight:700;color:#e6edf3;">'+height+' cm</div></div>':'')+
        ...
        '<div style="padding:0 20px 40px;">';
          // Sestav unikÃÂ¡tnÃÂ­ hodnoty pro filtry
...
function _renderMatches(){
            ...
            var mhCss=[
              ...
              '.lvl-atp{color:#60a5fa;font-weight:800;font-size:11px;}',
              '.lvl-ch{color:#fcd34d;font-weight:800;font-size:11px;}',
              '.lvl-itf{color:#a78bfa;font-weight:800;font-size:11px;}',
  ...
  '.mh-cmt-btn{background:none;border:none;cursor:pointer;font-size:12px;opacity:.3;padding:1px 3px;transition:all .2s;filter:grayscale(1)}.mh-cmt-btn:hover{opacity:.7;filter:none}.mh-cmt-btn.has-comment{opacity:1;filter:sepia(1) saturate(8) hue-rotate(5deg) brightness(1.1);}.mh-cmt-expand{color:#f97316;}.mh-cmt-expand:hover{opacity:.8!important;}.mh-cmt-expand.open{transform:rotate(180deg);opacity:.8!important;}.mh-cmt-preview td{background:rgba(249,115,22,0.06);border-top:none!important;padding:6px 12px 8px 12px!important;font-size:12px;color:rgba(255,255,255,0.55);font-style:italic;line-height:1.5;white-space:pre-wrap;}',
        ...
        '<td style="white-space:nowrap">'+dd+' <button class="mh-cmt-btn" data-mid="'+mid+'" title="Koment\u00e1\u0159" style="background:none;border:none;cursor:pointer;font-size:11px;padding:0 2px;vertical-align:middle;">Ã°ÂÂÂ¬</button><button class="mh-cmt-expand" data-mid="'+mid+'" title="Zobrazit koment\u00e1\u0159" style="background:none;border:none;cursor:pointer;font-size:9px;padding:0 1px;vertical-align:middle;opacity:.3;transition:all .2s;display:none;">Ã¢ÂÂ¼</button></td>',
        ...
        '</tr>',
            ...
            if(!filtered.length)hm='<div style="padding:40px;text-align:center;color:rgba(255,255,255,.2);font-size:13px;">ÃÂ½ÃÂ¡dnÃÂ© zÃÂ¡pasy</div>';
            var listEl=sec.querySelector('#mh-list');
            if(listEl){
              listEl.innerHTML=hm;
        // == KOMENTÃÂÃÂE ==
        (function initCmt(){
          // Modal - vytvoÃÂ jednou, pak reuse
          ...
          if(!modal){
            ...
            modal.innerHTML='<div style="background:#161b22;border:1px solid rgba(255,255,255,0.1);border-radius:14px;padding:24px;width:480px;max-width:90vw;box-shadow:0 20px 60px rgba(0,0,0,.8);">'
              ...
              +'<input id="mh-cmt-modal-date" type="text" placeholder="Datum zÃÂ¡pasu (napÃÂ. 18.03.2026)" style="width:100%;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;color:#e6edf3;font-size:13px;padding:8px 12px;outline:none;box-sizing:border-box;margin-bottom:8px;" />'
            ...
            // Listenery pÃÂidej JEDNOU na modal - ukazujÃÂ­ na sh._cmtMid
            sh._cmtMid=null;
            modal.querySelector("#mh-cmt-modal-save").addEventListener("click",function(){
              ...
              // Synchronizuj komentÃÂ¡ÃÂ do ts_notes_{pid} hlavnÃÂ­ karty
              (function syncToNotes(targetPid, noteText, noteDate, noteSource){
                ...
                // Aktualizuj nebo pÃÂidej note se stejnÃÂ½m source (mid)
              ...
              // Zrcadlo pro soupeÃÂe Ã¢ÂÂ komentÃÂ¡ÃÂ + datum + notes
              (function(){
              ...
              if(ex){ex.style.display=val?'inline':'none';if(!val){ex.classList.remove('open');var pr=sh.querySelector(".mh-cmt-preview[data-mid=\""+mid+"\"]");if(pr)pr.remove();}}
            ...
            // overlay click-to-close removed (caused issues with save button)
          ...
          // Pro kaÃÂ¾dÃÂ½ pÃÂechod na hrÃÂ¡ÃÂe Ã¢ÂÂ pÃÂidej listenery na novÃÂ© .mh-cmt-btn
          // Expand trojÃÂºhelnÃÂ­ky Ã¢ÂÂ jednou mimo btn loop
        ...
        // Klik na soupeÃÂe Ã¢ÂÂ otevÃÂi jeho kartu
          listEl.querySelectorAll('.mh-opp-link').forEach(function(td){
            td.addEventListener('click', function(e){
              e.stopPropagation();
              var oppName = td.dataset.opponent;
              if(!oppName) return;
              // Najdi hrÃÂ¡ÃÂe v ATP_PLAYERS podle full_name nebo ÃÂÃÂ¡sti jmÃÂ©na
              var players = window.ATP_PLAYERS || [];
              ...
              if(found){
                if(sh._openPlayerFromHistory){
                  // ZavÃÂi match history a otevÃÂi kartu nalezenÃÂ©ho hrÃÂ¡ÃÂe
          ...
          // == KONEC KOMENTÃÂÃÂÃÂ® ==
            ...
            if(cntEl)cntEl.textContent=filtered.length+' zÃÂ¡pasÃÂ¯';
          ...
          sec.innerHTML='<div style="padding:40px;text-align:center;color:rgba(255,255,255,.2);">NepodaÃÂilo se naÃÂÃÂ­st historii zÃÂ¡pasÃÂ¯</div>';
        });
      }
      // Ã¢ÂÂÃ¢ÂÂ SAVE NOTES Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
      // Ã¢ÂÂÃ¢ÂÂ NOTES SYSTEM Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
      function _tsRefreshNotes(targetPid){
        ...
        if(!list)return;
        if(targetPid===pid){notesList=fresh;} // aktualizuj closure pokud sedÃÂ­
        var renderList=targetPid===pid?notesList:fresh;
        if(renderList.length===0){list.innerHTML='<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.2);font-size:13px;">ZatÃÂ­m ÃÂ¾ÃÂ¡dnÃÂ© poznÃÂ¡mky</div>';return;}
        list.innerHTML=renderList.slice().sort(function(a,b){return (b.id||0)-(a.id||0);}).map(function(n){
          return '<div class="pp-note-item" data-nid="'+n.id+'" style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:10px;padding:14px 16px;margin-bottom:10px;">'
            +'<div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">'
              +(n.date?'<span style="font-size:13px;color:rgba(255,255,255,0.55);background:rgba(255,255,255,0.06);padding:3px 10px;border-radius:10px;">Ã°ÂÂÂ '+n.date+'</span>':'')
              +(n.source?'<span style="font-size:10px;color:rgba(0,200,83,0.6);background:rgba(0,200,83,0.08);padding:2px 8px;border-radius:10px;">Ã°ÂÂÂ '+n.source+'</span>':'')
              +'<div style="margin-left:auto;display:flex;gap:6px;">'
                +'<button class="pp-edit-note" data-nid="'+n.id+'" style="background:transparent;border:1px solid rgba(255,255,255,0.1);color:rgba(255,255,255,0.4);border-radius:6px;padding:3px 10px;font-size:10px;cursor:pointer;">Ã¢ÂÂÃ¯Â¸Â Upravit</button>'
                +'<button class="pp-del-note" data-nid="'+n.id+'" style="background:transparent;border:1px solid rgba(239,68,68,0.2);color:rgba(239,68,68,0.5);border-radius:6px;padding:3px 10px;font-size:10px;cursor:pointer;">Ã°ÂÂÂ Smazat</button>'
        ...
        list.querySelectorAll('.pp-del-note').forEach(function(btn){
          btn.onclick=function(e){
            e.stopPropagation();
            if(!confirm('Smazat tuto poznÃÂ¡mku?'))return;
      ...
      function _getMcValue(mid){
        // Hledej ts_mc_ klÃÂ­ÃÂ case-insensitively
      ...
      // Expose pro okamÃÂ¾itÃÂ© pÃÂekreslenÃÂ­ z match history save listeneru
      ...
      function _renderNotes(){
        var list=sh.getElementById('pp-notes-list');
        if(!list)return;
        // VÃÂ¾dy naÃÂti ÃÂerstvÃÂ½ stav z localStorage
        try{var _fresh=JSON.parse(localStorage.getItem(notesKey));if(Array.isArray(_fresh))notesList=_fresh;}catch(e){}
        if(notesList.length===0){list.innerHTML='<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.2);font-size:13px;">ZatÃÂ­m ÃÂ¾ÃÂ¡dnÃÂ© poznÃÂ¡mky</div>';return;}
...
function _openAtpPlayer(nameRaw,sh){
  ...
  var surname=parts[0].toLowerCase().replace(/[^a-zÃÂ-ÃÂ]/gi,'');
  ...
  if(!best||bestScore<3){
    ...
    t.textContent='HrÃÂ¡ÃÂ "'+nameRaw+'" nenalezen v ATP ÃÂ¾ebÃÂÃÂ­ÃÂku';
...
// Ã¢ÂÂÃ¢ÂÂ H2H MODUL Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function buildH2HTab(sh){
  var wrap=document.createElement('div');
  wrap.id='h2hw';
  wrap.style.cssText='display:none;padding:0;';
  var GH_BASE='https://raw.githubusercontent.com/Havran001/tennis-scout/main/player_history/';
  function normName(n){return (n||'').toLowerCase().normalize('NFD').replace(/[ÃÂ-ÃÂ¯]/g,'').replace(/[^a-z ]/g,'').trim();}
  function findPlayer(query){
    var q=normName(query);
    var players=window.ATP_PLAYERS||[];
    var found=players.find(function(p){var parts=(p.name||'').split(' ');var surname=normName(parts.slice(1).join(' '));return surname===q||normName(p.name)===q||normName(p.full_name||'')===q;});
    if(found)return found;
    return players.find(function(p){var n=normName(p.name)+' '+normName(p.full_name||'');return n.includes(q)&&q.length>=3;});
  }
  function surfaceColor(s){if(!s)return '#888';var sl=s.toLowerCase();if(sl.includes('clay'))return '#fb923c';if(sl.includes('grass'))return '#4ade80';if(sl.includes('hard'))return '#60a5fa';return '#a78bfa';}
  function surfaceLabel(s){if(!s)return s;var sl=s.toLowerCase();if(sl.includes('clay'))return 'Antuka';if(sl.includes('grass'))return 'TrÃÂ¡va';if(sl.includes('hard'))return 'TvrdÃÂ½';return s;}
  ...
  function findH2H(hist1,p2name){
    ...
    return (hist1.matches||[]).filter(function(m){
      var opp=normName(m.opponent||'');
      var qParts=q.split(' ');var oppParts=opp.split(' ');
      return qParts.some(function(w){return w.length>=3&&oppParts.some(function(o){return o.includes(w)||w.includes(o);});});
    });
  }
  function getForm(matches,n){return (matches||[]).slice(0,n||10).map(function(m){return m.result||'?';});}
  function surfaceBreakdown(h2hMatches){
    var byS={};
    h2hMatches.forEach(function(m){var s=surfaceLabel(m.surface)||'?';if(!byS[s])byS[s]={w:0,l:0};if(m.result==='W')byS[s].w++;else if(m.result==='L')byS[s].l++;});
    return byS;
  }
  function flag(c){var m={'ESP':'Ã°ÂÂÂªÃ°ÂÂÂ¸','ITA':'Ã°ÂÂÂ®Ã°ÂÂÂ¹','SRB':'Ã°ÂÂÂ·Ã°ÂÂÂ¸','GER':'Ã°ÂÂÂ©Ã°ÂÂÂª','AUS':'Ã°ÂÂÂ¦Ã°ÂÂÂº','USA':'Ã°ÂÂÂºÃ°ÂÂÂ¸','FRA':'Ã°ÂÂÂ«Ã°ÂÂÂ·','GBR':'Ã°ÂÂÂ¬Ã°ÂÂÂ§','ARG':'Ã°ÂÂÂ¦Ã°ÂÂÂ·','JPN':'Ã°ÂÂÂ¯Ã°ÂÂÂµ','RUS':'Ã°ÂÂÂ·Ã°ÂÂÂº','CAN':'Ã°ÂÂÂ¨Ã°ÂÂÂ¦','NOR':'Ã°ÂÂÂ³Ã°ÂÂÂ´','CZE':'Ã°ÂÂÂ¨Ã°ÂÂÂ¿','GRE':'Ã°ÂÂÂ¬Ã°ÂÂÂ·','CHI':'Ã°ÂÂÂ¨Ã°ÂÂÂ±','DEN':'Ã°ÂÂÂ©Ã°ÂÂÂ°','SUI':'Ã°ÂÂÂ¨Ã°ÂÂÂ­','BEL':'Ã°ÂÂÂ§Ã°ÂÂÂª','POL':'Ã°ÂÂÂµÃ°ÂÂÂ±','NED':'Ã°ÂÂÂ³Ã°ÂÂÂ±','HUN':'Ã°ÂÂÂ­Ã°ÂÂÂº','GEO':'Ã°ÂÂÂ¬Ã°ÂÂÂª','BUL':'Ã°ÂÂÂ§Ã°ÂÂÂ¬','KAZ':'Ã°ÂÂÂ°Ã°ÂÂÂ¿','ROU':'Ã°ÂÂÂ·Ã°ÂÂÂ´','SWE':'Ã°ÂÂÂ¸Ã°ÂÂÂª','AUT':'Ã°ÂÂÂ¦Ã°ÂÂÂ¹','FIN':'Ã°ÂÂÂ«Ã°ÂÂÂ®','UKR':'Ã°ÂÂÂºÃ°ÂÂÂ¦','KOR':'Ã°ÂÂÂ°Ã°ÂÂÂ·','BRA':'Ã°ÂÂÂ§Ã°ÂÂÂ·','COL':'Ã°ÂÂÂ¨Ã°ÂÂÂ´','URU':'Ã°ÂÂÂºÃ°ÂÂÂ¾'};return m[c]||'';}
  ...
  function renderH2H(p1,p2,hist1,hist2){
    ...
    var surf=surfaceBreakdown(h2h);
    var odds=_getBestOdds(p1name,p2name);
    var html='<div style="padding:0 0 40px;">';
    // Header
    html+='<div style="display:flex;align-items:center;gap:0;padding:24px 0 20px;border-bottom:1px solid rgba(255,255,255,.06);">';
    html+='<div style="flex:1;"><div style="font-size:11px;color:rgba(255,255,255,.3);letter-spacing:2px;text-transform:uppercase;margin-bottom:4px;">'+flag(p1.country)+' '+p1.country+'</div><div style="font-size:24px;font-weight:800;color:#fff;">'+p1name+'</div><div style="font-size:11px;color:rgba(255,255,255,.3);margin-top:4px;">Rank <span style="color:#00C853;font-weight:700;">#'+p1.rank+'</span></div></div>';
    html+='<div style="flex:0 0 160px;text-align:center;">';
    html+='<div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;">H2H</div>';
    html+='<div style="display:flex;align-items:center;justify-content:center;gap:10px;">';
    html+='<span style="font-size:40px;font-weight:900;color:'+(wins>losses?'#00C853':wins<losses?'#f85149':'#e6edf3')+';">'+wins+'</span>';
    html+='<span style="font-size:18px;color:rgba(255,255,255,.2);">Ã¢ÂÂ</span>';
    html+='<span style="font-size:40px;font-weight:900;color:'+(losses>wins?'#00C853':losses<wins?'#f85149':'#e6edf3')+';">'+losses+'</span>';
    html+='</div>';
    html+='<div style="font-size:10px;color:rgba(255,255,255,.3);margin-top:2px;">'+total+' zÃÂ¡pasÃÂ¯</div>';
    if(odds&&odds.best1&&odds.best2){
      html+='<div style="display:flex;gap:6px;justify-content:center;margin-top:10px;">';
      html+='<div style="background:rgba(255,215,0,.12);border:1px solid rgba(255,215,0,.25);border-radius:6px;padding:4px 12px;"><div style="font-size:8px;color:rgba(255,255,255,.3);">best odds</div><div style="font-size:16px;font-weight:800;color:#FFD700;">'+Math.round(odds.best1*100)/100+'</div></div>';
      html+='<div style="background:rgba(255,215,0,.12);border:1px solid rgba(255,215,0,.25);border-radius:6px;padding:4px 12px;"><div style="font-size:8px;color:rgba(255,255,255,.3);">best odds</div><div style="font-size:16px;font-weight:800;color:#FFD700;">'+Math.round(odds.best2*100)/100+'</div></div>';
      html+='</div>';
    }
    html+='</div>';
    html+='<div style="flex:1;text-align:right;"><div style="font-size:11px;color:rgba(255,255,255,.3);letter-spacing:2px;text-transform:uppercase;margin-bottom:4px;">'+p2.country+' '+flag(p2.country)+'</div><div style="font-size:24px;font-weight:800;color:#fff;">'+p2name+'</div><div style="font-size:11px;color:rgba(255,255,255,.3);margin-top:4px;">Rank <span style="color:#00C853;font-weight:700;">#'+p2.rank+'</span></div></div>';
    html+='</div>';
    // Forma
    html+='<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:16px;">';
    function renderForm(form,label){
      var h='<div style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.06);border-radius:10px;padding:12px 14px;">';
      h+='<div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;">'+label+' Ã¢ÂÂ forma</div>';
      h+='<div style="display:flex;gap:3px;flex-wrap:wrap;">';
      form.forEach(function(r){var c=getResultColor(r);h+='<div style="width:20px;height:20px;border-radius:3px;background:'+c+';display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:800;color:#000;">'+r+'</div>';});
      if(!form.length)h+='<span style="font-size:11px;color:rgba(255,255,255,.2);">ÃÂ½ÃÂ¡dnÃÂ¡ data</span>';
      h+='</div></div>';return h;
    }
    html+=renderForm(form1,p1name.split(' ').pop());
    html+=renderForm(form2,p2name.split(' ').pop());
    html+='</div>';
    // Surface breakdown
    var surfKeys=Object.keys(surf);
    if(surfKeys.length){
      html+='<div style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.06);border-radius:10px;padding:12px 14px;margin-top:12px;">';
      html+='<div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:10px;">H2H podle povrchu</div>';
      html+='<div style="display:flex;gap:10px;flex-wrap:wrap;">';
      surfKeys.forEach(function(s){var d=surf[s];var tot=d.w+d.l;html+='<div style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:8px;padding:8px 14px;text-align:center;"><div style="font-size:11px;font-weight:700;color:'+surfaceColor(s)+';margin-bottom:3px;">'+s+'</div><div style="font-size:18px;font-weight:800;color:#fff;">'+d.w+'Ã¢ÂÂ'+d.l+'</div><div style="font-size:9px;color:rgba(255,255,255,.25);">'+tot+' zÃÂ¡p.</div></div>';});
      html+='</div></div>';
    }
    // VzÃÂ¡jemnÃÂ© zÃÂ¡pasy
    if(h2h.length){
      html+='<div style="margin-top:16px;">';
      html+='<div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;padding-bottom:8px;border-bottom:1px solid rgba(255,255,255,.04);">VzÃÂ¡jemnÃÂ© zÃÂ¡pasy ('+h2h.length+')</div>';
      html+='<table style="width:100%;border-collapse:collapse;">';
      html+='<thead><tr>';
      ['Datum','Turnaj','Povrch','Kolo','Rank','vRank','SkÃÂ³re',''].forEach(function(c){html+='<th style="padding:5px 8px;font-size:8px;color:rgba(255,255,255,.25);letter-spacing:1px;text-align:left;border-bottom:1px solid rgba(255,255,255,.06);">'+c+'</th>';});
      html+='</tr></thead><tbody>';
      h2h.forEach(function(m,i){
        var bg=i%2===0?'transparent':'rgba(255,255,255,.012)';
        var rc=getResultColor(m.result);var sc=surfaceColor(m.surface);
        html+='<tr style="background:'+bg+';border-bottom:1px solid rgba(255,255,255,.03);">';
        html+='<td style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,.45);">'+fmtDate(m.date)+'</td>';
        html+='<td style="padding:6px 8px;font-size:11px;color:#e6edf3;max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">'+(m.tournament||'Ã¢ÂÂ')+'</td>';
        html+='<td style="padding:6px 8px;"><span style="font-size:9px;font-weight:700;color:'+sc+';background:rgba(255,255,255,.05);padding:2px 6px;border-radius:3px;">'+surfaceLabel(m.surface||'')+'</span></td>';
        html+='<td style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.round||'Ã¢ÂÂ')+'</td>';
        html+='<td style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.rank||'Ã¢ÂÂ')+'</td>';
        html+='<td style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.opp_rank||'Ã¢ÂÂ')+'</td>';
        html+='<td style="padding:6px 8px;font-size:12px;font-weight:600;font-family:monospace;color:#e6edf3;">'+(m.score||'Ã¢ÂÂ')+'</td>';
        html+='<td style="padding:6px 8px;font-size:13px;font-weight:800;color:'+rc+';">'+(m.result||'?')+'</td>';
        html+='</tr>';
      });
      html+='</tbody></table></div>';
    } else {
      html+='<div style="text-align:center;padding:40px;color:rgba(255,255,255,.2);font-size:13px;">ÃÂ½ÃÂ¡dnÃÂ© vzÃÂ¡jemnÃÂ© zÃÂ¡pasy v dostupnÃÂ½ch datech</div>';
    }
    html+='</div>';
    var container=wrap.querySelector('#h2h-result');
    if(container)container.innerHTML=html;
  }

  function render(){
    wrap.innerHTML='<div style="padding:0 24px 60px;"><div style="padding:20px 0 16px;border-bottom:1px solid rgba(255,255,255,.06);"><div style="font-size:20px;font-weight:800;color:#fff;margin-bottom:4px;">H2H PorovnÃÂ¡nÃÂ­</div><div style="font-size:11px;color:rgba(255,255,255,.3);">Zadej jmÃÂ©na dvou hrÃÂ¡ÃÂÃÂ¯ pro porovnÃÂ¡nÃÂ­</div></div><div style="display:flex;gap:12px;align-items:flex-end;margin-top:20px;flex-wrap:wrap;"><div style="flex:1;min-width:180px;"><div style="font-size:9px;color:rgba(255,255,255,.3);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:6px;">HrÃÂ¡ÃÂ 1</div><div style="position:relative;"><input id="h2h-p1" type="text" placeholder="napÃÂ. Alcaraz" autocomplete="off" style="width:100%;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.12);color:#e6edf3;font-size:14px;padding:10px 14px;border-radius:10px;outline:none;box-sizing:border-box;"/><div id="h2h-p1-sug" style="display:none;position:absolute;top:100%;left:0;right:0;background:#1c2128;border:1px solid rgba(255,255,255,.15);border-radius:8px;z-index:100;max-height:200px;overflow-y:auto;margin-top:2px;box-shadow:0 8px 24px rgba(0,0,0,.5);"></div></div></div><div style="font-size:22px;color:rgba(255,255,255,.2);padding-bottom:10px;flex-shrink:0;">vs</div><div style="flex:1;min-width:180px;"><div style="font-size:9px;color:rgba(255,255,255,.3);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:6px;">HrÃÂ¡ÃÂ 2</div><div style="position:relative;"><input id="h2h-p2" type="text" placeholder="napÃÂ. Sinner" autocomplete="off" style="width:100%;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.12);color:#e6edf3;font-size:14px;padding:10px 14px;border-radius:10px;outline:none;box-sizing:border-box;"/><div id="h2h-p2-sug" style="display:none;position:absolute;top:100%;left:0;right:0;background:#1c2128;border:1px solid rgba(255,255,255,.15);border-radius:8px;z-index:100;max-height:200px;overflow-y:auto;margin-top:2px;box-shadow:0 8px 24px rgba(0,0,0,.5);"></div></div></div><button id="h2h-go" style="background:rgba(0,200,83,.15);border:1px solid rgba(0,200,83,.35);color:#00C853;font-size:13px;font-weight:700;padding:10px 22px;border-radius:10px;cursor:pointer;white-space:nowrap;flex-shrink:0;">Porovnat Ã¢ÂÂ</button></div><div id="h2h-status" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,.4);min-height:18px;"></div><div id="h2h-result" style="margin-top:4px;"></div></div>';

    function setupAC(inputId,sugId){
      var inp=wrap.querySelector('#'+inputId),sug=wrap.querySelector('#'+sugId);
      inp.addEventListener('input',function(){
        var q=(inp.value||'').toLowerCase().trim();
        if(q.length<2){sug.style.display='none';return;}
        var matches=(window.ATP_PLAYERS||[]).filter(function(p){return normName(p.name).includes(q)||normName(p.full_name||'').includes(q);}).slice(0,8);
        if(!matches.length){sug.style.display='none';return;}
        sug.innerHTML=matches.map(function(p){return '<div class="h2h-si" data-name="'+(p.full_name||p.name)+'" style="padding:8px 12px;cursor:pointer;font-size:13px;color:#e6edf3;border-bottom:1px solid rgba(255,255,255,.05);"><span style="font-weight:600;">'+(p.full_name||p.name)+'</span> <span style="font-size:10px;color:rgba(255,255,255,.3);">#'+p.rank+'</span></div>';}).join('');
        sug.style.display='block';
        sug.querySelectorAll('.h2h-si').forEach(function(item){
          item.addEventListener('mousedown',function(e){e.preventDefault();inp.value=item.dataset.name;sug.style.display='none';});
          item.addEventListener('mouseover',function(){item.style.background='rgba(0,200,83,.1)';});
          item.addEventListener('mouseout',function(){item.style.background='';});
        });
      });
      inp.addEventListener('blur',function(){setTimeout(function(){sug.style.display='none';},150);});
      inp.addEventListener('focus',function(){inp.style.borderColor='rgba(0,200,83,.4)';});
      inp.addEventListener('blur',function(){inp.style.borderColor='rgba(255,255,255,.12)';});
    }
    setupAC('h2h-p1','h2h-p1-sug');
    setupAC('h2h-p2','h2h-p2-sug');
    ...
    wrap.querySelector('#h2h-go').addEventListener('click',function(){
      ...
      if(!v1||!v2){wrap.querySelector('#h2h-status').textContent='Zadej jmÃÂ©na obou hrÃÂ¡ÃÂÃÂ¯';return;}
      var p1=findPlayer(v1),p2=findPlayer(v2);
      if(!p1){wrap.querySelector('#h2h-status').textContent='HrÃÂ¡ÃÂ "'+v1+'" nenalezen';return;}
      if(!p2){wrap.querySelector('#h2h-status').textContent='HrÃÂ¡ÃÂ "'+v2+'" nenalezen';return;}
      wrap.querySelector('#h2h-status').textContent='Ã¢ÂÂ³ NaÃÂÃÂ­tÃÂ¡m data...';
      ...
      }).catch(function(e){wrap.querySelector('#h2h-status').textContent='Ã¢ÂÂ '+e.message;});
    });
...
function buildMatchesTab(sh){
  var wrap=document.createElement('div');
  wrap.id='mw';
  // Nastav innerHTML setter pro zachovÃÂ¡nÃÂ­ filtru po re-renderech
  (function(){
  ...
  var FLAGS={'USA':'Ã°ÂÂÂºÃ°ÂÂÂ¸','ESP':'Ã°ÂÂÂªÃ°ÂÂÂ¸','FRA':'Ã°ÂÂÂ«Ã°ÂÂÂ·','GER':'Ã°ÂÂÂ©Ã°ÂÂÂª','ITA':'Ã°ÂÂÂ®Ã°ÂÂÂ¹','GBR':'Ã°ÂÂÂ¬Ã°ÂÂÂ§','AUS':'Ã°ÂÂÂ¦Ã°ÂÂÂº','ARG':'Ã°ÂÂÂ¦Ã°ÂÂÂ·','JPN':'Ã°ÂÂÂ¯Ã°ÂÂÂµ','CAN':'Ã°ÂÂÂ¨Ã°ÂÂÂ¦','BRA':'Ã°ÂÂÂ§Ã°ÂÂÂ·','NED':'Ã°ÂÂÂ³Ã°ÂÂÂ±','SUI':'Ã°ÂÂÂ¨Ã°ÂÂÂ­','ROU':'Ã°ÂÂÂ·Ã°ÂÂÂ´','POL':'Ã°ÂÂÂµÃ°ÂÂÂ±','CZE':'Ã°ÂÂÂ¨Ã°ÂÂÂ¿','AUT':'Ã°ÂÂÂ¦Ã°ÂÂÂ¹','GRE':'Ã°ÂÂÂ¬Ã°ÂÂÂ·','BEL':'Ã°ÂÂÂ§Ã°ÂÂÂª','SWE':'Ã°ÂÂÂ¸Ã°ÂÂÂª','NOR':'Ã°ÂÂÂ³Ã°ÂÂÂ´','DEN':'Ã°ÂÂÂ©Ã°ÂÂÂ°','SRB':'Ã°ÂÂÂ·Ã°ÂÂÂ¸','KAZ':'Ã°ÂÂÂ°Ã°ÂÂÂ¿','RUS':'Ã°ÂÂÂ·Ã°ÂÂÂº','UKR':'Ã°ÂÂÂºÃ°ÂÂÂ¦','POR':'Ã°ÂÂÂµÃ°ÂÂÂ¹','CHI':'Ã°ÂÂÂ¨Ã°ÂÂÂ±','MEX':'Ã°ÂÂÂ²Ã°ÂÂÂ½','RSA':'Ã°ÂÂÂ¿Ã°ÂÂÂ¦','IND':'Ã°ÂÂÂ®Ã°ÂÂÂ³','KOR':'Ã°ÂÂÂ°Ã°ÂÂÂ·','MAR':'Ã°ÂÂÂ²Ã°ÂÂÂ¦','COL':'Ã°ÂÂÂ¨Ã°ÂÂÂ´','CRO':'Ã°ÂÂÂ­Ã°ÂÂÂ·','GEO':'Ã°ÂÂÂ¬Ã°ÂÂÂª','QAT':'Ã°ÂÂÂ¶Ã°ÂÂÂ¦','UAE':'Ã°ÂÂÂ¦Ã°ÂÂÂª','CHN':'Ã°ÂÂÂ¨Ã°ÂÂÂ³','SVK':'Ã°ÂÂÂ¸Ã°ÂÂÂ°','UZB':'Ã°ÂÂÂºÃ°ÂÂÂ¿','MON':'Ã°ÂÂÂ²Ã°ÂÂÂ¨','TUR':'Ã°ÂÂÂ¹Ã°ÂÂÂ·','BUL':'Ã°ÂÂÂ§Ã°ÂÂÂ¬','HUN':'Ã°ÂÂÂ­Ã°ÂÂÂº','FIN':'Ã°ÂÂÂ«Ã°ÂÂÂ®','SLO':'Ã°ÂÂÂ¸Ã°ÂÂÂ®','SVK':'Ã°ÂÂÂ¸Ã°ÂÂÂ°','EST':'Ã°ÂÂÂªÃ°ÂÂÂª','LAT':'Ã°ÂÂÂ±Ã°ÂÂÂ»','LTU':'Ã°ÂÂÂ±Ã°ÂÂÂ¹','NZL':'Ã°ÂÂÂ³Ã°ÂÂÂ¿','AZE':'Ã°ÂÂÂ¦Ã°ÂÂÂ¿','ARM':'Ã°ÂÂÂ¦Ã°ÂÂÂ²','GBR':'Ã°ÂÂÂ¬Ã°ÂÂÂ§','MDA':'Ã°ÂÂÂ²Ã°ÂÂÂ©','BLR':'Ã°ÂÂÂ§Ã°ÂÂÂ¾'};

  function tInfo(t){
    var u=t.toUpperCase();
    if(u.includes('ITF')) return{i:'Ã°ÂÂÂµ',l:'ITF',c:'#c084fc',bg:'rgba(192,132,252,.08)',b:'rgba(192,132,252,.2)'};
    if(u.includes('CHALLENGER')) return{i:'Ã¢ÂÂ¡',l:'Challenger',c:'#facc15',bg:'rgba(250,204,21,.1)',b:'rgba(250,204,21,.2)'};
    if(u.match(/AUSTRALIAN OPEN|ROLAND GARROS|WIMBLEDON|US OPEN/)) return{i:'Ã°ÂÂÂ',l:'Grand Slam',c:'#FFD700',bg:'rgba(255,215,0,.12)',b:'rgba(255,215,0,.3)'};
    if(u.match(/ATP.*1000|MASTERS 1000|MIAMI|INDIAN WELLS|MADRID OPEN|ROME|MONTREAL|CINCINNATI|SHANGHAI|PARIS MASTERS|CANADIAN|MONTE.CARLO/)) return{i:'Ã°ÂÂ¥Â',l:'ATP 1000',c:'#C0C0C0',bg:'rgba(192,192,192,.1)',b:'rgba(192,192,192,.2)'};
    if(u.match(/ATP.*500|ROTTERDAM|DUBAI|ACAPULCO|BARCELONA|HAMBURG|WASHINGTON|TOKYO|BEIJING|VIENNA|BASEL/)) return{i:'Ã°ÂÂ¥Â',l:'ATP 500',c:'#CD7F32',bg:'rgba(205,127,50,.1)',b:'rgba(205,127,50,.2)'};
    if(u.match(/WTA.*1000/)) return{i:'Ã°ÂÂÂ´',l:'WTA 1000',c:'#e879f9',bg:'rgba(232,121,249,.1)',b:'rgba(232,121,249,.2)'};
    if(u.match(/WTA.*500/)) return{i:'Ã°ÂÂÂ£',l:'WTA 500',c:'#d946ef',bg:'rgba(217,70,239,.1)',b:'rgba(217,70,239,.2)'};
    if(u.match(/WTA.*SINGLES|WTA - /)) return{i:'Ã°ÂÂÂ£',l:'WTA 250',c:'#c084fc',bg:'rgba(192,132,252,.08)',b:'rgba(192,132,252,.15)'};
    return{i:'Ã°ÂÂÂ¾',l:'ATP 250',c:'#38bdf8',bg:'rgba(56,189,248,.08)',b:'rgba(56,189,248,.2)'};
  }
  ...
  function pb(b){var o={};b.split('ÃÂ¬').forEach(function(f){var i=f.indexOf('ÃÂ·');if(i>0)o[f.slice(0,i)]=f.slice(i+1);});return o;}

  function parseFeed(feedTxt){
    // KLÃÂÃÂOVÃÂ OPRAVA: game score (WA/WB/WC) je pÃÂÃÂ­mo v f_2_0_1 bloku kaÃÂ¾dÃÂ©ho zÃÂ¡pasu
    // NEPÃÂEPISUJEME r_2_1 Ã¢ÂÂ f_2_0_1 je aktuÃÂ¡lnÃÂjÃÂ¡ÃÂ­ a kompletnÃÂ­
    ...
    blocks.forEach(function(b){
      ...
      if(isLive){
        // WA/WB/WC jsou game score pÃÂÃÂ­mo v f_2_0_1 Ã¢ÂÂ aktuÃÂ¡lnÃÂ­ a pÃÂesnÃÂ©
        game1=b.WA||'0';
        game2=b.WB||'0';
    ...
    try{
      ...
      if(cached){
        ...
        if(cp._ts&&Date.now()-cp._ts<cacheTTL){
          console.log('[FS] Cache hit, vÃÂk:'+(Date.now()-cp._ts)+'ms');
          delete cp._ts;
  ...
  function getMatches(data){
    // Worker a flashscore vracÃÂ­ data pro konkrÃÂ©tnÃÂ­ den pÃÂÃÂ­mo
    return data.matches||[];
  }

  function _ioc2flag(c){if(!c)return '';var m={'USA':'US','ESP':'ES','FRA':'FR','GER':'DE','ITA':'IT','GBR':'GB','AUS':'AU','ARG':'AR','JPN':'JP','CAN':'CA','BRA':'BR','NED':'NL','SUI':'CH','ROU':'RO','POL':'PL','CZE':'CZ','AUT':'AT','GRE':'GR','BEL':'BE','SWE':'SE','NOR':'NO','DEN':'DK','SRB':'RS','KAZ':'KZ','RUS':'RU','UKR':'UA','POR':'PT','CHI':'CL','MEX':'MX','RSA':'ZA','IND':'IN','KOR':'KR','MAR':'MA','COL':'CO','CRO':'HR','GEO':'GE','QAT':'QA','UAE':'AE','CHN':'CN','SVK':'SK','MON':'MC','TUR':'TR','BUL':'BG','HUN':'HU','FIN':'FI','SLO':'SI','EST':'EE','LAT':'LV','LTU':'LT','NZL':'NZ','AZE':'AZ','ARM':'AM','MDA':'MD','BLR':'BY','ISR':'IL','TUN':'TN','EGY':'EG','KEN':'KE','SEN':'SN','PUR':'PR','DOM':'DO','VEN':'VE','BOL':'BO','PAR':'PY','URU':'UY','PER':'PE','ECU':'EC','GUA':'GT','PAN':'PA','PHI':'PH','THA':'TH','VIE':'VN','MAS':'MY','SIN':'SG','INA':'ID','TPE':'TW','HKG':'HK','UZB':'UZ','ISL':'IS','IRL':'IE','LUX':'LU','MLT':'MT','CYP':'CY','GBR':'GB','SCO':'GB','WAL':'GB','CMR':'CM','ANG':'AO','KOS':'XK','KSA':'SA','NMI':'MP','SVK':'SK','KEN':'KE','RSA':'ZA','ZIM':'ZW','NGR':'NG','GHA':'GH','SEN':'SN','ETH':'ET','UGA':'UG','TAN':'TZ','ZAM':'ZM','MRI':'MU','SEY':'SC','BOT':'BW','NAM':'NA','MAD':'MG','CIV':'CI','TUN':'TN','EGY':'EG','MAR':'MA','ALG':'DZ','LBA':'LY','NIG':'NE','MLI':'ML','SUD':'SD','RWA':'RW','PHI':'PH','INA':'ID','MAS':'MY','THA':'TH','VIE':'VN','SIN':'SG','TPE':'TW','HKG':'HK','MGL':'MN','PAK':'PK','SRI':'LK','BAN':'BD','IRI':'IR','LIB':'LB','JOR':'JO','KUW':'KW','BAH':'BH','OMA':'OM','QAT':'QA','UAE':'AE','YEM':'YE','IRQ':'IQ','SYR':'SY','PUR':'PR','DOM':'DO','JAM':'JM','TRI':'TT','HAI':'HT','CUB':'CU','GUA':'GT','ESA':'SV','CRC':'CR','PAN':'PA','HON':'HN','NCA':'NI','GUY':'GY','SUR':'SR','BOL':'BO','PAR':'PY','URU':'UY','PER':'PE','ECU':'EC','VEN':'VE','COL':'CO','CHI':'CL','ARG':'AR','BRA':'BR','MEX':'MX','CAN':'CA','USA':'US','BIH':'BA','MKD':'MK','ESA':'SV','ALB':'AL','BDI':'BI','NMI':'MP','SVK':'SK','PLE':'PS','MDV':'MV'};var iso=m[c]||null;if(!iso||iso.length!==2)return '';return iso.split('').map(function(x){return String.fromCodePoint(x.charCodeAt(0)+127397);}).join('');}
function _pf(n){var _key='_pfC_v5_'+(window.ATP_PLAYERS||[]).length+'_'+(window.WTA_PLAYERS||[]).length;if(!window[_key]){var _ex={'gauff':'USA','sabalenka':'BLR','swiatek':'POL','rybakina':'KAZ','pegula':'USA','keys':'USA','navarro':'USA','collins':'USA','parks':'USA','alexandrova':'RUS','kasatkina':'RUS','shnaider':'RUS','andreeva':'RUS','blinkova':'RUS','potapova':'RUS','samsonova':'RUS','pavlyuchenkova':'RUS','vesnina':'RUS','svitolina':'UKR','kostyuk':'UKR','tsurenko':'UKR','ostapenko':'LAT','kanepi':'EST','kontaveit':'EST','paolini':'ITA','bronzetti':'ITA','cocciaretto':'ITA','trevisan':'ITA','giorgi':'ITA','errani':'ITA','sakkari':'GRE','bouzkova':'CZE','vondrousova':'CZE','pliskova':'CZE','kvitova':'CZE','siniakovÃÂ¡':'CZE','muchova':'CZE','krejcikova':'CZE','fruhvirtova':'CZE','strycova':'CZE','garcia':'FRA','burel':'FRA','ferro':'FRA','mladenovic':'FRA','cornet':'FRA','golubic':'SUI','bencic':'SUI','teichmann':'SUI','jabeur':'TUN','haddad':'BRA','sorribes':'ESP','muguruza':'ESP','badosa':'ESP','fernandez':'CAN','andreescu':'CAN','dabrowski':'CAN','watson':'GBR','raducanu':'GBR','boulter':'GBR','sherif':'EGY','azarenka':'BLR','sasnovich':'BLR','halep':'ROU','bogdan':'ROU','bara':'ROU','cristian':'ROU','cirstea':'ROU','ivanovic':'SRB','jovanovski':'SRB','danilovic':'SRB','stojanovic':'SRB','niculescu':'ROU','ruse':'ROU','hontama':'JPN','osaka':'JPN','doi':'JPN','aoyama':'JPN','lys':'GER','grabher':'AUT','viktoriya':'UKR','linette':'POL','zhu':'CHN','zheng':'CHN','wang':'CHN','zhang':'CHN','peng':'CHN','han':'CHN','lu':'CHN','liu':'CHN','shcherbakova':'RUS','kucova':'SVK','schmiedlova':'SVK','rybarkova':'SVK','lapko':'BLR','baptiste':'USA','townsend':'USA','mcnally':'USA','harrison':'USA','liu':'USA','stephens':'USA','venus':'USA','serena':'USA','vacherot':'MON','inglis':'AUS','peers':'AUS','tomljanovic':'AUS','stosur':'AUS','barty':'AUS','gavrilova':'AUS','escabias':'ESP','shelbayh':'JOR','hassan':'EGY','kirkin':'TUR','roncadelli':'ITA','gonzalez':'COL','barreto':'BRA','varillas':'PER','udvardy':'HUN','starodubtseva':'UKR','volynets':'USA','dodin':'FRA','salkova':'CZE','timofeeva':'RUS','charaeva':'RUS','shymanovich':'BLR','kasintseva':'AND','jimenez':'AND','monnet':'FRA','brengle':'USA','kalinina':'UKR','vekic':'CRO','kroitor':'UKR','siskova':'CZE','laron':'ISR','kowalczyk':'POL','pulchartova':'CZE','laboutkova':'CZE','villet':'FRA','sziedat':'GER','bayerlova':'CZE','martynov':'ROU','giovannini':'ARG','capurro':'ARG','gvozdenovic':'SRB','gudelj':'SRB','burylo':'UKR','chudejova':'CZE','nepliy':'UKR','kovacevic':'SRB','hatouka':'CZE','hatoukovÃÂ¡':'CZE','guth':'GER','tholey':'GER','mcgiffin':'AUS','nava':'USA','andrade':'COL','burruchaga':'ARG','brancaccio':'ITA','vrbensky':'CZE','strombachs':'GER','gengel':'CZE','alkaya':'TUR','marinkov':'SRB','blockx':'BEL','dzumhur':'BIH','ribecai':'ITA','neumayer':'AUT','berkieta':'POL','andaloro':'ITA','vasami':'ITA','krumich':'GER','nagal':'IND','molleker':'GER','caniato':'ITA','dhamne':'IND','brunclik':'CZE','arnaboldi':'ITA','albot':'MDA','guerrieri':'ITA','lokoli':'FRA','kasnikowski':'POL','oberleitner':'AUT','bondioli':'ITA','jevsejev':'EST','gombos':'SVK','vasa':'FIN','comesana':'ARG','jodar':'ESP','trungelliti':'ARG','merida':'ESP','dedura':'ESP','meneses':'ESP','cozar':'ESP','donski':'BUL','palosi':'ROU','stricker':'SUI','izquierdo':'ESP','manzano':'ESP','negritu':'ROU','butvilas':'LTU','gulin':'RUS','nedic':'SRB','hemery':'FRA','dellien':'BOL','geerts':'BEL','searle':'GBR','alcaraz':'ESP','alexandrova':'RUS','altmaier':'GER','andreescu':'CAN','andreeva':'RUS','anisimova':'USA','aoyama':'JPN','atmane':'FRA','azarenka':'BLR','badosa':'ESP','baez':'ARG','bara':'ROU','basilashvili':'GEO','basilaÃÂ¡vili':'GEO','bautista':'ESP','bellucci':'ITA','bencic':'SUI','bergs':'BEL','birrell':'AUS','blinkova':'RUS','bogdan':'ROU','bondar':'POL','borges':'POR','boulter':'GBR','brady':'USA','broady':'GBR','bronzetti':'ITA','buzarnescu':'ROU','cadenasso':'ITA','carballes':'ESP','cash':'GBR','cerundolo':'ARG','chachanov':'RUS','cirstea':'ROU','cocciaretto':'ITA','dabrowski':'CAN','davidovich':'ESP','delbonis':'ARG','diallo':'CAN','dimitrov':'BUL','djokovic':'SRB','doi':'JPN','dolehide':'USA','doumbia':'FRA','draper':'GBR','duckworth':'AUS','ebden':'AUS','errani':'ITA','etcheverry':'ARG','evans':'GBR','fernandez':'CAN','fery':'GBR','flipkens':'BEL','fognini':'ITA','fokina':'ESP','fonseca':'BRA','frech':'POL','fritz':'USA','fucsovics':'HUN','garin':'CHI','gasanova':'RUS','gavrilova':'AUS','giorgi':'ITA','goffin':'BEL','golubic':'SUI','grabher':'AUT','granollers':'ESP','griekspoor':'NED','haddad':'BRA','halep':'ROU','harris':'GBR','harrison':'USA','herbert':'FRA','hibino':'JPN','hontama':'JPN','humbert':'FRA','hurkacz':'POL','inglis':'AUS','ivanovic':'SRB','ivashka':'BLR','jabeur':'TUN','jarry':'CHI','jasika':'AUS','jimenez':'AND','kalinskaya':'RUS','kanepi':'EST','karatsev':'RUS','kasatkina':'RUS','kasintseva':'AND','kecmanovic':'SRB','kenin':'USA','khachanov':'RUS','khromacheva':'RUS','koepfer':'GER','kokkinakis':'AUS','kontaveit':'EST','kostyuk':'UKR','kotov':'RUS','kozlov':'USA','krawczyk':'USA','kucova':'SVK','laaksonen':'SUI','lajovic':'SRB','lapko':'BLR','lehecka':'CZE','linette':'POL','llamas':'ESP','lys':'GER','machac':'CZE','machÃÂ¡ÃÂ':'CZE','mahut':'FRA','majchrzak':'POL','mannarino':'FRA','marozsan':'HUN','mcnally':'USA','medvedev':'RUS','mensik':'CZE','menÃÂ¡ÃÂ­k':'CZE','mertens':'BEL','minnen':'BEL','mmoh':'USA','monfils':'FRA','moutet':'FRA','mpetshi':'FRA','muguruza':'ESP','muller':'FRA','munar':'ESP','murray':'GBR','musetti':'ITA','nadal':'ESP','nakashima':'USA','navone':'ARG','niculescu':'ROU','norrie':'GBR','opelka':'USA','osaka':'JPN','osorio':'COL','ostapenko':'LAT','paolini':'ITA','parks':'USA','parrizas':'ESP','pavlyuchenkova':'RUS','peers':'AUS','podoroska':'ARG','popyrin':'AUS','pospisil':'CAN','potapova':'RUS','puig':'PUR','raducanu':'GBR','rakhimova':'RUS','reboul':'FRA','rinderknech':'FRA','rogers':'USA','rublev':'RUS','rune':'DEN','ruse':'ROU','ruud':'NOR','safiullin':'RUS','sakkari':'GRE','salisbury':'GBR','samsonova':'RUS','schmiedlova':'SVK','schoolkate':'AUS','shapovalov':'CAN','shcherbakova':'RUS','shelton':'USA','shevchenko':'RUS','siegemund':'GER','sinner':'ITA','sizikova':'RUS','sonego':'ITA','sorribes':'ESP','sousa':'POR','stojanovic':'SRB','stosur':'AUS','strakhova':'UKR','struff':'GER','svitolina':'UKR','tabilo':'CHI','tauson':'DEN','teichmann':'SUI','thompson':'AUS','tiafoe':'USA','tig':'ROU','tikhonova':'RUS','tomljanovic':'AUS','townsend':'USA','travaglia':'ITA','trevisan':'ITA','tsitsipas':'GRE','tsurenko':'UKR','vacherot':'MON','wang':'CHN','watson':'GBR','wawrinka':'SUI','wozniacki':'DEN','yastremska':'UKR','zhang':'CHN','zheng':'CHN','zhu':'CHN','zvonareva':'RUS','paul':'USA','blanch':'USA','collignon':'BEL','landaluce':'ESP','berrettini':'ITA','sonego':'ITA','musetti':'ITA','cobolli':'ITA','nardi':'ITA','arnaldi':'ITA','vavassori':'ITA','darderi':'ITA','agamenone':'ITA','eala':'PHI','mboko':'CMR','fruhvirtova':'CZE','noskova':'CZE','siniakovÃÂ¡':'CZE','krejcikova':'CZE','townsend':'USA','mcnally':'USA','harrison':'USA','brengle':'USA','brady':'USA','liu':'USA','kenin':'USA','stephens':'USA','williams':'USA','pegula':'USA','navarro':'USA','collins':'USA','anisimova':'USA','sherif':'EGY','yastremska':'UKR','melnyk':'UKR','kalinskaya':'RUS','rakhimova':'RUS','gasanova':'RUS','sizikova':'RUS','zvonareva':'RUS','vichka':'RUS','zhuk':'RUS','niemeier':'GER','grabher':'AUT','siegemund':'GER','golubic':'SUI','teichmann':'SUI','bencic':'SUI','korpatsch':'GER','lys':'GER','friedsam':'GER','Ã¡ÂÂbas':'BLR','sherif':'EGY','hontama':'JPN','doi':'JPN','aoyama':'JPN','hibino':'JPN','minnen':'BEL','flipkens':'BEL','mertens':'BEL','linette':'POL','swiatek':'POL','rogers':'USA','pegula':'USA','tauson':'DEN','wozniacki':'DEN','ruse':'ROU','bogdan':'ROU','bara':'ROU','cristian':'ROU','cirstea':'ROU','buzarnescu':'ROU','podoroska':'ARG','osorio':'COL','haddad':'BRA','sorribes':'ESP','badosa':'ESP','muguruza':'ESP','parrizas':'ESP','fernandez':'CAN','andreescu':'CAN','dabrowski':'CAN','inglis':'AUS','peers':'AUS','tomljanovic':'AUS','stosur':'AUS','barty':'AUS','gavrilova':'AUS','birrell':'AUS','puig':'PUR','stephens':'USA','tig':'ROU','niculescu':'ROU',
...
function renderMatches(data){
    ...
    var hcm=sh.getElementById('hc-count-m');if(hcm)hcm.textContent=all.length+' zÃÂ¡pasÃÂ¯';
    ...
    // withOdds - kontrola kurzÃÂ¯ jen pro zÃÂ¡pasy bez existujÃÂ­cÃÂ­ho zÃÂ¡znamu
    // withOdds - poÃÂÃÂ­tÃÂ¡ se lazy jen kdyÃÂ¾ je potÃÂeba
    ...
    [{d:-1,l:'VÃÂera'},{d:0,l:'Dnes'},{d:1,l:'ZÃÂ­tra'},{d:2,l:'+2 dny'},{d:3,l:'+3 dny'}].forEach(function(x){
    ...
    h+='<button data-day="fav" style="padding:5px 16px;border-radius:7px;border:1px solid '+(_fo?'#FFD700':'rgba(255,255,255,.1)')+';background:'+(_fo?'rgba(255,215,0,.12)':'transparent')+';color:'+(_fo?'#FFD700':'rgba(255,255,255,.4)')+';font-size:12px;cursor:pointer;margin-left:4px;font-weight:'+(_fo?700:400)+';">&#9733; Obl&#237;ben&#233;'+(JSON.parse(localStorage.getItem('ts_favs')||'[]').length?' <span style="font-size:10px;background:rgba(255,215,0,.25);border-radius:8px;padding:1px 6px;">'+JSON.parse(localStorage.getItem('ts_favs')||'[]').length+'</span>':'')+'</button>';
    h+='<div style="margin-left:auto;display:flex;align-items:center;gap:6px;">';
    if(data.src==='github'){var _upd=data.updated?new Date(data.updated).getTime():NaN;var age=isNaN(_upd)?null:Math.round((Date.now()-_upd)/60);if(age!==null&&age>60)h+='<span style="font-size:9px;color:rgba(255,140,0,.7);">Ã¢ÂÂ Ã¯Â¸Â data '+age+'min starÃÂ¡ Ã¢ÂÂ spusÃÂ¥ skript na flashscore.com</span>';}
    if(_lastUpdated)h+='<span style="font-size:9px;color:rgba(255,255,255,.2);">Ã¢ÂÂ¥ '+_lastUpdated.slice(11,16)+'</span>';
    ...
    [['all','VÃÂ¡e',all.length],['live','LIVE Ã°ÂÂÂ´',live.length],['finished','Konec',fin.length],['scheduled','NÃÂ¡plÃÂ¡n.',sch.length],['odds','S kurzem Ã°ÂÂÂ°',(function(){
  var _c=0;
  ...
  return _c;
      ...
      var fw=on?700:400;
      var label=(on&&isMulti?'Ã¢ÂÂ ':'')+f[1]+(f[2]!==undefined?' ('+f[2]+')':'');
    ...
    if(!shown.length){h+='<div style="padding:60px;text-align:center;color:rgba(255,255,255,.2);">ÃÂ½ÃÂ¡dnÃÂ© zÃÂ¡pasy</div>';}
      ...
      if(activeSort==='time'){
        ...
        shown.forEach(function(m){
          ...
          h+='<div style="min-width:44px;text-align:center;flex-shrink:0;">'+(isLive?'<span style="font-size:9px;font-weight:800;color:#ff1100;">LIVE</span>':'<span style="font-size:13px;font-weight:300;color:'+('rgba(255,255,255,.35)')+';">'+(m.isFin?'Konec':timeStr(m.ts))+'</span>')+'</div>';
          h+='<button onclick="var f=JSON.parse(localStorage.getItem(\x27ts_favs\x27)||\x27[]\x27);var id=\x27'+m.id+'\x27;var i=f.indexOf(id);if(i>-1)f.splice(i,1);else f.push(id);localStorage.setItem(\x27ts_favs\x27,JSON.stringify(f));var on=f.indexOf(id)>-1;this.style.color=on?\x27#FFD700\x27:\x27rgba(255,255,255,0.3)\x27;var svg=this.querySelector(\x27svg\x27);if(svg){svg.style.fill=on?\x27currentColor\x27:\x27none\x27;}var _fb=document.querySelector(\x27#ts-host\x27)?document.querySelector(\x27#ts-host\x27).shadowRoot.querySelector(\x27[data-day=\\x27fav\\x27]\x27):null;if(_fb){var _fc=JSON.parse(localStorage.getItem(\x27ts_favs\x27)||\x27[]\x27).length;var _fs=_fb.querySelector(\x27span\x27);if(_fc>0){if(!_fs){_fs=document.createElement(\x27span\x27);_fs.style.cssText=\x27font-size:10px;background:rgba(255,215,0,.25);border-radius:8px;padding:1px 6px;\x27;_fb.appendChild(_fs);}}_fs&&(_fs.textContent=_fc||\x27\x27);}event.stopPropagation()" style="background:none;border:none;cursor:pointer;padding:0 5px;flex-shrink:0;color:rgba(255,255,255,0.3);align-self:stretch;display:flex;align-items:center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15" style="display:block;fill:none;stroke:currentColor;stroke-width:2"><polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"/></svg></button>';
          ...
          h+='<div style="display:flex;align-items:center;gap:4px;margin-bottom:3px;"><span class="mc-plink" data-pname="'+m.p1+'" style="font-size:12px;font-weight:700;color:'+(w1?'#FFD700':'#e6edf3')+';white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:190px;cursor:pointer;">'+(m.p1.includes('/')?m.p1.split('/').map(function(n){return _pf(n.trim())+' '+n.trim();}).join(' / '):_pf(m.p1)+' '+m.p1)+'</span>'+(m.serving===1&&isLive?'<span style="font-size:10px;line-height:1;">Ã°ÂÂÂ¾</span>':'')+'</div>';
          h+='<div style="display:flex;align-items:center;gap:4px;"><span class="mc-plink" data-pname="'+m.p2+'" style="font-size:12px;font-weight:700;color:'+(w2?'#FFD700':'#e6edf3')+';white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:190px;cursor:pointer;">'+(m.p2.includes('/')?m.p2.split('/').map(function(n){return _pf(n.trim())+' '+n.trim();}).join(' / '):_pf(m.p2)+' '+m.p2)+'</span>'+(m.serving===2&&isLive?'<span style="font-size:10px;line-height:1;">Ã°ÂÂÂ¾</span>':'')+'</div>';
          h+='</div>';
          ...
          function isSetDoneT(a,b){var x=parseInt(a),y=parseInt(b);if(isNaN(x)||isNaN(y))return false;if(x===7||y===7)return true;return(x>=6||y>=6)&&Math.abs(x-y)>=2;}
          var maxSiT=isLive?ns-1:ns;
          for(var siT=0;siT<maxSiT;siT++){var v1T=(m.sets1||[])[siT]||'0',v2T=(m.sets2||[])[siT]||'0';if(isLive&&!isSetDoneT(v1T,v2T))continue;var b1T=parseInt(v1T)>parseInt(v2T),b2T=parseInt(v2T)>parseInt(v1T);h+='<div style="text-align:center;min-width:14px;padding:1px 2px;opacity:0.55;"><div style="font-size:15px;line-height:1.3;font-weight:'+(b1T?700:400)+';color:'+(b1T?'#ccc':'rgba(255,255,255,.35)')+';">'+v1T+'</div><div style="font-size:15px;line-height:1.3;font-weight:'+(b2T?700:400)+';color:'+(b2T?'#ccc':'rgba(255,255,255,.35)')+';">'+v2T+'</div></div>';}
      ...
      tOrd.forEach(function(t){
        var sample=byT[t][0];
        var ti=tInfo(t);
        var flag=FLAGS[sample.tournament_country||'']||'';if(!flag){var _m=t.match(/\(([^)]+)\)/);if(_m){var _cn={'Spain':'Ã°ÂÂÂªÃ°ÂÂÂ¸','USA':'Ã°ÂÂÂºÃ°ÂÂÂ¸','Japan':'Ã°ÂÂÂ¯Ã°ÂÂÂµ','France':'Ã°ÂÂÂ«Ã°ÂÂÂ·','Italy':'Ã°ÂÂÂ®Ã°ÂÂÂ¹','Germany':'Ã°ÂÂÂ©Ã°ÂÂÂª','Australia':'Ã°ÂÂÂ¦Ã°ÂÂÂº','Argentina':'Ã°ÂÂÂ¦Ã°ÂÂÂ·','Canada':'Ã°ÂÂÂ¨Ã°ÂÂÂ¦','Brazil':'Ã°ÂÂÂ§Ã°ÂÂÂ·','Netherlands':'Ã°ÂÂÂ³Ã°ÂÂÂ±','Switzerland':'Ã°ÂÂÂ¨Ã°ÂÂÂ­','Romania':'Ã°ÂÂÂ·Ã°ÂÂÂ´','Poland':'Ã°ÂÂÂµÃ°ÂÂÂ±','Czech Republic':'Ã°ÂÂÂ¨Ã°ÂÂÂ¿','Austria':'Ã°ÂÂÂ¦Ã°ÂÂÂ¹','Greece':'Ã°ÂÂÂ¬Ã°ÂÂÂ·','Belgium':'Ã°ÂÂÂ§Ã°ÂÂÂª','Sweden':'Ã°ÂÂÂ¸Ã°ÂÂÂª','Norway':'Ã°ÂÂÂ³Ã°ÂÂÂ´','Denmark':'Ã°ÂÂÂ©Ã°ÂÂÂ°','Serbia':'Ã°ÂÂÂ·Ã°ÂÂÂ¸','Croatia':'Ã°ÂÂÂ­Ã°ÂÂÂ·','Hungary':'Ã°ÂÂÂ­Ã°ÂÂÂº','Portugal':'Ã°ÂÂÂµÃ°ÂÂÂ¹','Colombia':'Ã°ÂÂÂ¨Ã°ÂÂÂ´','Chile':'Ã°ÂÂÂ¨Ã°ÂÂÂ±','Mexico':'Ã°ÂÂÂ²Ã°ÂÂÂ½','Morocco':'Ã°ÂÂÂ²Ã°ÂÂÂ¦','Turkey':'Ã°ÂÂÂ¹Ã°ÂÂÂ·','China':'Ã°ÂÂÂ¨Ã°ÂÂÂ³','India':'Ã°ÂÂÂ®Ã°ÂÂÂ³','South Korea':'Ã°ÂÂÂ°Ã°ÂÂÂ·','Ecuador':'Ã°ÂÂÂªÃ°ÂÂÂ¨','Peru':'Ã°ÂÂÂµÃ°ÂÂÂª','Uruguay':'Ã°ÂÂÂºÃ°ÂÂÂ¾','Paraguay':'Ã°ÂÂÂµÃ°ÂÂÂ¾','Bolivia':'Ã°ÂÂÂ§Ã°ÂÂÂ´','Guatemala':'Ã°ÂÂÂ¬Ã°ÂÂÂ¹','Kazakhstan':'Ã°ÂÂÂ°Ã°ÂÂÂ¿','Tunisia':'Ã°ÂÂÂ¹Ã°ÂÂÂ³','Egypt':'Ã°ÂÂÂªÃ°ÂÂÂ¬','South Africa':'Ã°ÂÂÂ¿Ã°ÂÂÂ¦','Kenya':'Ã°ÂÂÂ°Ã°ÂÂÂª','Great Britain':'Ã°ÂÂÂ¬Ã°ÂÂÂ§','United Kingdom':'Ã°ÂÂÂ¬Ã°ÂÂÂ§','Ireland':'Ã°ÂÂÂ®Ã°ÂÂÂª','Slovakia':'Ã°ÂÂÂ¸Ã°ÂÂÂ°','Bulgaria':'Ã°ÂÂÂ§Ã°ÂÂÂ¬','Finland':'Ã°ÂÂÂ«Ã°ÂÂÂ®','Estonia':'Ã°ÂÂÂªÃ°ÂÂÂª','Lithuania':'Ã°ÂÂÂ±Ã°ÂÂÂ¹','Latvia':'Ã°ÂÂÂ±Ã°ÂÂÂ»','Slovenia':'Ã°ÂÂÂ¸Ã°ÂÂÂ®'};var _k=_m[1].trim();flag=_cn[_k]||FLAGS[_k]||''}};
        ...
        byT[t].forEach(function(m){
          ...
          for(var si=0;si<maxSi;si++){
            ...
            // Dokonceny set Ã¢ÂÂ maly, sedy, bez pozadi
...
var _f=JSON.parse(localStorage.getItem('ts_favs')||'[]');if(_f.length){wrap.querySelectorAll('button').forEach(function(_b){var _m=_b.getAttribute('onclick');if(!_m)return;var _i=_m.indexOf("id='")+4;var _j=_m.indexOf("'",_i);var _id=_m.substring(_i,_j);if(_f.indexOf(_id)>-1){_b.style.color='#FFD700';var _svg=_b.querySelector('svg');if(_svg)_svg.style.fill='currentColor';}});}
  ...
  async function tick(){
    ...
    try{
      ...
      if(_secEl&&!_lastData){_secEl.innerHTML='<div style="padding:30px;text-align:center;color:rgba(255,255,255,.4);font-size:13px;">Ã¢ÂÂ³ NaÃÂÃÂ­tÃÂ¡m zÃÂ¡pasy...</div>';}
      // NaÃÂti zÃÂ¡pasy a Chance data paralelnÃÂ
      ...
      else{wrap.innerHTML='<div style="padding:60px;text-align:center;color:rgba(255,255,255,.2);">Ã¢ÂÂ Ã¯Â¸Â '+e.message+'</div>';}
    }finally{_fetching=false;}
  }
  function render(){if(!_lastData)wrap.innerHTML='<div style="padding:60px;text-align:center;color:rgba(255,255,255,.2);">Ã¢ÂÂ³ NaÃÂÃÂ­tÃÂ¡m...</div>';tick();}
...
function buildUI(){
  ...
  // Filter observer - pÃÂeÃÂ¾ije re-rendery
  // Filter se pÃÂidÃÂ¡ pÃÂi prvnÃÂ­m renderMatches volÃÂ¡nÃÂ­
  ...
  sidebar.innerHTML=`
    <div id="sb-logo">
      <div id="sb-logo-icon">Ã°ÂÂÂ¾</div>
      <div id="sb-logo-text">Tennis<span>Scout</span></div>
      <div id="sb-badge">v${VERSION}</div>
    </div>
    <nav id="sb-nav">
      <div class="nav-section">PÃÂehled</div>
      <div class="nav-item active" data-view="home" id="nav-home">
        <span class="nav-icon">Ã¢ÂÂ</span> RozcestnÃÂ­k
      </div>
      <div class="nav-section">Moduly</div>
      <div class="nav-item" data-view="tournaments" id="nav-tournaments">
        <span class="nav-icon">Ã°ÂÂÂ</span> Turnaje
        <span class="nav-badge" id="nav-count">795</span>
      </div>
      <div class="nav-item" data-view="matches" id="nav-matches"><span class="nav-icon">Ã°ÂÂÂ¾</span> ZÃÂ¡pasy</div><div class="nav-item" data-view="h2h" id="nav-h2h"><span class="nav-icon">Ã¢ÂÂÃ¯Â¸Â</span> H2H</div>
      <div class="nav-item" data-view="players" id="nav-players">
        <span class="nav-icon">Ã°ÂÂÂ¤</span> HrÃÂ¡ÃÂi ATP
        <span class="nav-badge" id="nav-players-count">1454</span>
      </div>
      <div class="nav-item disabled">
        <span class="nav-icon">Ã°ÂÂÂ</span> Kurzy
        <span class="nav-soon">brzy</span>
      </div>
      <div class="nav-item disabled">
        <span class="nav-icon">Ã¢ÂÂ¡</span> Live zÃÂ¡pasy
        <span class="nav-soon">brzy</span>
      </div>
      <div class="nav-item disabled">
        <span class="nav-icon">Ã°ÂÂÂ</span> Statistiky
        <span class="nav-soon">brzy</span>
      </div>
    </nav>
    <div id="sb-footer">
      <button id="sb-reload">Ã¢ÂÂ» Reload dat</button>
      <button id="sb-close">Ã¢ÂÂ ZavÃÂÃÂ­t</button>
      <div id="ta-progress"></div>
      <button id="sb-ta-import">Ã¢Â¬Â Import Tennis Abstract</button>
      <div id="fs-progress"></div>
      <button id="sb-ta-retry">Ã°ÂÂÂ Reimport pÃÂeskoÃÂenÃÂ½ch TA</button>
    </div>
  `;
  ...
  topbar.innerHTML=`
    <div id="topbar-title">RozcestnÃÂ­k</div>
    <div id="topbar-sub">Tennis Scout</div>
    <div id="topbar-stats">
      <div class="ts-stat">
        <div class="ts-stat-val" id="nt">Ã¢ÂÂ</div>
        <div class="ts-stat-lbl">TurnajÃÂ¯</div>
      </div>
      <div class="ts-stat">
        <div class="ts-stat-val green" id="ns">Ã¢ÂÂ</div>
  ...
  [['ALL','VÃÂ¡e',true],['ATP','ATP'],['WTA','WTA'],['CHALL','Challenger'],['ITF','ITF']].forEach(([c,t,on])=>{
    const b=el('button',null,'fb'+(on?' on':''));b.dataset.c=c;b.textContent=t;fr1.appendChild(b);
  });
  const srch=el('input','srch');srch.placeholder='Ã°ÂÂÂ  Hledat...';fr1.appendChild(srch);
  filterbar.appendChild(fr1);
  const fr2=el('div',null,'fr');
  fr2.style.paddingBottom='10px';
  fr2.innerHTML=`<span class="fl">Povrch</span>`;
  [['VÃÂ¡echny',true],['TvrdÃÂ½'],['Antuka'],['TrÃÂ¡va'],['KrytÃÂ½']].forEach(([s,on])=>{
  ...
  const itft=el('div','itft');itft.textContent='NaÃÂÃÂ­tÃÂ¡m ITF data...';itfs.appendChild(itft);
  body.appendChild(itfs);
  // Loader
  const load=el('div','load');
  load.style.display='none';
  load.innerHTML=`<div class="spin"></div><div id="prog">ATP/WTA/Challenger: naÃÂteno Ã¢ÂÂ Ã¢ÂÂ ÃÂekÃÂ¡m na ITF API...</div>`;
  ...
  // Ã¢ÂÂÃ¢ÂÂ NAVIGACE Ã¢ÂÂÃ¢ÂÂ
  function goView(view){
    ...
    // Topbar title
    const titles={home:'RozcestnÃÂ­k',tournaments:'Turnaje 2026',players:'HrÃÂ¡ÃÂi ATP'};
    ...
    btn.addEventListener('click',function(){
      ...
      function nx(i){
        ...
        .then(function(cr){
          ...
          .then(function(html){
            if(!html){er++;window._importFailed=window._importFailed||[];window._importFailed.push(p.full_name+' ('+p.id+'): no html');prog.innerHTML=window._tsProgress=dn+'/'+tot+' Ã¢ÂÂ'+im+' Ã¢ÂÂ­'+sk+' Ã¢ÂÂ'+er+' Ã¢ÂÂ Ã¢ÂÂ '+p.full_name;dn++;setTimeout(function(){nx(i+1);},1000);return;}
            var tm=html.match(/<title>Tennis Abstract: ([^<]+)/);
            if(!tm||tm[1].indexOf('Player Search')>=0){sk++;window._skippedPlayers=window._skippedPlayers||[];window._skippedPlayers.push({id:p.id,name:p.full_name,slug:ta});dn++;prog.innerHTML=window._tsProgress=dn+'/'+tot+' Ã¢ÂÂ'+im+' Ã¢ÂÂ­'+sk+' Ã¢ÂÂ'+er+'<br><small style="color:#f87171">PÃÂeskoÃÂenÃÂ­: '+window._skippedPlayers.map(function(x){return x.name;}).join(', ')+'</small>';setTimeout(function(){nx(i+1);},500);return;}
            ...
            var _noVa=!_hasGoodData;if(!ms||ms.length<1){sk++;dn++;prog.innerHTML=window._tsProgress=dn+'/'+tot+' Ã¢ÂÂ'+im+' Ã¢ÂÂ­'+sk+' Ã¢ÂÂ'+er;setTimeout(function(){nx(i+1);},500);return;}
            return fetch('https://raw.githubusercontent.com/Havran001/tennis-scout/main/player_history/'+p.id+'.json?v='+Date.now())
              ...
              .then(function(existing){
                ...
                var cdOdds=(cd&&cd.matches)?cd.matches.filter(function(m){return m.odds_opp>0;}).length:0;console.log('[OddsMerge] cd='+!!(cd&&cd.matches)+' cdOdds='+cdOdds+' pid='+p.id);if(cd&&cd.matches&&cdOdds>0){var om={};cd.matches.forEach(function(m){if(m.odds_opp>0){var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();om[k]={alc:m.odds_alc,opp:m.odds_opp,src:m.odds_src};}});if(Object.keys(om).length>0){ms.forEach(function(m){if(m.odds_opp>0)return;if(!(m.score||'').trim())return;var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();if(om[k]){m.odds_alc=om[k].alc;m.odds_opp=om[k].opp;m.odds_src=om[k].src;}});console.log('[OddsMerge] restored '+Object.keys(om).length+' for '+p.id);}}
                var cdOdds=(cd&&cd.matches)?cd.matches.filter(function(m){return m.odds_opp>0;}).length:0;if(cd&&cd.matches&&cdOdds>0){var om={};cd.matches.forEach(function(m){if(m.odds_opp>0){var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();om[k]={alc:m.odds_alc,opp:m.odds_opp,src:m.odds_src};}});if(Object.keys(om).length>0){ms.forEach(function(m){if(m.odds_opp>0)return;if(!(m.score||'').trim())return;var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();if(om[k]){m.odds_alc=om[k].alc;m.odds_opp=om[k].opp;m.odds_src=om[k].src;}});console.log('[OddsMerge] restored '+Object.keys(om).length+' for '+p.id);}}
                var cdOdds2=(cd&&cd.matches)?cd.matches.filter(function(m){return m.odds_opp>0;}).length:0;if(cd&&cd.matches&&cdOdds2>0){var om2={};cd.matches.forEach(function(m){if(m.odds_opp>0){var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();om2[k]={alc:m.odds_alc,opp:m.odds_opp,src:m.odds_src};}});if(Object.keys(om2).length>0){ms.forEach(function(m){if(m.odds_opp>0)return;if(!(m.score||'').trim())return;var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();if(om2[k]){m.odds_alc=om2[k].alc;m.odds_opp=om2[k].opp;m.odds_src=om2[k].src;}});console.log('[OddsMerge2] restored '+Object.keys(om2).length+' for '+p.id);}}
                var cdOdds2=(cd&&cd.matches)?cd.matches.filter(function(m){return m.odds_opp>0;}).length:0;if(cd&&cd.matches&&cdOdds2>0){var om2={};cd.matches.forEach(function(m){if(m.odds_opp>0){var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();om2[k]={alc:m.odds_alc,opp:m.odds_opp,src:m.odds_src};}});if(Object.keys(om2).length>0){ms.forEach(function(m){if(m.odds_opp>0)return;if(!(m.score||'').trim())return;var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();if(om2[k]){m.odds_alc=om2[k].alc;m.odds_opp=om2[k].opp;m.odds_src=om2[k].src;}});console.log('[OddsMerge2] restored '+Object.keys(om2).length+' for '+p.id);}}
                var cdOdds2=(cd&&cd.matches)?cd.matches.filter(function(m){return m.odds_opp>0;}).length:0;if(cd&&cd.matches&&cdOdds2>0){var om2={};cd.matches.forEach(function(m){if(m.odds_opp>0){var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();om2[k]={alc:m.odds_alc,opp:m.odds_opp,src:m.odds_src};}});if(Object.keys(om2).length>0){ms.forEach(function(m){if(m.odds_opp>0)return;if(!(m.score||'').trim())return;var k=m.date+'|'+(m.opponent||'').toLowerCase().split(' ').pop();if(om2[k]){m.odds_alc=om2[k].alc;m.odds_opp=om2[k].opp;m.odds_src=om2[k].src;}});console.log('[OddsMerge2] restored '+Object.keys(om2).length+' for '+p.id);}}
            ...
            .then(function(pr){if(pr.ok){im++;prog.innerHTML=window._tsProgress=dn+'/'+tot+' Ã¢ÂÂ'+im+' Ã¢ÂÂ­'+sk+' Ã¢ÂÂ'+er+' Ã¢ÂÂ '+p.full_name+' ('+ms.length+')';}else{pr.json().then(function(e){console.error('GH PUT failed: '+p.full_name+' ('+p.id+')');window._importFailed=window._importFailed||[];window._importFailed.push(p.full_name+' ('+p.id+'): PUT failed');prog.innerHTML=window._tsProgress=dn+'/'+tot+' Ã¢ÂÂ'+im+' Ã¢ÂÂ­'+sk+' Ã¢ÂÂ'+er+' Ã¢ÂÂ Ã¢ÂÂ '+p.full_name;});er++;}dn++;setTimeout(function(){nx(i+1);},2000);});
          });
          }).catch(function(e){window._importFailed=window._importFailed||[];window._importFailed.push(p.full_name+' ('+p.id+'): network error');prog.innerHTML=window._tsProgress=dn+'/'+tot+' Ã¢ÂÂ'+im+' Ã¢ÂÂ­'+sk+' Ã¢ÂÂ'+er+' Ã¢ÂÂ Ã¢ÂÂ '+p.full_name;er++;dn++;setTimeout(function(){nx(i+1);},500);});
      }
  ...
  (function(){
    ...
    btn.addEventListener('click',function(){
      ...
      function nx(i){
        if(i>=tot){self.disabled=false;prog.innerHTML='Ã¢ÂÂ Reimport dokoncen! '+im+'/'+tot;window._skippedPlayers=[];return;}
        var s=skipped[i];
        var ta=nN(s.name||'');
        ...
        fetch('https://api.github.com/repos/Havran001/tennis-scout/contents/player_history/'+s.id+'.json',{headers:{'Authorization':'token '+GH,'Accept':'application/vnd.github.v3+json'}}).then(function(r){return r.ok?r.json():null;}).then(function(cr){
          return tryP(taUrl,0).then(function(html){
            if(!html){er++;dn++;prog.innerHTML=dn+'/'+tot+' Ã¢ÂÂ'+im+' Ã¢ÂÂ'+er;setTimeout(function(){nx(i+1);},500);return;}
            var tm2=html.match(/<title>Tennis Abstract: ([^<]+)/);
            if(!tm2||tm2[1].indexOf('Player Search')>=0){sk++;dn++;prog.innerHTML=dn+'/'+tot+' Ã¢ÂÂ'+im+' Ã¢ÂÂ­'+sk;setTimeout(function(){nx(i+1);},500);return;}
            ...
            fetch('https://api.github.com/repos/Havran001/tennis-scout/contents/player_history/'+s.id+'.json',{method:'PUT',headers:{'Authorization':'token '+GH,'Accept':'application/vnd.github.v3+json','Content-Type':'application/json'},body:JSON.stringify(bd)}).then(function(r){if(r&&r.ok)im++;else er++;dn++;prog.innerHTML=dn+'/'+tot+' Ã¢ÂÂ'+im+' Ã¢ÂÂ­'+sk+' Ã¢ÂÂ'+er+' -> '+s.name;setTimeout(function(){nx(i+1);},2000);});
          });
  ...
  (function(){
    sh.addEventListener('click',function(e){
      ...
      if(!pid){status.textContent='Ã¢ÂÂ Ã¯Â¸Â Chyba ID';return;}
      btn.disabled=true;
      var reDiac=new RegExp('[\u0300-\u036f]','g');
      var reNA=new RegExp('[^a-zA-Z -]','g');
      function nN(fn){return(fn||'').normalize('NFD').replace(reDiac,'').replace(reNA,'').trim().split(' ').join('');}
      ...
      tryP(taUrl,0).then(function(html){
        ...
        // Uloz pouze TA data
        if(!ms){status.textContent='Ã¢ÂÂ Ã¯Â¸Â TA proxy selhala';btn.disabled=false;return;}if(ms.length<1){status.textContent='Ã¢ÂÂ Ã¯Â¸Â HrÃÂ¡ÃÂ nemÃÂ¡ TA data';btn.disabled=false;return;}
        ms.sort(function(a,b){return b.date.localeCompare(a.date);});
        status.textContent='Ã¢ÂÂ³ UklÃÂ¡dÃÂ¡m...';
        ...
        fetch('https://api.github.com/repos/Havran001/tennis-scout/contents/player_history/'+pid+'.json',{headers:{'Authorization':'token '+GH,'Accept':'application/vnd.github.v3+json'}}).then(function(r){return r.ok?r.json():null;}).then(function(gd){
          ...
          if(r&&(r.ok||r.status===409))status.textContent='Ã¢ÂÂ '+ms.length+' zÃÂ¡pasÃÂ¯ (TA)';
          else status.textContent='Ã¢ÂÂ Chyba uloÃÂ¾enÃÂ­';
          btn.disabled=false;
        }).catch(function(){status.textContent='Ã¢ÂÂ Chyba';btn.disabled=false;});
      });
    });
  })();
  ...
  // Players toggle pro zpÃÂtnou kompatibilitu
...
function setupRender({sh,body,mnav}){
  let aC='ALL',aS='VÃÂ¡echny',sq='',exId=null;

  function filtered(){
    return(window._tsData||[]).filter(t=>{
      if(aC!=='ALL'&&t.cat!==aC)return false;
      if(aS!=='VÃÂ¡echny'&&t.surf!==aS)return false;
  ...
  function render(){
    ...
    if(!ts.length){[...body.children].forEach(el=>{if(el.id!=='pw'&&el.id!=='home-view')el.remove()});const e=document.createElement('div');e.style.cssText='text-align:center;padding:60px;color:#5a6070;';e.textContent='ÃÂ½ÃÂ¡dnÃÂ© turnaje.';body.appendChild(e);return;}

    let html='';
    Object.keys(byM).sort((a,b)=>+a-+b).forEach(m=>{
      const arr=byM[m];
      html+=`<div class="mg" id="m${m}"><div class="mh"><div class="mn">${MCS[m]}</div><div class="mc">${arr.length} turnajÃÂ¯</div></div><table><thead><tr><th style="width:18px"></th><th>Turnaj</th><th>Datum</th><th>Povrch</th><th>Los</th></tr></thead><tbody>`;
      arr.forEach((t,i)=>{
        const uid=`${m}_${i}`,ex=exId===uid,live=isLive(t.start,t.end);
        html+=`<tr class="r${ex?' ex':''}" data-uid="${uid}"><td><span class="cv">Ã¢ÂÂº</span></td><td><span class="ct c${t.cat}">${t.cat}</span><span class="tr ${tierCls(t.tier)}">${t.tier||'Ã¢ÂÂ'}</span><span class="nm">${live?'<span class="live"></span>':''}${t.name}</span><span class="lc">${t.loc}${t.country?' ('+t.country+')':''}</span></td><td class="dt">${fmtRange(t.start,t.end)}</td><td><span class="sp ${surfSp(t.surf)}">${t.surf}</span></td><td style="font-family:monospace;font-size:10px;color:#5a6070">${t.sgl>0?t.sgl:'Ã¢ÂÂ'}</td></tr>`;
        if(ex){
          const altLabel=t.alt>0?`${t.alt} m n.m.${t.alt>1000?' Ã°ÂÂÂ´':t.alt>500?' Ã°ÂÂÂ¡':''}`:t.cat==='ITF'?'Ã¢ÂÂ':'0 m';
        const ioLabel=t.io==='I'?'Ã°ÂÂÂ  KrytÃÂ¡ hala':'Ã¢ÂÂÃ¯Â¸Â VenkovnÃÂ­';
        const winnersHtml=(t.winners&&t.winners.length>0&&t.winners[0]!=='Ã¢ÂÂ')?t.winners.slice(0,3).map((w,i)=>`<div style="font-size:9px;color:#5a6070;font-family:monospace">${2025-i}: <span style="color:#e8eaf0;font-weight:600">${w}</span></div>`).join(''):'<span style="color:#5a6070;font-size:10px">Ã¢ÂÂ</span>';
        html+=`<tr class="xr"><td colspan="5"><div class="xc" style="grid-template-columns:1fr 1fr 1fr 1fr"><div><h4>Info</h4><div class="ig"><div><label>Okruh</label><span>${t.cat}</span></div><div><label>Tier</label><span>${t.tier||'Ã¢ÂÂ'}</span></div><div><label>Povrch</label><span>${t.surf}</span></div><div><label>Lokace</label><span>${ioLabel}</span></div><div><label>Los SGL</label><span>${t.sgl>0?t.sgl+' hr':'Ã¢ÂÂ'}</span></div><div><label>Los DBL</label><span>${t.dbl>0?t.dbl+' pÃÂ¡rÃÂ¯':'Ã¢ÂÂ'}</span></div></div></div><div><h4>Lokalita & vÃÂ½ÃÂ¡ka</h4><div style="font-size:12px;color:#e8eaf0;font-weight:600;margin-bottom:4px">${t.name}</div><div style="font-size:10px;color:#5a6070">${t.loc}${t.country?' ('+t.country+')':''}</div><div style="font-size:10px;color:#c8f135;margin-top:6px;font-family:monospace;font-weight:600">${altLabel}</div><div style="font-size:9px;color:#5a6070;margin-top:2px;font-family:monospace">${t.start||'?'} Ã¢ÂÂ ${t.end||'?'}</div></div><div><h4>Prize money</h4><div style="font-size:16px;color:#c8f135;font-weight:700;font-family:monospace">${t.prize||'Ã¢ÂÂ'}</div><div style="font-size:9px;color:#5a6070;margin-top:2px">VÃÂ­tÃÂz singlu</div><div style="margin-top:8px;font-size:9px;color:#5a6070;text-transform:uppercase;letter-spacing:1px">Stav</div><div style="color:${live?'#f13570':'#5a6070'};font-size:${live?12:11}px;font-weight:${live?700:400};margin-top:2px">${live?'Ã°ÂÂÂ´ ProbÃÂ­hÃÂ¡':'NadchÃÂ¡zejÃÂ­cÃÂ­'}</div></div><div><h4>VÃÂ­tÃÂzovÃÂ© (2025Ã¢ÂÂ2023)</h4>${winnersHtml}</div></div></td></tr>`;
        }
      });
      html+='</tbody></table></div>';
    });
...
fetchITF(txt=>{setP(txt);}).then(itfItems=>{
  ...
  if(hcT)hcT.textContent=window._tsData.length+' turnÃÂ¡jÃÂ¯';
  ...
  console.log('Ã°ÂÂÂ¾ Tennis Scout v'+VERSION+' Ã¢ÂÂ '+window._tsData.length+' turnÃÂ¡jÃÂ¯');
...
function _bet365Col(p1,p2){
  ...
  if(odds&&prevOdds){
    ...
    if(d1>0)a1='<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';
    else if(d1<0)a1='<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>';
    if(d2>0)a2='<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';
    else if(d2<0)a2='<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>';
    if(a1&&!a2)a2=(d1>0)?'<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>':'<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';
    if(a2&&!a1)a1=(d2>0)?'<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>':'<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';
  }
...
function _normName(n){
  if(!n)return '';
  // Pro ctyrhu (obsahuje '/') vezmi prvni prijmeni z paru
  if(n.indexOf('/')>=0){var first=n.split('/')[0].trim();return _normName(first);}
  var p=n.trim().split(/[\s\-]+/);
  // OdstraÃÂ poslednÃÂ­ token pokud je iniciÃÂ¡la nebo teÃÂka
  while(p.length>1&&(p[p.length-1].length<=1||p[p.length-1].endsWith('.')))p.pop();
...
function _getBetanoOdds(p1,p2,dataset){
  ...
  if(!ev)return null;
  if(normAll(ev.p1).indexOf(n1)>=0)return {o1:ev.odds1,o2:ev.odds2,s1:ev.suspended1,s2:ev.suspended2,url:ev.url};
...
function _renderBestHighlight(p1,p2){
  ...
  // VrÃÂ¡tÃÂ­ hidden div s daty pro JS highlighting
...
function _betanoCol(p1, p2){
  ...
  if(odds&&prevOdds){
    ...
    // Pokud jen jeden se zmÃÂnil, druhÃÂ½ dostane opaÃÂnou ÃÂ¡ipku
    if(a1&&!a2)a2=(d1>0)?'<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>':'<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';
    if(a2&&!a1)a1=(d2>0)?'<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>':'<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';
  }
...
function _normChance(n){
  if(!n)return '';
  var s=n.trim();
  // Pro ÃÂtyÃÂhry: vezmi prvnÃÂ­ hrÃÂ¡ÃÂe pÃÂed lomÃÂ­tkem
  if(s.indexOf('/')>=0)s=s.split('/')[0].trim();
  // OdstraÃÂ iniciÃÂ¡lu na konci: "Krawietz A." Ã¢ÂÂ "Krawietz"
  s=s.replace(/\s+[A-Z]\.?\s*$/,'').trim();
  // OdstraÃÂ iniciÃÂ¡lu na zaÃÂÃÂ¡tku: "R. Cash" Ã¢ÂÂ "Cash"
...
function _normChance2(n){
  // Vezmi druhÃÂ©ho hrÃÂ¡ÃÂe z ÃÂtyÃÂhry (za lomÃÂ­tkem)
  if(!n)return '';
  var s=n.trim();
...
function _getChanceOdds(p1,p2,dataset){
  ...
  function _allTokens(n){
    ...
    return n.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g,'')
      .replace(/[^a-z \-]/g,'').trim().split(/[\s\-]+/).filter(function(t){return t.length>1;});
  }
  function _matchS(a,b){
    var ta=_allTokens(a),tb=_allTokens(b);
    if(!ta.length||!tb.length)return false;
    // PÃÂesnÃÂ¡ shoda prvnÃÂ­ho tokenu (funguje i pro krÃÂ¡tkÃÂ¡ jmÃÂ©na jako Li, Wu)
    if(ta[0]===tb[0])return true;
    // Shoda libovolnÃÂ©ho tokenu (delÃÂ¡ÃÂ­ neÃÂ¾ 3 znaky pro prevenci false positive)
  ...
  function _surnameD(n){
    ...
    n=n.trim();
    n=n.replace(/^([A-Za-z]{1,3}\.)+\s*/,'');
    // Normalizuj pomlÃÂku na mezeru Ã¢ÂÂ "Cavalle-Reimers" Ã¢ÂÂ "Cavalle Reimers"
    n=n.replace(/-/g,' ');
    var tokens=n.split(/\s+/).filter(function(t){
      var clean=t.replace(/[\.\-]/g,'');
      return !(clean.length<=3&&(t.indexOf('.')>=0||clean.length===1));
    });
    // Vezmi jen prvnÃÂ­ token (pÃÂÃÂ­jmenÃÂ­)
    var first=tokens[0]||'';
    return first.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g,'').replace(/[^a-z]/g,'');
  }
  ...
  // Dvouhra Ã¢ÂÂ token intersection matching
  var ev=_ds.events.find(function(e){
...
function _chanceCol(p1,p2){var odds=_getChanceOdds(p1,p2);var prevOdds=_chanceBaseOdds?_getChanceOdds(p1,p2,_chanceBaseOdds):null;var o1=odds?Math.round(odds.o1*100)/100:'?',o2=odds?Math.round(odds.o2*100)/100:'?';var a1='',a2='';if(odds&&prevOdds){var d1=Math.round((odds.o1-prevOdds.o1)*100)/100;var d2=Math.round((odds.o2-prevOdds.o2)*100)/100;if(d1>0)a1='<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';else if(d1<0)a1='<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>';if(d2>0)a2='<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';else if(d2<0)a2='<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>';if(a1&&!a2)a2=(d1>0)?'<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>':'<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';if(a2&&!a1)a1=(d2>0)?'<span style="color:#f85149;font-size:10px;line-height:1;">Ã¢ÂÂ¼</span>':'<span style="color:#3fb950;font-size:10px;line-height:1;">Ã¢ÂÂ²</span>';}var c1=odds?'#e6edf3':'rgba(255,255,255,.2)';var c2=odds?'#e6edf3':'rgba(255,255,255,.2)';return'<div style="position:absolute;left:830px;top:50%;transform:translateY(-50%);display:flex;flex-direction:column;align-items:center;gap:2px;min-width:52px;text-align:center;"><div style="font-size:12px;font-weight:700;color:'+c1+';line-height:1.2;">'+a1+o1+'</div><div style="font-size:12px;font-weight:700;color:'+c2+';line-height:1.2;">'+a2+o2+'</div></div>';}


// === KINGSBET ODDS ===
var _kbUrl=localStorage.getItem('ts_kb_url')||'https://betano-odds.vavra-radovan.workers.dev/kb-odds';
...
var _runKb=function(){
  ...
  // Scrape jen pokud nebyl v poslednÃÂ­ch 60s
...
var _normKbName=function(n){
  ...
  var ascii=function(s){
    return s.toLowerCase()
      .replace(/ÃÂ¡/g,'sh').replace(/ÃÂ/g,'ch').replace(/ÃÂ¾/g,'zh').replace(/ÃÂ/g,'dj').replace(/ÃÂ/g,'c')
...
var _getKbOdds=function(p1,p2,dataset){
  ...
  var kbVars=function(name){
    ...
    var words;
    if(name.indexOf(',')>-1){
      // PÃÂidej varianty ze VÃÂ ECH tokenÃÂ¯ (pÃÂed i za ÃÂÃÂ¡rkou) Ã¢ÂÂ KB nemÃÂ¡ konzistentnÃÂ­ poÃÂadÃÂ­
  ...
  var appVars=function(n){
    ...
    names.forEach(function(segment){
      ...
      // PÃÂidej varianty vÃÂ¡ech tokenÃÂ¯ delÃÂ¡ÃÂ­ch neÃÂ¾ 2 znaky (kromÃÂ iniciÃÂ¡l jako "A.")
...
function _fortunaSurnameD(n){
  ...
  // Vezmi jen prvnÃÂ­ token (pÃÂÃÂ­jmenÃÂ­) Ã¢ÂÂ "Bassols Ribera M." Ã¢ÂÂ "bassols"
  var first=tokens[0]||'';
...
// === MERKUR ODDS ===
var _merkurOdds=null;var _merkurBaseOdds=null;var _merkurUpdated='';
var _merkurUrl='https://betano-odds.vavra-radovan.workers.dev/merkur-odds';
var _merkurScrapeUrl='https://betano-odds.vavra-radovan.workers.dev/merkur-scrape';

function _getKbOddsFrom(p1,p2,dataset,urlBase){
  return _getKbOdds(p1,p2,dataset);
}

function _getMerkurOdds(p1,p2,dataset){
  var ds=dataset||_merkurOdds;
  if(!ds||!ds.events)return null;
  // PouÃÂ¾ij _getKbOdds s Merkur datastem
...
function _merkurCol(p1,p2){
  var odds=_getMerkurOdds(p1,p2);
  var prevOdds=_merkurBaseOdds?_getMerkurOdds(p1,p2,_merkurBaseOdds):null;
  var o1=odds?Math.round(odds.o1*100)/100:'?',o2=odds?Math.round(odds.o2*100)/100:'?';
  var a1='',a2='';
  if(odds&&prevOdds){
    var d1=Math.round((odds.o1-prevOdds.o1)*100)/100;
...
// === SYNOT TIP ODDS ===
var _synotOdds=null;var _synotBaseOdds=null;var _synotUpdated='';
var _synotUrl='https://betano-odds.vavra-radovan.workers.dev/synot-odds';
var _synotScrapeUrl='https://betano-odds.vavra-radovan.workers.dev/synot-scrape';
...
function _applyFilter(){
  // VÃÂ¾dy hledej aktuÃÂ¡lnÃÂ­ wrap pÃÂes ts-host shadow root
  ...
  rows.forEach(function(row){
    ...
    if(hasAll){
      ...
      // KombinovatelnÃÂ© filtry: scheduled a odds
      show=true;
  ...
  // Skryj prÃÂ¡zdnÃÂ© turnajovÃÂ© headery
...
function _updateOddsFlags(){
  ...
  if(!wrap)return;
  // Najdi jmÃÂ©na hrÃÂ¡ÃÂÃÂ¯ z kaÃÂ¾dÃÂ©ho ÃÂÃÂ¡dku a zkontroluj kurzy
  wrap.querySelectorAll('.mrow').forEach(function(row){
    // Hledej text jmen - jsou v prvnÃÂ­ch divech ÃÂÃÂ¡dku
...
function _synotCol(p1,p2){
  ...
  var prevOdds=_synotBaseOdds?_getSynotOdds(p1,p2,_synotBaseOdds):null;
  var o1=odds?Math.round(odds.o1*100)/100:'?',o2=odds?Math.round(odds.o2*100)/100:'?';
  var a1='',a2='';
  if(odds&&prevOdds){
    var d1=Math.round((odds.o1-prevOdds.o1)*100)/100;
  ...
  setTimeout(function(){
    try{
      ...
      dataEls.forEach(function(el){
        ...
        if(!row||row===c)return;
        // Projdi vÃÂ¡echny divy v ÃÂÃÂ¡dku a hledej ÃÂÃÂ­sla kurzÃÂ¯
        ...
        allDivs.forEach(function(d){
          ...
          // OdstraÃÂ ÃÂ¡ipky
          txt=txt.replace(/[Ã¢ÂÂ²Ã¢ÂÂ¼]/g,'').trim();
...
// === KONEC BEST ODDS HIGHLIGHT ===
    ...
    // ÃÂti _activeFilterKey pÃÂÃÂ­mo ze sh (shadow root) - jedinÃÂ½ spolehlivÃÂ½ zdroj
...
// H2H init - spustÃÂ­ se po naÃÂtenÃÂ­ appky
(function waitForH2H(){
  var tries=0;
  var timer=setInterval(function(){
    ...
    // buildH2HTab nenÃÂ­ dostupnÃÂ¡ globÃÂ¡lnÃÂ - vytvoÃÂ minimÃÂ¡lnÃÂ­ verzi
    var wrap=document.createElement('div');
    wrap.id='h2hw';
    wrap.style.cssText='display:none;padding:0;';
    ...
    function sLabel(s){var sl=(s||'').toLowerCase();if(sl.includes('clay'))return 'Antuka';if(sl.includes('grass'))return 'TrÃÂ¡va';if(sl.includes('hard'))return 'TvrdÃÂ½';return s||'?';}
    ...
    function getFlag(c){var m={'ESP':'Ã°ÂÂÂªÃ°ÂÂÂ¸','ITA':'Ã°ÂÂÂ®Ã°ÂÂÂ¹','SRB':'Ã°ÂÂÂ·Ã°ÂÂÂ¸','GER':'Ã°ÂÂÂ©Ã°ÂÂÂª','AUS':'Ã°ÂÂÂ¦Ã°ÂÂÂº','USA':'Ã°ÂÂÂºÃ°ÂÂÂ¸','FRA':'Ã°ÂÂÂ«Ã°ÂÂÂ·','GBR':'Ã°ÂÂÂ¬Ã°ÂÂÂ§','ARG':'Ã°ÂÂÂ¦Ã°ÂÂÂ·','JPN':'Ã°ÂÂÂ¯Ã°ÂÂÂµ','RUS':'Ã°ÂÂÂ·Ã°ÂÂÂº','CAN':'Ã°ÂÂÂ¨Ã°ÂÂÂ¦','NOR':'Ã°ÂÂÂ³Ã°ÂÂÂ´','CZE':'Ã°ÂÂÂ¨Ã°ÂÂÂ¿','GRE':'Ã°ÂÂÂ¬Ã°ÂÂÂ·','DEN':'Ã°ÂÂÂ©Ã°ÂÂÂ°','SUI':'Ã°ÂÂÂ¨Ã°ÂÂÂ­','BEL':'Ã°ÂÂÂ§Ã°ÂÂÂª','POL':'Ã°ÂÂÂµÃ°ÂÂÂ±','KAZ':'Ã°ÂÂÂ°Ã°ÂÂÂ¿','ROU':'Ã°ÂÂÂ·Ã°ÂÂÂ´','SWE':'Ã°ÂÂÂ¸Ã°ÂÂÂª','AUT':'Ã°ÂÂÂ¦Ã°ÂÂÂ¹','UKR':'Ã°ÂÂÂºÃ°ÂÂÂ¦','BRA':'Ã°ÂÂÂ§Ã°ÂÂÂ·','COL':'Ã°ÂÂÂ¨Ã°ÂÂÂ´'};return m[c]||'';}
    ...
    function renderH2H(p1,p2,h1,h2){
      ...
      html+='<div style="flex:0 0 140px;text-align:center;"><div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;margin-bottom:6px;">H2H</div><div style="display:flex;align-items:center;justify-content:center;gap:8px;"><span style="font-size:38px;font-weight:900;color:'+(wins>losses?'#00C853':wins<losses?'#f85149':'#e6edf3')+';">'+wins+'</span><span style="font-size:16px;color:rgba(255,255,255,.2);">Ã¢ÂÂ</span><span style="font-size:38px;font-weight:900;color:'+(losses>wins?'#00C853':losses<wins?'#f85149':'#e6edf3')+';">'+losses+'</span></div><div style="font-size:10px;color:rgba(255,255,255,.3);">'+h2hM.length+' zÃÂ¡pasÃÂ¯</div></div>';
      ...
      [form1,form2].forEach(function(form,i){var label=(i===0?p1n:p2n).split(' ').pop();html+='<div style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.06);border-radius:10px;padding:12px 14px;"><div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;">'+label+' Ã¢ÂÂ forma</div><div style="display:flex;gap:3px;">'+form.map(function(r){return '<div style="width:20px;height:20px;border-radius:3px;background:'+rColor(r)+';display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:800;color:#000;">'+r+'</div>';}).join('')+'</div></div>';});
      html+='</div>';
      var sk=Object.keys(surf);
      if(sk.length){html+='<div style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.06);border-radius:10px;padding:12px 14px;margin-top:12px;"><div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:10px;">H2H podle povrchu</div><div style="display:flex;gap:10px;">'+sk.map(function(s){var d=surf[s];return '<div style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:8px;padding:8px 14px;text-align:center;"><div style="font-size:11px;font-weight:700;color:'+sColor(s)+';margin-bottom:3px;">'+s+'</div><div style="font-size:18px;font-weight:800;color:#fff;">'+d.w+'Ã¢ÂÂ'+d.l+'</div><div style="font-size:9px;color:rgba(255,255,255,.25);">'+(d.w+d.l)+' zÃÂ¡p.</div></div>';}).join('')+'</div></div>';}
      if(h2hM.length){html+='<div style="margin-top:14px;"><div style="font-size:9px;color:rgba(255,255,255,.25);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;padding-bottom:8px;border-bottom:1px solid rgba(255,255,255,.04);">VzÃÂ¡jemnÃÂ© zÃÂ¡pasy ('+h2hM.length+')</div><table style="width:100%;border-collapse:collapse;"><thead><tr>'+['Datum','Turnaj','Povrch','Kolo','Rank','vRank','SkÃÂ³re',''].map(function(c){return '<th style="padding:4px 8px;font-size:8px;color:rgba(255,255,255,.25);letter-spacing:1px;text-align:left;border-bottom:1px solid rgba(255,255,255,.06);">'+c+'</th>';}).join('')+'</tr></thead><tbody>'+h2hM.map(function(m,i){var bg=i%2===0?'transparent':'rgba(255,255,255,.012)';return '<tr style="background:'+bg+';border-bottom:1px solid rgba(255,255,255,.03);"><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+fDate(m.date)+'</td><td style="padding:5px 8px;font-size:11px;color:#e6edf3;max-width:180px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">'+(m.tournament||'Ã¢ÂÂ')+'</td><td style="padding:5px 8px;"><span style="font-size:9px;font-weight:700;color:'+sColor(m.surface)+';background:rgba(255,255,255,.05);padding:2px 6px;border-radius:3px;">'+sLabel(m.surface||'')+'</span></td><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.round||'Ã¢ÂÂ')+'</td><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.rank||'Ã¢ÂÂ')+'</td><td style="padding:5px 8px;font-size:11px;color:rgba(255,255,255,.4);">'+(m.opp_rank||'Ã¢ÂÂ')+'</td><td style="padding:5px 8px;font-size:12px;font-weight:600;font-family:monospace;color:#e6edf3;">'+(m.score||'Ã¢ÂÂ')+'</td><td style="padding:5px 8px;font-size:13px;font-weight:800;color:'+rColor(m.result)+';"> '+(m.result||'?')+'</td></tr>';}).join('')+'</tbody></table></div>';}
      else{html+='<div style="text-align:center;padding:40px;color:rgba(255,255,255,.2);">ÃÂ½ÃÂ¡dnÃÂ© vzÃÂ¡jemnÃÂ© zÃÂ¡pasy v dostupnÃÂ½ch datech</div>';}
      html+='</div>';
      wrap.querySelector('#h2h-result').innerHTML=html;
    }

    wrap.render=function(){
      wrap.innerHTML='<div style="padding:0 24px 40px;"><div style="padding:18px 0 14px;border-bottom:1px solid rgba(255,255,255,.06);margin-bottom:16px;"><div style="font-size:20px;font-weight:800;color:#fff;margin-bottom:3px;">H2H PorovnÃÂ¡nÃÂ­</div><div style="font-size:11px;color:rgba(255,255,255,.3);">Zadej jmÃÂ©na dvou hrÃÂ¡ÃÂÃÂ¯</div></div><div style="display:flex;gap:12px;align-items:flex-end;flex-wrap:wrap;"><div style="flex:1;min-width:160px;"><div style="font-size:9px;color:rgba(255,255,255,.3);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:5px;">HrÃÂ¡ÃÂ 1</div><input id="h2h-p1" type="text" placeholder="napÃÂ. Alcaraz" style="width:100%;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.12);color:#e6edf3;font-size:14px;padding:9px 13px;border-radius:10px;outline:none;box-sizing:border-box;"/></div><div style="font-size:20px;color:rgba(255,255,255,.2);padding-bottom:9px;flex-shrink:0;">vs</div><div style="flex:1;min-width:160px;"><div style="font-size:9px;color:rgba(255,255,255,.3);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:5px;">HrÃÂ¡ÃÂ 2</div><input id="h2h-p2" type="text" placeholder="napÃÂ. Sinner" style="width:100%;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.12);color:#e6edf3;font-size:14px;padding:9px 13px;border-radius:10px;outline:none;box-sizing:border-box;"/></div><button id="h2h-go" style="background:rgba(0,200,83,.15);border:1px solid rgba(0,200,83,.35);color:#00C853;font-size:13px;font-weight:700;padding:9px 20px;border-radius:10px;cursor:pointer;flex-shrink:0;">Porovnat Ã¢ÂÂ</button></div><div id="h2h-status" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,.4);min-height:18px;"></div><div id="h2h-result"></div></div>';
      wrap.querySelector('#h2h-go').addEventListener('click',function(){
        var v1=wrap.querySelector('#h2h-p1').value.trim(),v2=wrap.querySelector('#h2h-p2').value.trim();
        if(!v1||!v2){wrap.querySelector('#h2h-status').textContent='Zadej jmÃÂ©na obou hrÃÂ¡ÃÂÃÂ¯';return;}
        ...
        if(!p1){wrap.querySelector('#h2h-status').textContent='HrÃÂ¡ÃÂ "'+v1+'" nenalezen';return;}
        if(!p2){wrap.querySelector('#h2h-status').textContent='HrÃÂ¡ÃÂ "'+v2+'" nenalezen';return;}
        wrap.querySelector('#h2h-status').textContent='Ã¢ÂÂ³ NaÃÂÃÂ­tÃÂ¡m...';
        wrap.querySelector('#h2h-result').innerHTML='';
        Promise.all([
    ...
    if(nv){
      nv.addEventListener('click',function(){
        ...
        var tt=sh.getElementById('topbar-title');if(tt)tt.textContent='H2H PorovnÃÂ¡nÃÂ­';
...
function openOddsOnBE(pid,fullname){
  ...
  var origText=btn?btn.innerHTML:"Ã¢ÂÂ¡ Odds";
  if(btn){btn.innerHTML="Ã¢ÂÂ³ Importing...";btn.disabled=true;}
...
// === SAVE NAVLIST BOOKMARKLET CODE ===
// Run this on betexplorer.com after __importOdds to save navlist to proxy
// Usage: paste in BE console: __saveNavlist("a0e2")
window.__saveNavlist = function(pid) {
  var queue = JSON.parse(localStorage.getItem("be_queue") || "[]");
  var urls = JSON.parse(localStorage.getItem("be_urls") || "{}");
  var seen = {}; var navlist = [];
  queue.forEach(function(item) {
    var mid = item.url.split("/").filter(function(x){return x.length===8&&/^[a-zA-Z0-9]+$/.test(x);}).pop()||"";
    if(mid&&!seen[mid]){seen[mid]=1;navlist.push({s:item.s,url:item.url,mid:mid});}
  });
  Object.keys(urls).forEach(function(opp){
    var url=urls[opp];
    var mid=url.split("/").filter(function(x){return x.length===8&&/^[a-zA-Z0-9]+$/.test(x);}).pop()||"";
    if(mid&&!seen[mid]){seen[mid]=1;navlist.push({s:opp,url:url,mid:mid});}
  });
  var body = JSON.stringify(navlist);
  fetch("http://localhost:3333/save-navlist?pid="+pid, {
    method: "POST",
    headers: {"Content-Type": "application/json", "Content-Length": body.length},
    body: body
  }).then(function(r){return r.json();}).then(function(d){
    console.log("Navlist saved:", d.entries, "entries, commit:", d.commit);
  }).catch(function(e){
    console.log("Error saving navlist:", e.message);
  });
...
(function(){
  ...
  window.fetch=function(url,opts){
    ...
    // ZachyÃÂ¥ GET player_history - uloÃÂ¾ odds do cache
    ...
    // ZachyÃÂ¥ PUT player_history - merge odds
...
(function(){
  var _w=setInterval(function(){
    ...
    clearInterval(_w);
    var s=window.__imp.toString();
    var p=s.replace(
      'taToBeSur[sur]||sur',
      '({"aliassime":"auger","connell":"connell","oconnell":"connell","zandschulp":"van","jong":"de","agut":"bautista","fokina":"davidovich","minaur":"de","schwaerzler":"schwarzler","moller":"moeller"})[sur]||sur'
    );
